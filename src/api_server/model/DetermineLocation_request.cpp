...
oai::lmf_server::model::InputData DetermineLocation_request::getJsonData() const
{
    return m_JsonData;
}
void DetermineLocation_request::setJsonData(oai::lmf_server::model::InputData const& value)
{
    m_JsonData = value;
