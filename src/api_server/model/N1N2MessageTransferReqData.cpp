...
oai::lmf_server::model::N1MessageContainer
...
oai::lmf_server::model::N2InfoContainer
...
void N1N2MessageTransferReqData::setN2InfoContainer(
    oai::lmf_server::model::N2InfoContainer const& value) {
...
oai::lmf_server::model::RefToBinaryData N1N2MessageTransferReqData::getMtData()
    const {
  return m_MtData;
}
...
void N1N2MessageTransferReqData::setArp(
    oai::lmf_server::model::Arp const& value) {
  m_Arp      = value;
  m_ArpIsSet = true;
}
...
oai::lmf_server::model::AreaOfValidity
...
void N1N2MessageTransferReqData::setAreaOfValidity(
    oai::lmf_server::model::AreaOfValidity const& value) {
...
void N1N2MessageTransferReqData::setOldGuami(
    oai::lmf_server::model::Guami const& value) {
  m_OldGuami      = value;
...
oai::lmf_server::model::AccessType N1N2MessageTransferReqData::getTargetAccess()
    const {
  return m_TargetAccess;
}
void N1N2MessageTransferReqData::setTargetAccess(
    oai::lmf_server::model::AccessType const& value) {
