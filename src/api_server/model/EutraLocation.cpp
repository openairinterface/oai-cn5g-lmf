...
oai::lmf_server::model::Tai EutraLocation::getTai() const
{
    return m_Tai;
}
void EutraLocation::setTai(oai::lmf_server::model::Tai const& value)
{
    m_Tai = value;
}
...
oai::lmf_server::model::Ecgi EutraLocation::getEcgi() const
{
    return m_Ecgi;
}
void EutraLocation::setEcgi(oai::lmf_server::model::Ecgi const& value)
{
    m_Ecgi = value;
}
...
oai::lmf_server::model::GlobalRanNodeId EutraLocation::getGlobalNgenbId() const
{
    return m_GlobalNgenbId;
}
void EutraLocation::setGlobalNgenbId(oai::lmf_server::model::GlobalRanNodeId const& value)
{
...
oai::lmf_server::model::GlobalRanNodeId EutraLocation::getGlobalENbId() const
{
    return m_GlobalENbId;
}
void EutraLocation::setGlobalENbId(oai::lmf_server::model::GlobalRanNodeId const& value)
{
    m_GlobalENbId = value;
