...
oai::lmf_server::model::EventClass EventReportMessage::getEventClass() const
{
    return m_EventClass;
}
void EventReportMessage::setEventClass(oai::lmf_server::model::EventClass const& value)
{
    m_EventClass = value;
}
oai::lmf_server::model::RefToBinaryData EventReportMessage::getEventContent() const
{
    return m_EventContent;
}
void EventReportMessage::setEventContent(oai::lmf_server::model::RefToBinaryData const& value)
{
