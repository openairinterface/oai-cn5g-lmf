...
oai::lmf_server::model::GeographicalCoordinates PointUncertaintyCircle_allOf::getPoint() const
{
    return m_Point;
}
void PointUncertaintyCircle_allOf::setPoint(oai::lmf_server::model::GeographicalCoordinates const& value)
{
    m_Point = value;
}
