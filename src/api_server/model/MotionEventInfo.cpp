...
oai::lmf_server::model::OccurrenceInfo MotionEventInfo::getOccurrenceInfo() const
{
    return m_OccurrenceInfo;
}
void MotionEventInfo::setOccurrenceInfo(oai::lmf_server::model::OccurrenceInfo const& value)
{
