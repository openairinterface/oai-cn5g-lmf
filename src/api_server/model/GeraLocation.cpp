...
oai::lmf_server::model::CellGlobalId GeraLocation::getCgi() const
{
    return m_Cgi;
}
void GeraLocation::setCgi(oai::lmf_server::model::CellGlobalId const& value)
{
    m_Cgi = value;
    m_CgiIsSet = true;
}
...
oai::lmf_server::model::RoutingAreaId GeraLocation::getRai() const
{
    return m_Rai;
}
void GeraLocation::setRai(oai::lmf_server::model::RoutingAreaId const& value)
{
    m_Rai = value;
    m_RaiIsSet = true;
}
...
oai::lmf_server::model::ServiceAreaId GeraLocation::getSai() const
{
    return m_Sai;
}
void GeraLocation::setSai(oai::lmf_server::model::ServiceAreaId const& value)
{
    m_Sai = value;
    m_SaiIsSet = true;
}
...
oai::lmf_server::model::LocationAreaId GeraLocation::getLai() const
{
    return m_Lai;
}
void GeraLocation::setLai(oai::lmf_server::model::LocationAreaId const& value)
{
    m_Lai = value;
    m_LaiIsSet = true;
}
