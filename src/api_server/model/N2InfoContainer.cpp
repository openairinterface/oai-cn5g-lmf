...
oai::lmf_server::model::N2InformationClass N2InfoContainer::getN2InformationClass() const
{
    return m_N2InformationClass;
}
void N2InfoContainer::setN2InformationClass(oai::lmf_server::model::N2InformationClass const& value)
{
    m_N2InformationClass = value;
}
oai::lmf_server::model::N2SmInformation N2InfoContainer::getSmInfo() const
{
    return m_SmInfo;
}
void N2InfoContainer::setSmInfo(oai::lmf_server::model::N2SmInformation const& value)
{
    m_SmInfo = value;
    m_SmInfoIsSet = true;
}
...
oai::lmf_server::model::N2RanInformation N2InfoContainer::getRanInfo() const
{
    return m_RanInfo;
}
void N2InfoContainer::setRanInfo(oai::lmf_server::model::N2RanInformation const& value)
{
    m_RanInfo = value;
    m_RanInfoIsSet = true;
}
...
oai::lmf_server::model::NrppaInformation N2InfoContainer::getNrppaInfo() const
{
    return m_NrppaInfo;
}
void N2InfoContainer::setNrppaInfo(oai::lmf_server::model::NrppaInformation const& value)
{
    m_NrppaInfo = value;
...
oai::lmf_server::model::PwsInformation N2InfoContainer::getPwsInfo() const
{
    return m_PwsInfo;
}
void N2InfoContainer::setPwsInfo(oai::lmf_server::model::PwsInformation const& value)
{
    m_PwsInfo = value;
    m_PwsInfoIsSet = true;
}
...
oai::lmf_server::model::V2xInformation N2InfoContainer::getV2xInfo() const
{
    return m_V2xInfo;
}
void N2InfoContainer::setV2xInfo(oai::lmf_server::model::V2xInformation const& value)
{
    m_V2xInfo = value;
    m_V2xInfoIsSet = true;
}
