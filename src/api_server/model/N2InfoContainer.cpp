...
oai::lmf_server::model::N2InformationClass
...
void N2InfoContainer::setSmInfo(
    oai::lmf_server::model::N2SmInformation const& value) {
  m_SmInfo      = value;
  m_SmInfoIsSet = true;
}
...
void N2InfoContainer::setRanInfo(
    oai::lmf_server::model::N2RanInformation const& value) {
  m_RanInfo      = value;
  m_RanInfoIsSet = true;
}
...
void N2InfoContainer::setNrppaInfo(
    oai::lmf_server::model::NrppaInformation const& value) {
  m_NrppaInfo      = value;
...
void N2InfoContainer::setPwsInfo(
    oai::lmf_server::model::PwsInformation const& value) {
  m_PwsInfo      = value;
  m_PwsInfoIsSet = true;
}
...
void N2InfoContainer::setV2xInfo(
    oai::lmf_server::model::V2xInformation const& value) {
  m_V2xInfo      = value;
  m_V2xInfoIsSet = true;
}
