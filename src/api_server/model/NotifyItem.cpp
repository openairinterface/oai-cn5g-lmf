...
bool NotifyItem::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    /* Changes */ {
        const std::vector<oai::lmf_server::model::ChangeItem>& value = m_Changes;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::lmf_server::model::ChangeItem& value : value)
            { 
...
std::vector<oai::lmf_server::model::ChangeItem> NotifyItem::getChanges() const
{
    return m_Changes;
}
void NotifyItem::setChanges(std::vector<oai::lmf_server::model::ChangeItem> const& value)
{
    m_Changes = value;
}
