...
oai::lmf_server::model::PlmnId GlobalRanNodeId::getPlmnId() const {
  return m_PlmnId;
}
void GlobalRanNodeId::setPlmnId(oai::lmf_server::model::PlmnId const& value) {
  m_PlmnId = value;
}
...
oai::lmf_server::model::GNbId GlobalRanNodeId::getGNbId() const {
  return m_GNbId;
}
void GlobalRanNodeId::setGNbId(oai::lmf_server::model::GNbId const& value) {
  m_GNbId      = value;
  m_GNbIdIsSet = true;
}
