...
public:
    ...
    /// 
    /// </summary>
    oai::lmf_server::model::N1MessageContainer getN1MessageContainer() const;
    void setN1MessageContainer(oai::lmf_server::model::N1MessageContainer const& value);
    bool n1MessageContainerIsSet() const;
    void unsetN1MessageContainer();
    /// <summary>
    /// 
    /// </summary>
    oai::lmf_server::model::N2InfoContainer getN2InfoContainer() const;
    void setN2InfoContainer(oai::lmf_server::model::N2InfoContainer const& value);
    bool n2InfoContainerIsSet() const;
    void unsetN2InfoContainer();
    /// <summary>
    /// 
    /// </summary>
    oai::lmf_server::model::RefToBinaryData getMtData() const;
    void setMtData(oai::lmf_server::model::RefToBinaryData const& value);
    ...
    /// 
    /// </summary>
    oai::lmf_server::model::AreaOfValidity getAreaOfValidity() const;
    void setAreaOfValidity(oai::lmf_server::model::AreaOfValidity const& value);
    ...
    /// 
    /// </summary>
    oai::lmf_server::model::Guami getOldGuami() const;
    void setOldGuami(oai::lmf_server::model::Guami const& value);
    ...
    /// 
    /// </summary>
    oai::lmf_server::model::AccessType getTargetAccess() const;
    void setTargetAccess(oai::lmf_server::model::AccessType const& value);
...
protected:
    oai::lmf_server::model::N1MessageContainer m_N1MessageContainer;
    bool m_N1MessageContainerIsSet;
    oai::lmf_server::model::N2InfoContainer m_N2InfoContainer;
    bool m_N2InfoContainerIsSet;
    oai::lmf_server::model::RefToBinaryData m_MtData;
    bool m_MtDataIsSet;
    bool m_SkipInd;
    bool m_SkipIndIsSet;
