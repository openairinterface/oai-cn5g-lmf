...
public:
    ...
    /// 
    /// </summary>
    oai::lmf_server::model::VerticalDirection getVDirection() const;
    void setVDirection(oai::lmf_server::model::VerticalDirection const& value);
...
protected:
    ...
    oai::lmf_server::model::VerticalDirection m_VDirection;
