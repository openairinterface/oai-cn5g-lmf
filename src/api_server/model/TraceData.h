...
public:
    ...
    /// 
    /// </summary>
    oai::lmf_server::model::TraceDepth getTraceDepth() const;
    void setTraceDepth(oai::lmf_server::model::TraceDepth const& value);
    /// <summary>
    /// 
    /// </summary>
    ...
    /// 
    /// </summary>
    oai::lmf_server::model::Ipv6Addr getCollectionEntityIpv6Addr() const;
    void setCollectionEntityIpv6Addr(oai::lmf_server::model::Ipv6Addr const& value);
...
protected:
    ...
    oai::lmf_server::model::TraceDepth m_TraceDepth;
    ...
    oai::lmf_server::model::Ipv6Addr m_CollectionEntityIpv6Addr;
