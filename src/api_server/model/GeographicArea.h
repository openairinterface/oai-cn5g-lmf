...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::lmf_server::model::GeographicalCoordinates> getPointList() const;
    void setPointList(std::vector<oai::lmf_server::model::GeographicalCoordinates> const& value);
    /// <summary>
    /// 
    /// </summary>
...
protected:
    ...
    std::vector<oai::lmf_server::model::GeographicalCoordinates> m_PointList;
