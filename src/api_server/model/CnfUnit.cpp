...
bool CnfUnit::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    /* CnfUnit */ {
        const std::vector<oai::lmf_server::model::Atom>& value = m_CnfUnit;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::lmf_server::model::Atom& value : value)
            { 
...
std::vector<oai::lmf_server::model::Atom> CnfUnit::getCnfUnit() const
{
    return m_CnfUnit;
}
void CnfUnit::setCnfUnit(std::vector<oai::lmf_server::model::Atom> const& value)
{
    m_CnfUnit = value;
}
