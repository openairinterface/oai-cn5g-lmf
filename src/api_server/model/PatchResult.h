...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::lmf_server::model::ReportItem> getReport() const;
    void setReport(std::vector<oai::lmf_server::model::ReportItem> const& value);

    friend void to_json(nlohmann::json& j, const PatchResult& o);
    friend void from_json(const nlohmann::json& j, PatchResult& o);
protected:
    std::vector<oai::lmf_server::model::ReportItem> m_Report;
