...
oai::lmf_server::model::GeographicalCoordinates EllipsoidArc_allOf::getPoint() const
{
    return m_Point;
}
void EllipsoidArc_allOf::setPoint(oai::lmf_server::model::GeographicalCoordinates const& value)
{
    m_Point = value;
}
