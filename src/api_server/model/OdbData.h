...
public:
    ...
    /// 
    /// </summary>
    oai::lmf_server::model::RoamingOdb getRoamingOdb() const;
    void setRoamingOdb(oai::lmf_server::model::RoamingOdb const& value);
...
protected:
    oai::lmf_server::model::RoamingOdb m_RoamingOdb;
