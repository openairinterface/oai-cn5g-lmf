...
oai::lmf_server::model::NgapIeType N2InfoContent::getNgapIeType() const
{
    return m_NgapIeType;
}
void N2InfoContent::setNgapIeType(oai::lmf_server::model::NgapIeType const& value)
{
    m_NgapIeType = value;
...
oai::lmf_server::model::RefToBinaryData N2InfoContent::getNgapData() const
{
    return m_NgapData;
}
void N2InfoContent::setNgapData(oai::lmf_server::model::RefToBinaryData const& value)
{
    m_NgapData = value;
}
