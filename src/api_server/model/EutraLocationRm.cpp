...
oai::lmf_server::model::Tai EutraLocationRm::getTai() const
{
    return m_Tai;
}
void EutraLocationRm::setTai(oai::lmf_server::model::Tai const& value)
{
    m_Tai = value;
}
...
oai::lmf_server::model::Ecgi EutraLocationRm::getEcgi() const
{
    return m_Ecgi;
}
void EutraLocationRm::setEcgi(oai::lmf_server::model::Ecgi const& value)
{
    m_Ecgi = value;
}
...
oai::lmf_server::model::GlobalRanNodeId EutraLocationRm::getGlobalNgenbId() const
{
    return m_GlobalNgenbId;
}
void EutraLocationRm::setGlobalNgenbId(oai::lmf_server::model::GlobalRanNodeId const& value)
{
...
oai::lmf_server::model::GlobalRanNodeId EutraLocationRm::getGlobalENbId() const
{
    return m_GlobalENbId;
}
void EutraLocationRm::setGlobalENbId(oai::lmf_server::model::GlobalRanNodeId const& value)
{
    m_GlobalENbId = value;
