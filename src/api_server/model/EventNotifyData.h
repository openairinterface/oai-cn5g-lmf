...
public:
    ...
    /// 
    /// </summary>
    oai::lmf_server::model::ReportedEventType getReportedEventType() const;
    void setReportedEventType(oai::lmf_server::model::ReportedEventType const& value);
    /// <summary>
    /// 
    /// </summary>
    ...
    /// 
    /// </summary>
    oai::lmf_server::model::TerminationCause getTerminationCause() const;
    void setTerminationCause(oai::lmf_server::model::TerminationCause const& value);
...
protected:
    oai::lmf_server::model::ReportedEventType m_ReportedEventType;
    ...
    oai::lmf_server::model::TerminationCause m_TerminationCause;
