...
oai::lmf_server::model::CellGlobalId UtraLocation::getCgi() const
{
    return m_Cgi;
}
void UtraLocation::setCgi(oai::lmf_server::model::CellGlobalId const& value)
{
    m_Cgi = value;
    m_CgiIsSet = true;
}
...
oai::lmf_server::model::ServiceAreaId UtraLocation::getSai() const
{
    return m_Sai;
}
void UtraLocation::setSai(oai::lmf_server::model::ServiceAreaId const& value)
{
    m_Sai = value;
    m_SaiIsSet = true;
}
...
oai::lmf_server::model::LocationAreaId UtraLocation::getLai() const
{
    return m_Lai;
}
void UtraLocation::setLai(oai::lmf_server::model::LocationAreaId const& value)
{
    m_Lai = value;
    m_LaiIsSet = true;
}
...
oai::lmf_server::model::RoutingAreaId UtraLocation::getRai() const
{
    return m_Rai;
}
void UtraLocation::setRai(oai::lmf_server::model::RoutingAreaId const& value)
{
    m_Rai = value;
    m_RaiIsSet = true;
}
