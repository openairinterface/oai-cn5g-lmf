...
bool PresenceInfoRm::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<oai::lmf_server::model::Tai>& value = m_TrackingAreaList;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::lmf_server::model::Tai& value : value)
            { 
    ...
    if (ecgiListIsSet())
    {
        const std::vector<oai::lmf_server::model::Ecgi>& value = m_EcgiList;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::lmf_server::model::Ecgi& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
    ...
    if (ncgiListIsSet())
    {
        const std::vector<oai::lmf_server::model::Ncgi>& value = m_NcgiList;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::lmf_server::model::Ncgi& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
    ...
    {
        const std::vector<oai::lmf_server::model::GlobalRanNodeId>& value = m_GlobalRanNodeIdList;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::lmf_server::model::GlobalRanNodeId& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
    ...
    {
        const std::vector<oai::lmf_server::model::GlobalRanNodeId>& value = m_GlobaleNbIdList;
...
oai::lmf_server::model::PresenceState PresenceInfoRm::getPresenceState() const
{
    return m_PresenceState;
}
void PresenceInfoRm::setPresenceState(oai::lmf_server::model::PresenceState const& value)
{
...
std::vector<oai::lmf_server::model::Tai> PresenceInfoRm::getTrackingAreaList() const
{
    return m_TrackingAreaList;
}
void PresenceInfoRm::setTrackingAreaList(std::vector<oai::lmf_server::model::Tai> const& value)
{
...
std::vector<oai::lmf_server::model::Ecgi> PresenceInfoRm::getEcgiList() const
{
    return m_EcgiList;
}
void PresenceInfoRm::setEcgiList(std::vector<oai::lmf_server::model::Ecgi> const& value)
{
    m_EcgiList = value;
...
std::vector<oai::lmf_server::model::Ncgi> PresenceInfoRm::getNcgiList() const
{
    return m_NcgiList;
}
void PresenceInfoRm::setNcgiList(std::vector<oai::lmf_server::model::Ncgi> const& value)
{
    m_NcgiList = value;
...
std::vector<oai::lmf_server::model::GlobalRanNodeId> PresenceInfoRm::getGlobalRanNodeIdList() const
{
    return m_GlobalRanNodeIdList;
}
void PresenceInfoRm::setGlobalRanNodeIdList(std::vector<oai::lmf_server::model::GlobalRanNodeId> const& value)
{
...
std::vector<oai::lmf_server::model::GlobalRanNodeId> PresenceInfoRm::getGlobaleNbIdList() const
{
    return m_GlobaleNbIdList;
}
void PresenceInfoRm::setGlobaleNbIdList(std::vector<oai::lmf_server::model::GlobalRanNodeId> const& value)
{
