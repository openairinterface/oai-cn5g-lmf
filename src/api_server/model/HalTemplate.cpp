...
bool HalTemplate::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    if (propertiesIsSet())
    {
        const std::vector<oai::lmf_server::model::Property>& value = m_Properties;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::lmf_server::model::Property& value : value)
            { 
...
oai::lmf_server::model::HttpMethod HalTemplate::getMethod() const
{
    return m_Method;
}
void HalTemplate::setMethod(oai::lmf_server::model::HttpMethod const& value)
{
    m_Method = value;
}
...
std::vector<oai::lmf_server::model::Property> HalTemplate::getProperties() const
{
    return m_Properties;
}
void HalTemplate::setProperties(std::vector<oai::lmf_server::model::Property> const& value)
{
    m_Properties = value;
