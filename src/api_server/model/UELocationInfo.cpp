...
oai::lmf_server::model::GeographicArea UELocationInfo::getLocationEstimate() const
{
    return m_LocationEstimate;
}
void UELocationInfo::setLocationEstimate(oai::lmf_server::model::GeographicArea const& value)
{
...
oai::lmf_server::model::VelocityEstimate UELocationInfo::getVelocityEstimate() const
{
    return m_VelocityEstimate;
}
void UELocationInfo::setVelocityEstimate(oai::lmf_server::model::VelocityEstimate const& value)
{
