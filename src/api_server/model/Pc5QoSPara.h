...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::lmf_server::model::Pc5QosFlowItem> getPc5QosFlowList() const;
    void setPc5QosFlowList(std::vector<oai::lmf_server::model::Pc5QosFlowItem> const& value);
    /// <summary>
    /// 
    /// </summary>
...
protected:
    std::vector<oai::lmf_server::model::Pc5QosFlowItem> m_Pc5QosFlowList;
