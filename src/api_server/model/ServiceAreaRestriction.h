...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::lmf_server::model::Area> getAreas() const;
    void setAreas(std::vector<oai::lmf_server::model::Area> const& value);
...
protected:
    ...
    std::vector<oai::lmf_server::model::Area> m_Areas;
    bool m_AreasIsSet;
