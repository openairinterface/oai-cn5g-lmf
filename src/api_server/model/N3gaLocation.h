...
public:
    ...
    /// 
    /// </summary>
    oai::lmf_server::model::Tai getN3gppTai() const;
    void setN3gppTai(oai::lmf_server::model::Tai const& value);
    ...
    /// 
    /// </summary>
    oai::lmf_server::model::Ipv6Addr getUeIpv6Addr() const;
    void setUeIpv6Addr(oai::lmf_server::model::Ipv6Addr const& value);
    ...
    /// 
    /// </summary>
    oai::lmf_server::model::TnapId getTnapId() const;
    void setTnapId(oai::lmf_server::model::TnapId const& value);
    bool tnapIdIsSet() const;
    void unsetTnapId();
    /// <summary>
    /// 
    /// </summary>
    oai::lmf_server::model::TransportProtocol getProtocol() const;
    void setProtocol(oai::lmf_server::model::TransportProtocol const& value);
    bool protocolIsSet() const;
    void unsetProtocol();
    /// <summary>
    /// 
    /// </summary>
    oai::lmf_server::model::TwapId getTwapId() const;
    void setTwapId(oai::lmf_server::model::TwapId const& value);
    bool twapIdIsSet() const;
    void unsetTwapId();
    /// <summary>
    /// 
    /// </summary>
    oai::lmf_server::model::HfcNodeId getHfcNodeId() const;
    void setHfcNodeId(oai::lmf_server::model::HfcNodeId const& value);
    ...
    /// 
    /// </summary>
    oai::lmf_server::model::LineType getW5gbanLineType() const;
    void setW5gbanLineType(oai::lmf_server::model::LineType const& value);
...
protected:
    oai::lmf_server::model::Tai m_N3gppTai;
    bool m_N3gppTaiIsSet;
    std::string m_N3IwfId;
    bool m_N3IwfIdIsSet;
    std::string m_UeIpv4Addr;
    bool m_UeIpv4AddrIsSet;
    oai::lmf_server::model::Ipv6Addr m_UeIpv6Addr;
    bool m_UeIpv6AddrIsSet;
    int32_t m_PortNumber;
    bool m_PortNumberIsSet;
    oai::lmf_server::model::TnapId m_TnapId;
    bool m_TnapIdIsSet;
    oai::lmf_server::model::TransportProtocol m_Protocol;
    bool m_ProtocolIsSet;
    oai::lmf_server::model::TwapId m_TwapId;
    bool m_TwapIdIsSet;
    oai::lmf_server::model::HfcNodeId m_HfcNodeId;
    bool m_HfcNodeIdIsSet;
    std::string m_Gli;
    bool m_GliIsSet;
    oai::lmf_server::model::LineType m_W5gbanLineType;
