...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::lmf_server::model::Tai> getTaiList() const;
    void setTaiList(std::vector<oai::lmf_server::model::Tai> const& value);

    friend void to_json(nlohmann::json& j, const AreaOfValidity& o);
    friend void from_json(const nlohmann::json& j, AreaOfValidity& o);
protected:
    std::vector<oai::lmf_server::model::Tai> m_TaiList;
