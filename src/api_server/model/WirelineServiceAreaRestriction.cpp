...
bool WirelineServiceAreaRestriction::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    if (areasIsSet())
    {
        const std::vector<oai::lmf_server::model::WirelineArea>& value = m_Areas;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::lmf_server::model::WirelineArea& value : value)
            { 
...
oai::lmf_server::model::RestrictionType WirelineServiceAreaRestriction::getRestrictionType() const
{
    return m_RestrictionType;
}
void WirelineServiceAreaRestriction::setRestrictionType(oai::lmf_server::model::RestrictionType const& value)
{
...
std::vector<oai::lmf_server::model::WirelineArea> WirelineServiceAreaRestriction::getAreas() const
{
    return m_Areas;
}
void WirelineServiceAreaRestriction::setAreas(std::vector<oai::lmf_server::model::WirelineArea> const& value)
{
    m_Areas = value;
    m_AreasIsSet = true;
}
