...
oai::lmf_server::model::SupportedGADShapes PointUncertaintyCircle::getShape() const
{
    return m_Shape;
}
void PointUncertaintyCircle::setShape(oai::lmf_server::model::SupportedGADShapes const& value)
{
    m_Shape = value;
}
oai::lmf_server::model::GeographicalCoordinates PointUncertaintyCircle::getPoint() const
{
    return m_Point;
}
void PointUncertaintyCircle::setPoint(oai::lmf_server::model::GeographicalCoordinates const& value)
{
    m_Point = value;
}
