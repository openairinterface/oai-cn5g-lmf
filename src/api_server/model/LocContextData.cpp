...
oai::lmf_server::model::PeriodicEventInfo LocContextData::getPeriodicEventInfo()
    const {
...
oai::lmf_server::model::MotionEventInfo LocContextData::getMotionEventInfo()
    const {
...
oai::lmf_server::model::EventReportMessage
...
oai::lmf_server::model::EventReportingStatus
...
oai::lmf_server::model::UELocationInfo LocContextData::getUeLocationInfo()
    const {
  return m_UeLocationInfo;
}
void LocContextData::setUeLocationInfo(
    oai::lmf_server::model::UELocationInfo const& value) {
