...
oai::lmf_server::model::UpIntegrity UpSecurity::getUpIntegr() const
{
    return m_UpIntegr;
}
void UpSecurity::setUpIntegr(oai::lmf_server::model::UpIntegrity const& value)
{
    m_UpIntegr = value;
}
oai::lmf_server::model::UpConfidentiality UpSecurity::getUpConfid() const
{
    return m_UpConfid;
}
void UpSecurity::setUpConfid(oai::lmf_server::model::UpConfidentiality const& value)
{
    m_UpConfid = value;
}
