...
oai::lmf_server::model::N1MessageClass N1MessageContainer::getN1MessageClass() const
{
    return m_N1MessageClass;
}
void N1MessageContainer::setN1MessageClass(oai::lmf_server::model::N1MessageClass const& value)
{
    m_N1MessageClass = value;
}
oai::lmf_server::model::RefToBinaryData N1MessageContainer::getN1MessageContent() const
{
    return m_N1MessageContent;
}
void N1MessageContainer::setN1MessageContent(oai::lmf_server::model::RefToBinaryData const& value)
{
