...
oai::lmf_server::model::TraceDepth TraceData::getTraceDepth() const
{
    return m_TraceDepth;
}
void TraceData::setTraceDepth(oai::lmf_server::model::TraceDepth const& value)
{
    m_TraceDepth = value;
}
...
oai::lmf_server::model::Ipv6Addr TraceData::getCollectionEntityIpv6Addr() const
{
    return m_CollectionEntityIpv6Addr;
}
void TraceData::setCollectionEntityIpv6Addr(oai::lmf_server::model::Ipv6Addr const& value)
{
