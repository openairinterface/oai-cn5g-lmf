...
oai::lmf_server::model::Tai NrLocation::getTai() const
{
    return m_Tai;
}
void NrLocation::setTai(oai::lmf_server::model::Tai const& value)
{
    m_Tai = value;
}
oai::lmf_server::model::Ncgi NrLocation::getNcgi() const
{
    return m_Ncgi;
}
void NrLocation::setNcgi(oai::lmf_server::model::Ncgi const& value)
{
    m_Ncgi = value;
}
...
oai::lmf_server::model::GlobalRanNodeId NrLocation::getGlobalGnbId() const
{
    return m_GlobalGnbId;
}
void NrLocation::setGlobalGnbId(oai::lmf_server::model::GlobalRanNodeId const& value)
{
    m_GlobalGnbId = value;
