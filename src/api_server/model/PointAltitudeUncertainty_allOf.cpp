...
oai::lmf_server::model::GeographicalCoordinates PointAltitudeUncertainty_allOf::getPoint() const
{
    return m_Point;
}
void PointAltitudeUncertainty_allOf::setPoint(oai::lmf_server::model::GeographicalCoordinates const& value)
{
    m_Point = value;
}
...
oai::lmf_server::model::UncertaintyEllipse PointAltitudeUncertainty_allOf::getUncertaintyEllipse() const
{
    return m_UncertaintyEllipse;
}
void PointAltitudeUncertainty_allOf::setUncertaintyEllipse(oai::lmf_server::model::UncertaintyEllipse const& value)
{
