...
oai::lmf_server::model::SupportedGADShapes EllipsoidArc::getShape() const
{
    return m_Shape;
}
void EllipsoidArc::setShape(oai::lmf_server::model::SupportedGADShapes const& value)
{
    m_Shape = value;
}
oai::lmf_server::model::GeographicalCoordinates EllipsoidArc::getPoint() const
{
    return m_Point;
}
void EllipsoidArc::setPoint(oai::lmf_server::model::GeographicalCoordinates const& value)
{
    m_Point = value;
}
