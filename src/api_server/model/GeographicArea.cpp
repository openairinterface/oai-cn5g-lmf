...
bool GeographicArea::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    /* PointList */ {
        const std::vector<oai::lmf_server::model::GeographicalCoordinates>& value = m_PointList;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::lmf_server::model::GeographicalCoordinates& value : value)
            { 
...
oai::lmf_server::model::SupportedGADShapes GeographicArea::getShape() const
{
    return m_Shape;
}
void GeographicArea::setShape(oai::lmf_server::model::SupportedGADShapes const& value)
{
    m_Shape = value;
}
oai::lmf_server::model::GeographicalCoordinates GeographicArea::getPoint() const
{
    return m_Point;
}
void GeographicArea::setPoint(oai::lmf_server::model::GeographicalCoordinates const& value)
{
    m_Point = value;
}
...
oai::lmf_server::model::UncertaintyEllipse GeographicArea::getUncertaintyEllipse() const
{
    return m_UncertaintyEllipse;
}
void GeographicArea::setUncertaintyEllipse(oai::lmf_server::model::UncertaintyEllipse const& value)
{
...
std::vector<oai::lmf_server::model::GeographicalCoordinates> GeographicArea::getPointList() const
{
    return m_PointList;
}
void GeographicArea::setPointList(std::vector<oai::lmf_server::model::GeographicalCoordinates> const& value)
{
    m_PointList = value;
}
