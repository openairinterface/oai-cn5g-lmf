...
bool GeographicArea::validate(
  ...
  /* PointList */ {
    const std::vector<oai::lmf_server::model::GeographicalCoordinates>& value =
        m_PointList;
    ...
    {  // Recursive validation of array elements
      ...
      int i                          = 0;
      for (const oai::lmf_server::model::GeographicalCoordinates& value :
           value) {
...
void GeographicArea::setShape(
    oai::lmf_server::model::SupportedGADShapes const& value) {
  m_Shape = value;
}
oai::lmf_server::model::GeographicalCoordinates GeographicArea::getPoint()
    const {
  return m_Point;
}
void GeographicArea::setPoint(
    oai::lmf_server::model::GeographicalCoordinates const& value) {
  m_Point = value;
}
...
oai::lmf_server::model::UncertaintyEllipse
...
std::vector<oai::lmf_server::model::GeographicalCoordinates>
GeographicArea::getPointList() const {
  return m_PointList;
}
void GeographicArea::setPointList(
    std::vector<oai::lmf_server::model::GeographicalCoordinates> const& value) {
  m_PointList = value;
}
