...
public:
    ...
    /// 
    /// </summary>
    oai::lmf_server::model::PlmnId getPlmnId() const;
    void setPlmnId(oai::lmf_server::model::PlmnId const& value);
    /// <summary>
    /// 
    /// </summary>
    ...
    /// 
    /// </summary>
    oai::lmf_server::model::GNbId getGNbId() const;
    void setGNbId(oai::lmf_server::model::GNbId const& value);
...
protected:
    oai::lmf_server::model::PlmnId m_PlmnId;

    std::string m_N3IwfId;
    bool m_N3IwfIdIsSet;
    oai::lmf_server::model::GNbId m_GNbId;
    bool m_GNbIdIsSet;
