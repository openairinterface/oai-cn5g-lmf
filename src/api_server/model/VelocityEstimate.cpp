...
oai::lmf_server::model::VerticalDirection VelocityEstimate::getVDirection() const
{
    return m_VDirection;
}
void VelocityEstimate::setVDirection(oai::lmf_server::model::VerticalDirection const& value)
{
    m_VDirection = value;
}
