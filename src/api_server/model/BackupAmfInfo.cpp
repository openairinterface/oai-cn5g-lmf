...
bool BackupAmfInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    if (guamiListIsSet())
    {
        const std::vector<oai::lmf_server::model::Guami>& value = m_GuamiList;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::lmf_server::model::Guami& value : value)
            { 
...
std::vector<oai::lmf_server::model::Guami> BackupAmfInfo::getGuamiList() const
{
    return m_GuamiList;
}
void BackupAmfInfo::setGuamiList(std::vector<oai::lmf_server::model::Guami> const& value)
{
    m_GuamiList = value;
