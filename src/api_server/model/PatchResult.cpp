...
bool PatchResult::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    /* Report */ {
        const std::vector<oai::lmf_server::model::ReportItem>& value = m_Report;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::lmf_server::model::ReportItem& value : value)
            { 
...
std::vector<oai::lmf_server::model::ReportItem> PatchResult::getReport() const
{
    return m_Report;
}
void PatchResult::setReport(std::vector<oai::lmf_server::model::ReportItem> const& value)
{
    m_Report = value;
}
