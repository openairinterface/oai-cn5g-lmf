...
oai::lmf_server::model::PositioningMethod PositioningMethodAndUsage::getMethod()
    const {
  return m_Method;
}
void PositioningMethodAndUsage::setMethod(
    oai::lmf_server::model::PositioningMethod const& value) {
  m_Method = value;
}
oai::lmf_server::model::PositioningMode PositioningMethodAndUsage::getMode()
    const {
  return m_Mode;
}
void PositioningMethodAndUsage::setMode(
    oai::lmf_server::model::PositioningMode const& value) {
  m_Mode = value;
}
...
void PositioningMethodAndUsage::setUsage(
    oai::lmf_server::model::Usage const& value) {
  m_Usage = value;
}
