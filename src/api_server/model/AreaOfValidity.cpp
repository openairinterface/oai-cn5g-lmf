...
bool AreaOfValidity::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    /* TaiList */ {
        const std::vector<oai::lmf_server::model::Tai>& value = m_TaiList;
...
std::vector<oai::lmf_server::model::Tai> AreaOfValidity::getTaiList() const
{
    return m_TaiList;
}
void AreaOfValidity::setTaiList(std::vector<oai::lmf_server::model::Tai> const& value)
{
    m_TaiList = value;
}
