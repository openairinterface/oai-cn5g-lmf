...
oai::lmf_server::model::N2InfoContent N2SmInformation::getN2InfoContent()
    const {
  return m_N2InfoContent;
}
void N2SmInformation::setN2InfoContent(
    oai::lmf_server::model::N2InfoContent const& value) {
...
void N2SmInformation::setHomePlmnSnssai(
    oai::lmf_server::model::Snssai const& value) {
