...
oai::lmf_server::model::GeographicalCoordinates PointUncertaintyEllipse_allOf::getPoint() const
{
    return m_Point;
}
void PointUncertaintyEllipse_allOf::setPoint(oai::lmf_server::model::GeographicalCoordinates const& value)
{
    m_Point = value;
}
oai::lmf_server::model::UncertaintyEllipse PointUncertaintyEllipse_allOf::getUncertaintyEllipse() const
{
    return m_UncertaintyEllipse;
}
void PointUncertaintyEllipse_allOf::setUncertaintyEllipse(oai::lmf_server::model::UncertaintyEllipse const& value)
{
