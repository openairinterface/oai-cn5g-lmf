...
public:
    ...
    /// 
    /// </summary>
    oai::lmf_server::model::GlobalRanNodeId getGlobalGnbId() const;
    void setGlobalGnbId(oai::lmf_server::model::GlobalRanNodeId const& value);
...
protected:
    ...
    oai::lmf_server::model::GlobalRanNodeId m_GlobalGnbId;
