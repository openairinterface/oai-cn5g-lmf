...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::lmf_server::model::ReportingArea> getAreaDefinition() const;
    void setAreaDefinition(std::vector<oai::lmf_server::model::ReportingArea> const& value);
    /// <summary>
    /// 
    /// </summary>
    oai::lmf_server::model::OccurrenceInfo getOccurrenceInfo() const;
    void setOccurrenceInfo(oai::lmf_server::model::OccurrenceInfo const& value);
...
protected:
    std::vector<oai::lmf_server::model::ReportingArea> m_AreaDefinition;

    oai::lmf_server::model::OccurrenceInfo m_OccurrenceInfo;
