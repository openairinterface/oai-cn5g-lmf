...
public:
    ...
    /// 
    /// </summary>
    oai::lmf_server::model::ResponseTime getResponseTime() const;
    void setResponseTime(oai::lmf_server::model::ResponseTime const& value);
    bool responseTimeIsSet() const;
    void unsetResponseTime();
    /// <summary>
    /// 
    /// </summary>
    oai::lmf_server::model::LcsQosClass getLcsQosClass() const;
    void setLcsQosClass(oai::lmf_server::model::LcsQosClass const& value);
...
protected:
    ...
    oai::lmf_server::model::ResponseTime m_ResponseTime;
    bool m_ResponseTimeIsSet;
    oai::lmf_server::model::LcsQosClass m_LcsQosClass;
