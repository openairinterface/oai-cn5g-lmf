...
public:
    ...
    /// 
    /// </summary>
    oai::lmf_server::model::Ipv6Addr getAcsIpv6Addr() const;
    void setAcsIpv6Addr(oai::lmf_server::model::Ipv6Addr const& value);
...
protected:
    ...
    oai::lmf_server::model::Ipv6Addr m_AcsIpv6Addr;
