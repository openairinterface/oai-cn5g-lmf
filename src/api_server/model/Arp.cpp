...
oai::lmf_server::model::PreemptionCapability Arp::getPreemptCap() const
{
    return m_PreemptCap;
}
void Arp::setPreemptCap(oai::lmf_server::model::PreemptionCapability const& value)
{
    m_PreemptCap = value;
}
oai::lmf_server::model::PreemptionVulnerability Arp::getPreemptVuln() const
{
    return m_PreemptVuln;
}
void Arp::setPreemptVuln(oai::lmf_server::model::PreemptionVulnerability const& value)
{
    m_PreemptVuln = value;
}
