...
class V2xInformation {
 public:
  ...
  ///
  /// </summary>
  oai::lmf_server::model::N2InfoContent getN2Pc5Pol() const;
  void setN2Pc5Pol(oai::lmf_server::model::N2InfoContent const& value);
 ...
 protected:
  oai::lmf_server::model::N2InfoContent m_N2Pc5Pol;
