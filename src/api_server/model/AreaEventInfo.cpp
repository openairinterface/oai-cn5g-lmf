...
bool AreaEventInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    /* AreaDefinition */ {
        const std::vector<oai::lmf_server::model::ReportingArea>& value = m_AreaDefinition;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::lmf_server::model::ReportingArea& value : value)
            { 
...
std::vector<oai::lmf_server::model::ReportingArea> AreaEventInfo::getAreaDefinition() const
{
    return m_AreaDefinition;
}
void AreaEventInfo::setAreaDefinition(std::vector<oai::lmf_server::model::ReportingArea> const& value)
{
    m_AreaDefinition = value;
}
oai::lmf_server::model::OccurrenceInfo AreaEventInfo::getOccurrenceInfo() const
{
    return m_OccurrenceInfo;
}
void AreaEventInfo::setOccurrenceInfo(oai::lmf_server::model::OccurrenceInfo const& value)
{
