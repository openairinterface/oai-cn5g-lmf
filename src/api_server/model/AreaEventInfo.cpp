...
bool AreaEventInfo::validate(std::stringstream &msg,
  ...
  /* AreaDefinition */ {
    const std::vector<ReportingArea> &value = m_AreaDefinition;
    ...
    { // Recursive validation of array elements
      ...
      int i = 0;
      for (const ReportingArea &value : value) {
...
std::vector<ReportingArea> AreaEventInfo::getAreaDefinition() const {
