...
bool AreaEventInfo::validate(
  ...
  /* AreaDefinition */ {
    const std::vector<oai::lmf_server::model::ReportingArea>& value =
        m_AreaDefinition;
...
std::vector<oai::lmf_server::model::ReportingArea>
...
oai::lmf_server::model::OccurrenceInfo AreaEventInfo::getOccurrenceInfo()
    const {
  return m_OccurrenceInfo;
}
void AreaEventInfo::setOccurrenceInfo(
    oai::lmf_server::model::OccurrenceInfo const& value) {
