...
public:
    ...
    /// 
    /// </summary>
    oai::lmf_server::model::PreemptionCapability getPreemptCap() const;
    void setPreemptCap(oai::lmf_server::model::PreemptionCapability const& value);
    /// <summary>
    /// 
    /// </summary>
    oai::lmf_server::model::PreemptionVulnerability getPreemptVuln() const;
    void setPreemptVuln(oai::lmf_server::model::PreemptionVulnerability const& value);
...
protected:
    ...
    oai::lmf_server::model::PreemptionCapability m_PreemptCap;

    oai::lmf_server::model::PreemptionVulnerability m_PreemptVuln;
