...
bool AccessTokenReq::validate(
  ...
  if (requesterPlmnListIsSet()) {
    const std::vector<oai::lmf_server::model::PlmnId>& value =
        m_RequesterPlmnList;
  ...
  if (requesterSnssaiListIsSet()) {
    const std::vector<oai::lmf_server::model::Snssai>& value =
  ...
  if (requesterSnpnListIsSet()) {
    const std::vector<oai::lmf_server::model::PlmnIdNid>& value =
        m_RequesterSnpnList;
...
void AccessTokenReq::setTargetNfType(
    oai::lmf_server::model::NFType const& value) {
...
void AccessTokenReq::setRequesterPlmn(
    oai::lmf_server::model::PlmnId const& value) {
...
std::vector<oai::lmf_server::model::PlmnId>
...
std::vector<oai::lmf_server::model::Snssai>
...
std::vector<oai::lmf_server::model::PlmnIdNid>
...
void AccessTokenReq::setTargetPlmn(
    oai::lmf_server::model::PlmnId const& value) {
  m_TargetPlmn      = value;
