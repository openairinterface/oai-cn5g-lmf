...
bool AccessTokenReq::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<oai::lmf_server::model::PlmnId>& value = m_RequesterPlmnList;
    ...
    {
        const std::vector<oai::lmf_server::model::Snssai>& value = m_RequesterSnssaiList;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::lmf_server::model::Snssai& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
    ...
    {
        const std::vector<oai::lmf_server::model::PlmnIdNid>& value = m_RequesterSnpnList;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::lmf_server::model::PlmnIdNid& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
    ...
    {
        const std::vector<oai::lmf_server::model::Snssai>& value = m_TargetSnssaiList;
...
oai::lmf_server::model::NFType AccessTokenReq::getNfType() const
{
    return m_NfType;
}
void AccessTokenReq::setNfType(oai::lmf_server::model::NFType const& value)
{
    m_NfType = value;
    m_NfTypeIsSet = true;
}
...
oai::lmf_server::model::NFType AccessTokenReq::getTargetNfType() const
{
    return m_TargetNfType;
}
void AccessTokenReq::setTargetNfType(oai::lmf_server::model::NFType const& value)
{
...
oai::lmf_server::model::PlmnId AccessTokenReq::getRequesterPlmn() const
{
    return m_RequesterPlmn;
}
void AccessTokenReq::setRequesterPlmn(oai::lmf_server::model::PlmnId const& value)
{
...
std::vector<oai::lmf_server::model::PlmnId> AccessTokenReq::getRequesterPlmnList() const
{
    return m_RequesterPlmnList;
}
void AccessTokenReq::setRequesterPlmnList(std::vector<oai::lmf_server::model::PlmnId> const& value)
{
...
std::vector<oai::lmf_server::model::Snssai> AccessTokenReq::getRequesterSnssaiList() const
{
    return m_RequesterSnssaiList;
}
void AccessTokenReq::setRequesterSnssaiList(std::vector<oai::lmf_server::model::Snssai> const& value)
{
...
std::vector<oai::lmf_server::model::PlmnIdNid> AccessTokenReq::getRequesterSnpnList() const
{
    return m_RequesterSnpnList;
}
void AccessTokenReq::setRequesterSnpnList(std::vector<oai::lmf_server::model::PlmnIdNid> const& value)
{
...
oai::lmf_server::model::PlmnId AccessTokenReq::getTargetPlmn() const
{
    return m_TargetPlmn;
}
void AccessTokenReq::setTargetPlmn(oai::lmf_server::model::PlmnId const& value)
{
    m_TargetPlmn = value;
...
std::vector<oai::lmf_server::model::Snssai> AccessTokenReq::getTargetSnssaiList() const
{
    return m_TargetSnssaiList;
}
void AccessTokenReq::setTargetSnssaiList(std::vector<oai::lmf_server::model::Snssai> const& value)
{
