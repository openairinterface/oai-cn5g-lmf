...
oai::lmf_server::model::SupportedGADShapes PointAltitudeUncertainty::getShape() const
{
    return m_Shape;
}
void PointAltitudeUncertainty::setShape(oai::lmf_server::model::SupportedGADShapes const& value)
{
    m_Shape = value;
}
oai::lmf_server::model::GeographicalCoordinates PointAltitudeUncertainty::getPoint() const
{
    return m_Point;
}
void PointAltitudeUncertainty::setPoint(oai::lmf_server::model::GeographicalCoordinates const& value)
{
    m_Point = value;
}
...
oai::lmf_server::model::UncertaintyEllipse PointAltitudeUncertainty::getUncertaintyEllipse() const
{
    return m_UncertaintyEllipse;
}
void PointAltitudeUncertainty::setUncertaintyEllipse(oai::lmf_server::model::UncertaintyEllipse const& value)
{
