...
oai::lmf_server::model::AccessType UeConnectivityState::getAccessType() const
{
    return m_AccessType;
}
void UeConnectivityState::setAccessType(oai::lmf_server::model::AccessType const& value)
{
    m_AccessType = value;
}
oai::lmf_server::model::CmState UeConnectivityState::getConnectivitystate() const
{
    return m_Connectivitystate;
}
void UeConnectivityState::setConnectivitystate(oai::lmf_server::model::CmState const& value)
{
