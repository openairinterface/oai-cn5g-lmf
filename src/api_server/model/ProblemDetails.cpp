...
bool ProblemDetails::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<oai::lmf_server::model::InvalidParam>& value = m_InvalidParams;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::lmf_server::model::InvalidParam& value : value)
            { 
...
std::vector<oai::lmf_server::model::InvalidParam> ProblemDetails::getInvalidParams() const
{
    return m_InvalidParams;
}
void ProblemDetails::setInvalidParams(std::vector<oai::lmf_server::model::InvalidParam> const& value)
{
...
oai::lmf_server::model::AccessTokenErr ProblemDetails::getAccessTokenError() const
{
    return m_AccessTokenError;
}
void ProblemDetails::setAccessTokenError(oai::lmf_server::model::AccessTokenErr const& value)
{
...
oai::lmf_server::model::AccessTokenReq ProblemDetails::getAccessTokenRequest() const
{
    return m_AccessTokenRequest;
}
void ProblemDetails::setAccessTokenRequest(oai::lmf_server::model::AccessTokenReq const& value)
{
