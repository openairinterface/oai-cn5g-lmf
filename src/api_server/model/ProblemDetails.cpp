...
bool ProblemDetails::validate(
  ...
  if (invalidParamsIsSet()) {
    const std::vector<oai::lmf_server::model::InvalidParam>& value =
        m_InvalidParams;
...
std::vector<oai::lmf_server::model::InvalidParam>
...
oai::lmf_server::model::AccessTokenErr ProblemDetails::getAccessTokenError()
    const {
  return m_AccessTokenError;
}
void ProblemDetails::setAccessTokenError(
    oai::lmf_server::model::AccessTokenErr const& value) {
...
oai::lmf_server::model::AccessTokenReq ProblemDetails::getAccessTokenRequest()
    const {
