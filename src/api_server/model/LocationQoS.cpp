...
oai::lmf_server::model::ResponseTime LocationQoS::getResponseTime() const
{
    return m_ResponseTime;
}
void LocationQoS::setResponseTime(oai::lmf_server::model::ResponseTime const& value)
{
...
oai::lmf_server::model::LcsQosClass LocationQoS::getLcsQosClass() const
{
    return m_LcsQosClass;
}
void LocationQoS::setLcsQosClass(oai::lmf_server::model::LcsQosClass const& value)
{
    m_LcsQosClass = value;
