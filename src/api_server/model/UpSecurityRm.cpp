...
oai::lmf_server::model::UpIntegrity UpSecurityRm::getUpIntegr() const
{
    return m_UpIntegr;
}
void UpSecurityRm::setUpIntegr(oai::lmf_server::model::UpIntegrity const& value)
{
    m_UpIntegr = value;
}
oai::lmf_server::model::UpConfidentiality UpSecurityRm::getUpConfid() const
{
    return m_UpConfid;
}
void UpSecurityRm::setUpConfid(oai::lmf_server::model::UpConfidentiality const& value)
{
    m_UpConfid = value;
}
