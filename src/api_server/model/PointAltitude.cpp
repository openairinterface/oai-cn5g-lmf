...
oai::lmf_server::model::SupportedGADShapes PointAltitude::getShape() const
{
    return m_Shape;
}
void PointAltitude::setShape(oai::lmf_server::model::SupportedGADShapes const& value)
{
    m_Shape = value;
}
oai::lmf_server::model::GeographicalCoordinates PointAltitude::getPoint() const
{
    return m_Point;
}
void PointAltitude::setPoint(oai::lmf_server::model::GeographicalCoordinates const& value)
{
    m_Point = value;
}
