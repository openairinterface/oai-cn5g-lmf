...
public:
    ...
    /// 
    /// </summary>
    oai::lmf_server::model::QosResourceType getResourceType() const;
    void setResourceType(oai::lmf_server::model::QosResourceType const& value);
    /// <summary>
    /// 
    /// </summary>
...
protected:
    oai::lmf_server::model::QosResourceType m_ResourceType;
