...
bool PwsInformation::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<oai::lmf_server::model::GlobalRanNodeId>& value = m_BcEmptyAreaList;
...
oai::lmf_server::model::N2InfoContent PwsInformation::getPwsContainer() const
{
    return m_PwsContainer;
}
void PwsInformation::setPwsContainer(oai::lmf_server::model::N2InfoContent const& value)
{
    m_PwsContainer = value;
}
std::vector<oai::lmf_server::model::GlobalRanNodeId> PwsInformation::getBcEmptyAreaList() const
{
    return m_BcEmptyAreaList;
}
void PwsInformation::setBcEmptyAreaList(std::vector<oai::lmf_server::model::GlobalRanNodeId> const& value)
{
