...
oai::lmf_server::model::ReportedEventType
...
oai::lmf_server::model::GeographicArea EventNotifyData::getLocationEstimate()
    const {
...
oai::lmf_server::model::TerminationCause EventNotifyData::getTerminationCause()
    const {
...
oai::lmf_server::model::VelocityEstimate EventNotifyData::getVelocityEstimate()
    const {
