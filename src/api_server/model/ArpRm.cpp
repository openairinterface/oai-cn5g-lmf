...
oai::lmf_server::model::PreemptionCapability ArpRm::getPreemptCap() const
{
    return m_PreemptCap;
}
void ArpRm::setPreemptCap(oai::lmf_server::model::PreemptionCapability const& value)
{
    m_PreemptCap = value;
}
oai::lmf_server::model::PreemptionVulnerability ArpRm::getPreemptVuln() const
{
    return m_PreemptVuln;
}
void ArpRm::setPreemptVuln(oai::lmf_server::model::PreemptionVulnerability const& value)
{
    m_PreemptVuln = value;
}
