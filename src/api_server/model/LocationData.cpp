...
bool LocationData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<PositioningMethodAndUsage>& value = m_PositioningDataList;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const PositioningMethodAndUsage& value : value)
            { 
    ...
    {
        const std::vector<GnssPositioningMethodAndUsage>& value = m_GnssPositioningDataList;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const GnssPositioningMethodAndUsage& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
    ...
    if (altitudeIsSet())
    {
        const float& value = m_Altitude;
        const std::string currentValuePath = _pathPrefix + ".altitude";
                
        
        if (value < static_cast<float>(-32767))
        {
            success = false;
...
AccuracyFulfilmentIndicator LocationData::getAccuracyFulfilmentIndicator() const
{
    return m_AccuracyFulfilmentIndicator;
}
void LocationData::setAccuracyFulfilmentIndicator(AccuracyFulfilmentIndicator const& value)
{
...
CivicAddress LocationData::getCivicAddress() const
{
...
std::vector<PositioningMethodAndUsage> LocationData::getPositioningDataList() const
{
    return m_PositioningDataList;
}
void LocationData::setPositioningDataList(std::vector<PositioningMethodAndUsage> const& value)
{
...
std::vector<GnssPositioningMethodAndUsage> LocationData::getGnssPositioningDataList() const
{
    return m_GnssPositioningDataList;
}
void LocationData::setGnssPositioningDataList(std::vector<GnssPositioningMethodAndUsage> const& value)
{
...
Ecgi LocationData::getEcgi() const
{
    return m_Ecgi;
}
...
Ncgi LocationData::getNcgi() const
{
    return m_Ncgi;
}
...
float LocationData::getAltitude() const
{
    return m_Altitude;
}
void LocationData::setAltitude(float const value)
{
    m_Altitude = value;
