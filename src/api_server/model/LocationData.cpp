...
bool LocationData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    {
        const std::vector<oai::lmf_server::model::PositioningMethodAndUsage>& value = m_PositioningDataList;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::lmf_server::model::PositioningMethodAndUsage& value : value)
            { 
    ...
    {
        const std::vector<oai::lmf_server::model::GnssPositioningMethodAndUsage>& value = m_GnssPositioningDataList;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const oai::lmf_server::model::GnssPositioningMethodAndUsage& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
...
oai::lmf_server::model::GeographicArea LocationData::getLocationEstimate() const
{
    return m_LocationEstimate;
}
void LocationData::setLocationEstimate(oai::lmf_server::model::GeographicArea const& value)
{
    m_LocationEstimate = value;
}
oai::lmf_server::model::AccuracyFulfilmentIndicator LocationData::getAccuracyFulfilmentIndicator() const
{
    return m_AccuracyFulfilmentIndicator;
}
void LocationData::setAccuracyFulfilmentIndicator(oai::lmf_server::model::AccuracyFulfilmentIndicator const& value)
{
...
oai::lmf_server::model::VelocityEstimate LocationData::getVelocityEstimate() const
{
    return m_VelocityEstimate;
}
void LocationData::setVelocityEstimate(oai::lmf_server::model::VelocityEstimate const& value)
{
...
oai::lmf_server::model::CivicAddress LocationData::getCivicAddress() const
{
    return m_CivicAddress;
}
void LocationData::setCivicAddress(oai::lmf_server::model::CivicAddress const& value)
{
...
std::vector<oai::lmf_server::model::PositioningMethodAndUsage> LocationData::getPositioningDataList() const
{
    return m_PositioningDataList;
}
void LocationData::setPositioningDataList(std::vector<oai::lmf_server::model::PositioningMethodAndUsage> const& value)
{
...
std::vector<oai::lmf_server::model::GnssPositioningMethodAndUsage> LocationData::getGnssPositioningDataList() const
{
    return m_GnssPositioningDataList;
}
void LocationData::setGnssPositioningDataList(std::vector<oai::lmf_server::model::GnssPositioningMethodAndUsage> const& value)
{
...
oai::lmf_server::model::Ecgi LocationData::getEcgi() const
{
    return m_Ecgi;
}
void LocationData::setEcgi(oai::lmf_server::model::Ecgi const& value)
{
    m_Ecgi = value;
    m_EcgiIsSet = true;
}
...
oai::lmf_server::model::Ncgi LocationData::getNcgi() const
{
    return m_Ncgi;
}
void LocationData::setNcgi(oai::lmf_server::model::Ncgi const& value)
{
    m_Ncgi = value;
    m_NcgiIsSet = true;
}
