...
bool LocationData::validate(
  ...
  if (positioningDataListIsSet()) {
    const std::vector<oai::lmf_server::model::PositioningMethodAndUsage>&
        value                          = m_PositioningDataList;
    ...
    {  // Recursive validation of array elements
      ...
      int i                          = 0;
      for (const oai::lmf_server::model::PositioningMethodAndUsage& value :
           value) {
  ...
  if (gnssPositioningDataListIsSet()) {
    const std::vector<oai::lmf_server::model::GnssPositioningMethodAndUsage>&
        value = m_GnssPositioningDataList;
    const std::string currentValuePath =
    ...
    {  // Recursive validation of array elements
      const std::string oldValuePath = currentValuePath;
      int i                          = 0;
      for (const oai::lmf_server::model::GnssPositioningMethodAndUsage& value :
           value) {
        const std::string currentValuePath =
            oldValuePath + "[" + std::to_string(i) + "]";
...
oai::lmf_server::model::GeographicArea LocationData::getLocationEstimate()
    const {
  return m_LocationEstimate;
}
void LocationData::setLocationEstimate(
    oai::lmf_server::model::GeographicArea const& value) {
  m_LocationEstimate = value;
}
oai::lmf_server::model::AccuracyFulfilmentIndicator
...
void LocationData::setAccuracyFulfilmentIndicator(
    oai::lmf_server::model::AccuracyFulfilmentIndicator const& value) {
...
oai::lmf_server::model::VelocityEstimate LocationData::getVelocityEstimate()
    const {
  return m_VelocityEstimate;
}
void LocationData::setVelocityEstimate(
    oai::lmf_server::model::VelocityEstimate const& value) {
...
void LocationData::setCivicAddress(
    oai::lmf_server::model::CivicAddress const& value) {
...
std::vector<oai::lmf_server::model::PositioningMethodAndUsage>
LocationData::getPositioningDataList() const {
  return m_PositioningDataList;
}
void LocationData::setPositioningDataList(
    std::vector<oai::lmf_server::model::PositioningMethodAndUsage> const&
        value) {
...
std::vector<oai::lmf_server::model::GnssPositioningMethodAndUsage>
...
void LocationData::setGnssPositioningDataList(
    std::vector<oai::lmf_server::model::GnssPositioningMethodAndUsage> const&
        value) {
