...
oai::lmf_server::model::SupportedGADShapes PointUncertaintyEllipse::getShape() const
{
    return m_Shape;
}
void PointUncertaintyEllipse::setShape(oai::lmf_server::model::SupportedGADShapes const& value)
{
    m_Shape = value;
}
oai::lmf_server::model::GeographicalCoordinates PointUncertaintyEllipse::getPoint() const
{
    return m_Point;
}
void PointUncertaintyEllipse::setPoint(oai::lmf_server::model::GeographicalCoordinates const& value)
{
    m_Point = value;
}
oai::lmf_server::model::UncertaintyEllipse PointUncertaintyEllipse::getUncertaintyEllipse() const
{
    return m_UncertaintyEllipse;
}
void PointUncertaintyEllipse::setUncertaintyEllipse(oai::lmf_server::model::UncertaintyEllipse const& value)
{
