...
oai::lmf_server::model::UeAuth NrV2xAuth::getVehicleUeAuth() const
{
    return m_VehicleUeAuth;
}
void NrV2xAuth::setVehicleUeAuth(oai::lmf_server::model::UeAuth const& value)
{
...
oai::lmf_server::model::UeAuth NrV2xAuth::getPedestrianUeAuth() const
{
    return m_PedestrianUeAuth;
}
void NrV2xAuth::setPedestrianUeAuth(oai::lmf_server::model::UeAuth const& value)
{
