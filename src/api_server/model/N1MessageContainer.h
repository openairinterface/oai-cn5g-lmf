...
public:
    ...
    /// 
    /// </summary>
    oai::lmf_server::model::N1MessageClass getN1MessageClass() const;
    void setN1MessageClass(oai::lmf_server::model::N1MessageClass const& value);
    /// <summary>
    /// 
    /// </summary>
    oai::lmf_server::model::RefToBinaryData getN1MessageContent() const;
    void setN1MessageContent(oai::lmf_server::model::RefToBinaryData const& value);
    /// <summary>
    /// 
    /// </summary>
...
protected:
    oai::lmf_server::model::N1MessageClass m_N1MessageClass;

    oai::lmf_server::model::RefToBinaryData m_N1MessageContent;
