...
oai::lmf_server::model::UeAuth LteV2xAuth::getVehicleUeAuth() const
{
    return m_VehicleUeAuth;
}
void LteV2xAuth::setVehicleUeAuth(oai::lmf_server::model::UeAuth const& value)
{
...
oai::lmf_server::model::UeAuth LteV2xAuth::getPedestrianUeAuth() const
{
    return m_PedestrianUeAuth;
}
void LteV2xAuth::setPedestrianUeAuth(oai::lmf_server::model::UeAuth const& value)
{
