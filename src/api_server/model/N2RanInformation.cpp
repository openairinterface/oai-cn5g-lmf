...
oai::lmf_server::model::N2InfoContent N2RanInformation::getN2InfoContent() const
{
    return m_N2InfoContent;
}
void N2RanInformation::setN2InfoContent(oai::lmf_server::model::N2InfoContent const& value)
{
