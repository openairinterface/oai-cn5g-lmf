...
public:
    ...
    /// 
    /// </summary>
    std::map<std::string, oai::lmf_server::model::TacInfo> getTacInfoPerPlmn() const;
    void setTacInfoPerPlmn(std::map<std::string, oai::lmf_server::model::TacInfo> const& value);
...
protected:
    ...
    bool m_TacListIsSet;
    std::map<std::string, oai::lmf_server::model::TacInfo> m_TacInfoPerPlmn;
