...
oai::lmf_server::model::RouteInformation RouteToLocation::getRouteInfo() const
{
    return m_RouteInfo;
}
void RouteToLocation::setRouteInfo(oai::lmf_server::model::RouteInformation const& value)
{
    m_RouteInfo = value;
