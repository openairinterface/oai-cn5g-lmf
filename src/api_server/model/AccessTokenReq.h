...
class AccessTokenReq {
 public:
  ...
  void setRequesterPlmnList(
      std::vector<oai::lmf_server::model::PlmnId> const& value);
  ...
  void setRequesterSnssaiList(
      std::vector<oai::lmf_server::model::Snssai> const& value);
  ...
  void setRequesterSnpnList(
      std::vector<oai::lmf_server::model::PlmnIdNid> const& value);
