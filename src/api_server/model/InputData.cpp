...
bool InputData::validate(
  ...
  if (supportedGADShapesIsSet()) {
    const std::vector<oai::lmf_server::model::SupportedGADShapes>& value =
  ...
  if (reportingAccessTypesIsSet()) {
    const std::vector<oai::lmf_server::model::ReportingAccessType>& value =
...
oai::lmf_server::model::ExternalClientType InputData::getExternalClientType()
    const {
...
void InputData::setLocationQoS(
    oai::lmf_server::model::LocationQoS const& value) {
  m_LocationQoS      = value;
...
oai::lmf_server::model::VelocityRequested InputData::getVelocityRequested()
    const {
...
void InputData::setUeLcsCap(
    oai::lmf_server::model::UeLcsCapability const& value) {
  m_UeLcsCap      = value;
...
oai::lmf_server::model::PeriodicEventInfo InputData::getPeriodicEventInfo()
    const {
...
void InputData::setAreaEventInfo(
    oai::lmf_server::model::AreaEventInfo const& value) {
...
void InputData::setMotionEventInfo(
    oai::lmf_server::model::MotionEventInfo const& value) {
...
oai::lmf_server::model::UeConnectivityState InputData::getUeConnectivityStates()
    const {
...
oai::lmf_server::model::UeLocationServiceInd
...
void InputData::setLppMessage(
    oai::lmf_server::model::RefToBinaryData const& value) {
  m_LppMessage      = value;
