...
std::map<std::string, oai::lmf_server::model::TacInfo> AreaScope::getTacInfoPerPlmn() const
{
    return m_TacInfoPerPlmn;
}
void AreaScope::setTacInfoPerPlmn(std::map<std::string, oai::lmf_server::model::TacInfo> const& value)
{
