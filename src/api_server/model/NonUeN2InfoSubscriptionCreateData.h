...
class NonUeN2InfoSubscriptionCreateData {
 public:
  ...
  ///
  /// </summary>
  std::vector<oai::lmf_server::model::GlobalRanNodeId>& getGlobalRanNodeList();
  bool globalRanNodeListIsSet() const;
  void unsetGlobalRanNodeList();
  /// <summary>
  ///
  /// </summary>
  std::vector<oai::lmf_server::model::AccessType>& getAnTypeList();
 ...
 protected:
  std::vector<oai::lmf_server::model::GlobalRanNodeId> m_GlobalRanNodeList;
  bool m_GlobalRanNodeListIsSet;
  std::vector<oai::lmf_server::model::AccessType> m_AnTypeList;
