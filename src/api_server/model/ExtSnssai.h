...
public:
    ...
    /// </summary>
    std::vector<oai::lmf_server::model::SdRange> getSdRanges() const;
    void setSdRanges(std::vector<oai::lmf_server::model::SdRange> const& value);
...
protected:
    ...
    std::string m_Sd;
    bool m_SdIsSet;
    std::vector<oai::lmf_server::model::SdRange> m_SdRanges;
