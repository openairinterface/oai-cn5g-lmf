...
class N2InfoContent {
 public:
  ...
  ///
  /// </summary>
  oai::lmf_server::model::NgapIeType getNgapIeType() const;
  void setNgapIeType(oai::lmf_server::model::NgapIeType const& value);
  bool ngapIeTypeIsSet() const;
  void unsetNgapIeType();
  /// <summary>
  ///
  /// </summary>
  oai::lmf_server::model::RefToBinaryData getNgapData() const;
  void setNgapData(oai::lmf_server::model::RefToBinaryData const& value);
 ...
 protected:
  ...
  oai::lmf_server::model::NgapIeType m_NgapIeType;
  bool m_NgapIeTypeIsSet;
  oai::lmf_server::model::RefToBinaryData m_NgapData;
};
