...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::lmf_server::model::InvalidParam> getInvalidParams() const;
    void setInvalidParams(std::vector<oai::lmf_server::model::InvalidParam> const& value);
    ...
    /// 
    /// </summary>
    oai::lmf_server::model::AccessTokenErr getAccessTokenError() const;
    void setAccessTokenError(oai::lmf_server::model::AccessTokenErr const& value);
    bool accessTokenErrorIsSet() const;
    void unsetAccessTokenError();
    /// <summary>
    /// 
    /// </summary>
    oai::lmf_server::model::AccessTokenReq getAccessTokenRequest() const;
    void setAccessTokenRequest(oai::lmf_server::model::AccessTokenReq const& value);
...
protected:
    ...
    std::string m_Cause;
    bool m_CauseIsSet;
    std::vector<oai::lmf_server::model::InvalidParam> m_InvalidParams;
    bool m_InvalidParamsIsSet;
    std::string m_SupportedFeatures;
    bool m_SupportedFeaturesIsSet;
    oai::lmf_server::model::AccessTokenErr m_AccessTokenError;
    bool m_AccessTokenErrorIsSet;
    oai::lmf_server::model::AccessTokenReq m_AccessTokenRequest;
