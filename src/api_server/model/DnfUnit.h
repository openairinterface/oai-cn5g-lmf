...
public:
    ...
    /// 
    /// </summary>
    std::vector<oai::lmf_server::model::Atom> getDnfUnit() const;
    void setDnfUnit(std::vector<oai::lmf_server::model::Atom> const& value);

    friend void to_json(nlohmann::json& j, const DnfUnit& o);
    friend void from_json(const nlohmann::json& j, DnfUnit& o);
protected:
    std::vector<oai::lmf_server::model::Atom> m_DnfUnit;
