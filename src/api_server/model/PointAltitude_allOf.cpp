...
oai::lmf_server::model::GeographicalCoordinates PointAltitude_allOf::getPoint() const
{
    return m_Point;
}
void PointAltitude_allOf::setPoint(oai::lmf_server::model::GeographicalCoordinates const& value)
{
    m_Point = value;
}
