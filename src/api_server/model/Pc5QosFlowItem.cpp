...
oai::lmf_server::model::Pc5FlowBitRates Pc5QosFlowItem::getPc5FlowBitRates() const
{
    return m_Pc5FlowBitRates;
}
void Pc5QosFlowItem::setPc5FlowBitRates(oai::lmf_server::model::Pc5FlowBitRates const& value)
{
