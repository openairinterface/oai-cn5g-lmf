...
oai::lmf_server::model::EutraLocation UserLocation::getEutraLocation() const
{
    return m_EutraLocation;
}
void UserLocation::setEutraLocation(oai::lmf_server::model::EutraLocation const& value)
{
...
oai::lmf_server::model::NrLocation UserLocation::getNrLocation() const
{
    return m_NrLocation;
}
void UserLocation::setNrLocation(oai::lmf_server::model::NrLocation const& value)
{
    m_NrLocation = value;
...
oai::lmf_server::model::N3gaLocation UserLocation::getN3gaLocation() const
{
    return m_N3gaLocation;
}
void UserLocation::setN3gaLocation(oai::lmf_server::model::N3gaLocation const& value)
{
...
oai::lmf_server::model::UtraLocation UserLocation::getUtraLocation() const
{
    return m_UtraLocation;
}
void UserLocation::setUtraLocation(oai::lmf_server::model::UtraLocation const& value)
{
...
oai::lmf_server::model::GeraLocation UserLocation::getGeraLocation() const
{
    return m_GeraLocation;
}
void UserLocation::setGeraLocation(oai::lmf_server::model::GeraLocation const& value)
{
