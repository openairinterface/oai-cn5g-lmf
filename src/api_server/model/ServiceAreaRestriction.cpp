...
bool ServiceAreaRestriction::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    if (areasIsSet())
    {
        const std::vector<oai::lmf_server::model::Area>& value = m_Areas;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const oai::lmf_server::model::Area& value : value)
            { 
...
oai::lmf_server::model::RestrictionType ServiceAreaRestriction::getRestrictionType() const
{
    return m_RestrictionType;
}
void ServiceAreaRestriction::setRestrictionType(oai::lmf_server::model::RestrictionType const& value)
{
...
std::vector<oai::lmf_server::model::Area> ServiceAreaRestriction::getAreas() const
{
    return m_Areas;
}
void ServiceAreaRestriction::setAreas(std::vector<oai::lmf_server::model::Area> const& value)
{
    m_Areas = value;
    m_AreasIsSet = true;
}
