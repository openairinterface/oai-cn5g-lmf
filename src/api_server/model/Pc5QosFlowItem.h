...
public:
    ...
    /// 
    /// </summary>
    oai::lmf_server::model::Pc5FlowBitRates getPc5FlowBitRates() const;
    void setPc5FlowBitRates(oai::lmf_server::model::Pc5FlowBitRates const& value);
...
protected:
    ...
    oai::lmf_server::model::Pc5FlowBitRates m_Pc5FlowBitRates;
