...
public:
    ...
    /// 
    /// </summary>
    oai::lmf_server::model::N2InfoContent getPwsContainer() const;
    void setPwsContainer(oai::lmf_server::model::N2InfoContent const& value);
    /// <summary>
    /// 
    /// </summary>
    std::vector<oai::lmf_server::model::GlobalRanNodeId> getBcEmptyAreaList() const;
    void setBcEmptyAreaList(std::vector<oai::lmf_server::model::GlobalRanNodeId> const& value);
...
protected:
    ...
    oai::lmf_server::model::N2InfoContent m_PwsContainer;

    std::vector<oai::lmf_server::model::GlobalRanNodeId> m_BcEmptyAreaList;
