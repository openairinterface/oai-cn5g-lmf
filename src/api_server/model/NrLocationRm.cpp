...
oai::lmf_server::model::Tai NrLocationRm::getTai() const
{
    return m_Tai;
}
void NrLocationRm::setTai(oai::lmf_server::model::Tai const& value)
{
    m_Tai = value;
}
oai::lmf_server::model::Ncgi NrLocationRm::getNcgi() const
{
    return m_Ncgi;
}
void NrLocationRm::setNcgi(oai::lmf_server::model::Ncgi const& value)
{
    m_Ncgi = value;
}
...
oai::lmf_server::model::GlobalRanNodeId NrLocationRm::getGlobalGnbId() const
{
    return m_GlobalGnbId;
}
void NrLocationRm::setGlobalGnbId(oai::lmf_server::model::GlobalRanNodeId const& value)
{
    m_GlobalGnbId = value;
