...
void LMFApiServer::init(size_t thr) {
  ...
  m_CancelLocationApiImpl->init();
  m_LocationContextTransferApiImpl->init();
  // m_RequestCipheringKeyDataApiImpl->init();
}
...
void LMFApiServer::shutdown() { m_httpEndpoint->shutdown(); }
