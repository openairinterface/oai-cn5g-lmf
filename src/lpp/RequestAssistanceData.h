...
typedef enum RequestAssistanceData__criticalExtensions__c1_PR {
  RequestAssistanceData__criticalExtensions__c1_PR_NOTHING, /* No components
                                                               present */
...
struct RequestAssistanceData_r9_IEs;
    ...
    union RequestAssistanceData__criticalExtensions_u {
      struct RequestAssistanceData__criticalExtensions__c1 {
        ...
        union RequestAssistanceData__criticalExtensions__c1_u {
          struct RequestAssistanceData_r9_IEs* requestAssistanceData_r9;
          NULL_t spare3;
          NULL_t spare2;
          NULL_t spare1;
        } choice;
