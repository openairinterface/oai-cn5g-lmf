...
static asn_oer_constraints_t asn_OER_type_GNSS_AlmanacElement_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_member_t asn_MBR_GNSS_AlmanacElement_1[] = {
	{ ATF_POINTER, 0, offsetof(struct GNSS_AlmanacElement, choice.keplerianAlmanacSet),
	...
	{ ATF_POINTER, 0, offsetof(struct GNSS_AlmanacElement, choice.keplerianNAV_Almanac),
	...
	{ ATF_POINTER, 0, offsetof(struct GNSS_AlmanacElement, choice.keplerianReducedAlmanac),
	...
	{ ATF_POINTER, 0, offsetof(struct GNSS_AlmanacElement, choice.keplerianMidiAlmanac),
	...
	{ ATF_POINTER, 0, offsetof(struct GNSS_AlmanacElement, choice.keplerianGLONASS),
	...
	{ ATF_POINTER, 0, offsetof(struct GNSS_AlmanacElement, choice.ecef_SBAS_Almanac),
	...
	{ ATF_POINTER, 0, offsetof(struct GNSS_AlmanacElement, choice.keplerianBDS_Almanac_r12),
...
asn_TYPE_descriptor_t asn_DEF_GNSS_AlmanacElement = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_GNSS_AlmanacElement_constr_1, &asn_PER_type_GNSS_AlmanacElement_constr_1, CHOICE_constraint },
