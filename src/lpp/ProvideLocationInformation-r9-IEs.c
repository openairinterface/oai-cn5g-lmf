...
static const asn_TYPE_tag2member_t asn_MAP_ext1_tag2el_8[] = {
    {(ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0,
     0}, /* sensor-ProvideLocationInformation-r13 */
    {(ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0,
     0}, /* tbs-ProvideLocationInformation-r13 */
    {(ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0,
     0}, /* wlan-ProvideLocationInformation-r13 */
    {(ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0,
     0} /* bt-ProvideLocationInformation-r13 */
};
...
static const asn_TYPE_tag2member_t asn_MAP_ext2_tag2el_13[] = {
    {(ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0,
     0}, /* nr-ECID-ProvideLocationInformation-r16 */
    {(ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0,
     0}, /* nr-Multi-RTT-ProvideLocationInformation-r16 */
    {(ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0,
     0}, /* nr-DL-AoD-ProvideLocationInformation-r16 */
    {(ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0,
     0} /* nr-DL-TDOA-ProvideLocationInformation-r16 */
};
...
asn_TYPE_member_t asn_MBR_ProvideLocationInformation_r9_IEs_1[] = {
    ...
    {ATF_POINTER,
     2,
     offsetof(struct ProvideLocationInformation_r9_IEs, ext1),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct ProvideLocationInformation_r9_IEs, ext2),
...
static const int asn_MAP_ProvideLocationInformation_r9_IEs_oms_1[] = {
    0, 1, 2, 3, 4, 5, 6};
...
static const asn_TYPE_tag2member_t
    asn_MAP_ProvideLocationInformation_r9_IEs_tag2el_1[] = {
        {(ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0,
         0}, /* commonIEsProvideLocationInformation */
        {(ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0,
         0}, /* a-gnss-ProvideLocationInformation */
        {(ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0,
         0}, /* otdoa-ProvideLocationInformation */
        {(ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0,
         0}, /* ecid-ProvideLocationInformation */
        {(ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0,
         0}, /* epdu-ProvideLocationInformation */
