...
static int memb_udre_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  long value;
...
static int memb_rangeRateCor_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  long value;
...
static int memb_udreGrowthRate_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  long value;
...
static int memb_udreValidityTime_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  long value;
...
static asn_oer_constraints_t asn_OER_memb_udreGrowthRate_constr_7 CC_NOTUSED = {
    {1, 1} /* (0..7) */,
    -1};
...
static asn_oer_constraints_t asn_OER_memb_udreValidityTime_constr_8
...
asn_TYPE_member_t asn_MBR_DGNSS_CorrectionsElement_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct DGNSS_CorrectionsElement, svID),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct DGNSS_CorrectionsElement, iod),
     (ASN_TAG_CLASS_CONTEXT | (1 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_BIT_STRING,
     0,
     {&asn_OER_memb_iod_constr_3, &asn_PER_memb_iod_constr_3,
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct DGNSS_CorrectionsElement, udre),
     (ASN_TAG_CLASS_CONTEXT | (2 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_udre_constr_4, &asn_PER_memb_udre_constr_4,
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct DGNSS_CorrectionsElement, pseudoRangeCor),
     (ASN_TAG_CLASS_CONTEXT | (3 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_pseudoRangeCor_constr_5,
      &asn_PER_memb_pseudoRangeCor_constr_5, memb_pseudoRangeCor_constraint_1},
     0,
     0, /* No default value */
     "pseudoRangeCor"},
    {ATF_NOFLAGS,
     0,
     offsetof(struct DGNSS_CorrectionsElement, rangeRateCor),
     (ASN_TAG_CLASS_CONTEXT | (4 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_rangeRateCor_constr_6, &asn_PER_memb_rangeRateCor_constr_6,
    ...
    {ATF_POINTER,
     2,
     offsetof(struct DGNSS_CorrectionsElement, udreGrowthRate),
     (ASN_TAG_CLASS_CONTEXT | (5 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_udreGrowthRate_constr_7,
      &asn_PER_memb_udreGrowthRate_constr_7, memb_udreGrowthRate_constraint_1},
     0,
     0, /* No default value */
     "udreGrowthRate"},
    {ATF_POINTER,
     1,
     offsetof(struct DGNSS_CorrectionsElement, udreValidityTime),
     (ASN_TAG_CLASS_CONTEXT | (6 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_udreValidityTime_constr_8,
