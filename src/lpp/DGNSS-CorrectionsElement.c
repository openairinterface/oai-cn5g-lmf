...
static asn_oer_constraints_t asn_OER_memb_udreValidityTime_constr_8 CC_NOTUSED = {
	{ 1, 1 }	/* (0..7) */,
	-1};
...
asn_TYPE_member_t asn_MBR_DGNSS_CorrectionsElement_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct DGNSS_CorrectionsElement, udreGrowthRate),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_udreGrowthRate_constr_7, &asn_PER_memb_udreGrowthRate_constr_7,  memb_udreGrowthRate_constraint_1 },
		0, 0, /* No default value */
		"udreGrowthRate"
		},
	{ ATF_POINTER, 1, offsetof(struct DGNSS_CorrectionsElement, udreValidityTime),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_udreValidityTime_constr_8, &asn_PER_memb_udreValidityTime_constr_8,  memb_udreValidityTime_constraint_1 },
		0, 0, /* No default value */
		"udreValidityTime"
		},
};
