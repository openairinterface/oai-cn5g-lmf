...
static asn_oer_constraints_t asn_OER_memb_clockModelID_constr_4 CC_NOTUSED = {
	{ 1, 1 }	/* (1..8) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_orbitModelID_constr_5 CC_NOTUSED = {
	{ 1, 1 }	/* (1..8) */,
	-1};
...
asn_TYPE_member_t asn_MBR_SatListRelatedDataElement_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct SatListRelatedDataElement, clockModelID),
		...
		0,
		{ &asn_OER_memb_clockModelID_constr_4, &asn_PER_memb_clockModelID_constr_4,  memb_clockModelID_constraint_1 },
		0, 0, /* No default value */
		"clockModelID"
		},
	{ ATF_POINTER, 1, offsetof(struct SatListRelatedDataElement, orbitModelID),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_orbitModelID_constr_5, &asn_PER_memb_orbitModelID_constr_5,  memb_orbitModelID_constraint_1 },
		0, 0, /* No default value */
		"orbitModelID"
		},
};
