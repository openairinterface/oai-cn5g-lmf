...
asn_TYPE_member_t asn_MBR_GPS_TOW_AssistElement_1[] = {
    {ATF_NOFLAGS,
     ...
     0,
     {&asn_OER_memb_satelliteID_constr_2, &asn_PER_memb_satelliteID_constr_2,
    ...
    {ATF_NOFLAGS,
     ...
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_tlmWord_constr_3, &asn_PER_memb_tlmWord_constr_3,
    ...
    {ATF_NOFLAGS,
     ...
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_antiSpoof_constr_4, &asn_PER_memb_antiSpoof_constr_4,
    ...
    {ATF_NOFLAGS,
     ...
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_alert_constr_5, &asn_PER_memb_alert_constr_5,
    ...
    {ATF_NOFLAGS,
     ...
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_tlmRsvdBits_constr_6, &asn_PER_memb_tlmRsvdBits_constr_6,
