...
oer_type_decoder_f EPDU_Name_decode_oer;
oer_type_encoder_f EPDU_Name_encode_oer;
per_type_decoder_f EPDU_Name_decode_uper;
per_type_encoder_f EPDU_Name_encode_uper;
per_type_decoder_f EPDU_Name_decode_aper;
per_type_encoder_f EPDU_Name_encode_aper;
