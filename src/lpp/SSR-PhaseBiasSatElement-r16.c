...
asn_TYPE_member_t asn_MBR_SSR_PhaseBiasSatElement_r16_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct SSR_PhaseBiasSatElement_r16, svID_r16),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct SSR_PhaseBiasSatElement_r16, ssr_PhaseBiasSignalList_r16),
