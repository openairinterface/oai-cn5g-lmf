...
#include "EPDU.h"
static asn_oer_constraints_t asn_OER_type_EPDU_Sequence_constr_1 CC_NOTUSED = {
    {0, 0},
    -1 /* (SIZE(1..16)) */};
...
asn_SET_OF_specifics_t asn_SPC_EPDU_Sequence_specs_1 = {
    sizeof(struct EPDU_Sequence), offsetof(struct EPDU_Sequence, _asn_ctx),
...
asn_TYPE_descriptor_t asn_DEF_EPDU_Sequence = {
    ...
    sizeof(asn_DEF_EPDU_Sequence_tags_1) /
        sizeof(asn_DEF_EPDU_Sequence_tags_1[0]), /* 1 */
    {&asn_OER_type_EPDU_Sequence_constr_1, &asn_PER_type_EPDU_Sequence_constr_1,
