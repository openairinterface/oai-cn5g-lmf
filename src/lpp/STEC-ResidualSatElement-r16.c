...
static int memb_b7_r16_constraint_3(
...
static int memb_b16_r16_constraint_3(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  long value;
...
static asn_per_constraints_t asn_PER_memb_b16_r16_constr_5 CC_NOTUSED = {
    ...
    0 /* No PER value map */
          ...
          !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_stecResidualCorrection_r16_constr_3
    CC_NOTUSED = {
...
static asn_CHOICE_specifics_t asn_SPC_stecResidualCorrection_r16_specs_3 = {
    ...
    offsetof(
        struct STEC_ResidualSatElement_r16__stecResidualCorrection_r16,
        present),
    sizeof(((struct STEC_ResidualSatElement_r16__stecResidualCorrection_r16*) 0)
               ->present),
    asn_MAP_stecResidualCorrection_r16_tag2el_3,
...
asn_TYPE_member_t asn_MBR_STEC_ResidualSatElement_r16_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct STEC_ResidualSatElement_r16, svID_r16),
     (ASN_TAG_CLASS_CONTEXT | (0 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_SV_ID,
     0,
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct STEC_ResidualSatElement_r16, stecResidualCorrection_r16),
     (ASN_TAG_CLASS_CONTEXT | (1 << 2)),
