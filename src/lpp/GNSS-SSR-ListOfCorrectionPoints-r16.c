...
static int memb_relativeLocationsList_r16_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  size_t size;
...
static asn_per_constraints_t asn_PER_type_relativeLocationsList_r16_constr_4
    CC_NOTUSED = {
...
static asn_per_constraints_t asn_PER_memb_relativeLocationsList_r16_constr_4
    CC_NOTUSED = {
        {APC_UNCONSTRAINED, -1, -1, 0, 0},
        {APC_CONSTRAINED, 6, 6, 0, 63} /* (SIZE(0..63)) */,
        0,
...
asn_TYPE_member_t asn_MBR_GNSS_SSR_ListOfCorrectionPoints_r16_1[] = {
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(
         struct GNSS_SSR_ListOfCorrectionPoints_r16, relativeLocationsList_r16),
     (ASN_TAG_CLASS_CONTEXT | (2 << 2)),
     0,
     &asn_DEF_relativeLocationsList_r16_4,
     0,
     {0, &asn_PER_memb_relativeLocationsList_r16_constr_4,
