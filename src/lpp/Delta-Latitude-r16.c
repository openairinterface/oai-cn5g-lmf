...
static int memb_delta_Latitude_r16_constraint_1(
...
static int memb_coarse_delta_Latitude_r16_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  long value;
...
static asn_per_constraints_t asn_PER_memb_delta_Latitude_r16_constr_2
    CC_NOTUSED = {
...
static asn_per_constraints_t asn_PER_memb_coarse_delta_Latitude_r16_constr_3
    CC_NOTUSED = {
...
asn_TYPE_member_t asn_MBR_Delta_Latitude_r16_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct Delta_Latitude_r16, delta_Latitude_r16),
     (ASN_TAG_CLASS_CONTEXT | (0 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {0, &asn_PER_memb_delta_Latitude_r16_constr_2,
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Delta_Latitude_r16, coarse_delta_Latitude_r16),
     (ASN_TAG_CLASS_CONTEXT | (1 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {0, &asn_PER_memb_coarse_delta_Latitude_r16_constr_3,
