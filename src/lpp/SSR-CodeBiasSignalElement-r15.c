...
static int memb_codeBias_r15_constraint_1(
...
static asn_oer_constraints_t asn_OER_memb_codeBias_r15_constr_3 CC_NOTUSED = {
    {2, 0} /* (-8192..8191) */,
    -1};
...
asn_TYPE_member_t asn_MBR_SSR_CodeBiasSignalElement_r15_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(
         struct SSR_CodeBiasSignalElement_r15, signal_and_tracking_mode_ID_r15),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct SSR_CodeBiasSignalElement_r15, codeBias_r15),
     (ASN_TAG_CLASS_CONTEXT | (1 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_codeBias_r15_constr_3, &asn_PER_memb_codeBias_r15_constr_3,
...
static const asn_TYPE_tag2member_t
    asn_MAP_SSR_CodeBiasSignalElement_r15_tag2el_1[] = {
        {(ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0,
         0}, /* signal-and-tracking-mode-ID-r15 */
