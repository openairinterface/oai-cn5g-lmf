...
asn_TYPE_member_t asn_MBR_GNSS_SSR_URA_r16_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct GNSS_SSR_URA_r16, epochTime_r16),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct GNSS_SSR_URA_r16, ssrUpdateInterval_r16),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct GNSS_SSR_URA_r16, iod_ssr_r16),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct GNSS_SSR_URA_r16, ssr_URA_SatList_r16),
