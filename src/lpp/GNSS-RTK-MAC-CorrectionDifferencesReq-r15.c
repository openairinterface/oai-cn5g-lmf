...
static const int asn_MAP_GNSS_RTK_MAC_CorrectionDifferencesReq_r15_oms_1[] = {
    0, 1, 2};
...
static const asn_TYPE_tag2member_t
    asn_MAP_GNSS_RTK_MAC_CorrectionDifferencesReq_r15_tag2el_1[] = {
        ...
        {(ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0,
         0}, /* aux-ReferenceStationList-r15 */
        {(ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0,
         0} /* linkCombinations-PrefList-r15 */
};
asn_SEQUENCE_specifics_t
    asn_SPC_GNSS_RTK_MAC_CorrectionDifferencesReq_r15_specs_1 = {
        ...
        asn_MAP_GNSS_RTK_MAC_CorrectionDifferencesReq_r15_oms_1, /* Optional
                                                                    members */
        3,
        0, /* Root/Additions */
...
asn_TYPE_descriptor_t asn_DEF_GNSS_RTK_MAC_CorrectionDifferencesReq_r15 = {
    ...
    sizeof(asn_DEF_GNSS_RTK_MAC_CorrectionDifferencesReq_r15_tags_1) /
        sizeof(
            asn_DEF_GNSS_RTK_MAC_CorrectionDifferencesReq_r15_tags_1[0]), /* 1
                                                                           */
    ...
    3, /* Elements count */
    &asn_SPC_GNSS_RTK_MAC_CorrectionDifferencesReq_r15_specs_1 /* Additional
                                                                  specs */
};
