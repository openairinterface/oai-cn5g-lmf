...
static asn_oer_constraints_t asn_OER_memb_posModes_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..8)) */};
...
asn_TYPE_member_t asn_MBR_PositioningModes_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct PositioningModes, posModes),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_posModes_constr_2, &asn_PER_memb_posModes_constr_2,  memb_posModes_constraint_1 },
