...
static int memb_navic_RefTOWC_r16_constraint_1(
...
static int memb_regionMasked_r16_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  long value;
...
static asn_per_constraints_t asn_PER_memb_navic_RefTOWC_r16_constr_2
    CC_NOTUSED = {
...
static asn_per_constraints_t asn_PER_memb_regionMasked_r16_constr_3
    CC_NOTUSED = {
...
asn_TYPE_member_t asn_MBR_NavIC_GridModelParameter_r16_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct NavIC_GridModelParameter_r16, navic_RefTOWC_r16),
     (ASN_TAG_CLASS_CONTEXT | (0 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {0, &asn_PER_memb_navic_RefTOWC_r16_constr_2,
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct NavIC_GridModelParameter_r16, regionMasked_r16),
     (ASN_TAG_CLASS_CONTEXT | (1 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {0, &asn_PER_memb_regionMasked_r16_constr_3,
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct NavIC_GridModelParameter_r16, regionIgpList_r16),
