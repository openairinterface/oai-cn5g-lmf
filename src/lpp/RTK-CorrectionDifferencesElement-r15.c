...
asn_TYPE_member_t asn_MBR_RTK_CorrectionDifferencesElement_r15_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct RTK_CorrectionDifferencesElement_r15, epochTime_r15),
    ...
    {ATF_NOFLAGS,
     ...
     offsetof(
         ...
         auxiliary_referenceStationID_r15),
...
static const asn_TYPE_tag2member_t
    asn_MAP_RTK_CorrectionDifferencesElement_r15_tag2el_1[] = {
        ...
        {(ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0,
         0}, /* auxiliary-referenceStationID-r15 */
        {(ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0,
         0} /* geometric-ionospheric-corrections-differences-r15 */
};
