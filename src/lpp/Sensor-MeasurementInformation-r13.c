...
static asn_oer_constraints_t asn_OER_memb_uncompensatedBarometricPressure_r13_constr_3 CC_NOTUSED = {
	{ 4, 1 }	/* (30000..115000) */,
	-1};
...
static asn_TYPE_member_t asn_MBR_uncertainty_r14_6[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct Sensor_MeasurementInformation_r13__ext1__uncertainty_r14, range_r14),
		...
		0,
		{ &asn_OER_memb_range_r14_constr_7, &asn_PER_memb_range_r14_constr_7,  memb_range_r14_constraint_6 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct Sensor_MeasurementInformation_r13__ext1__uncertainty_r14, confidence_r14),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_confidence_r14_constr_8, &asn_PER_memb_confidence_r14_constr_8,  memb_confidence_r14_constraint_6 },
		0, 0, /* No default value */
		"confidence-r14"
		},
};
...
asn_TYPE_member_t asn_MBR_Sensor_MeasurementInformation_r13_1[] = {
	{ ATF_POINTER, 3, offsetof(struct Sensor_MeasurementInformation_r13, measurementReferenceTime_r13),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_UTCTime,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct Sensor_MeasurementInformation_r13, uncompensatedBarometricPressure_r13),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_uncompensatedBarometricPressure_r13_constr_3, &asn_PER_memb_uncompensatedBarometricPressure_r13_constr_3,  memb_uncompensatedBarometricPressure_r13_constraint_1 },
		0, 0, /* No default value */
		"uncompensatedBarometricPressure-r13"
		},
	{ ATF_POINTER, 1, offsetof(struct Sensor_MeasurementInformation_r13, ext1),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		&asn_DEF_ext1_5,
		0,
