...
static int memb_adjustment_r16_constraint_9(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  long value;
...
static asn_per_constraints_t asn_PER_memb_adjustment_r16_constr_10
    CC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_uncertainty_r14_6[] = {
    ...
    {ATF_NOFLAGS,
     ...
     &asn_DEF_NativeInteger,
     0,
     {0, &asn_PER_memb_confidence_r14_constr_8,
...
static asn_TYPE_member_t asn_MBR_ext2_9[] = {
    {ATF_POINTER,
     1,
     offsetof(struct Sensor_MeasurementInformation_r13__ext2, adjustment_r16),
     (ASN_TAG_CLASS_CONTEXT | (0 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {0, &asn_PER_memb_adjustment_r16_constr_10,
...
static /* Use -fall-defs-global to expose */
    asn_TYPE_descriptor_t asn_DEF_ext2_9 = {
        ...
        &asn_OP_SEQUENCE,
        asn_DEF_ext2_tags_9,
        sizeof(asn_DEF_ext2_tags_9) / sizeof(asn_DEF_ext2_tags_9[0]) -
            1,               /* 1 */
        asn_DEF_ext2_tags_9, /* Same as above */
        sizeof(asn_DEF_ext2_tags_9) / sizeof(asn_DEF_ext2_tags_9[0]), /* 2 */
        {0, 0, SEQUENCE_constraint},
        asn_MBR_ext2_9,
        1,                    /* Elements count */
...
asn_TYPE_member_t asn_MBR_Sensor_MeasurementInformation_r13_1[] = {
    ...
    {ATF_POINTER,
     ...
     &asn_DEF_NativeInteger,
     0,
     {0, &asn_PER_memb_uncompensatedBarometricPressure_r13_constr_3,
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Sensor_MeasurementInformation_r13, ext2),
...
static const int asn_MAP_Sensor_MeasurementInformation_r13_oms_1[] = {
    0, 1, 2, 3};
