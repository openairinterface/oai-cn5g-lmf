...
static asn_TYPE_member_t asn_MBR_c1_3[] = {
    {ATF_POINTER,
     ...
     offsetof(
         ...
         choice.provideLocationInformation_r9),
...
static asn_CHOICE_specifics_t asn_SPC_c1_specs_3 = {
    ...
    offsetof(
        struct ProvideLocationInformation__criticalExtensions__c1, _asn_ctx),
    offsetof(
        struct ProvideLocationInformation__criticalExtensions__c1, present),
    sizeof(((struct ProvideLocationInformation__criticalExtensions__c1*) 0)
               ->present),
    asn_MAP_c1_tag2el_3,
...
static asn_TYPE_member_t asn_MBR_criticalExtensions_2[] = {
    {ATF_POINTER,
     0,
     offsetof(struct ProvideLocationInformation__criticalExtensions, choice.c1),
     (ASN_TAG_CLASS_CONTEXT | (0 << 2)),
...
static asn_CHOICE_specifics_t asn_SPC_criticalExtensions_specs_2 = {
    ...
    sizeof(
        ((struct ProvideLocationInformation__criticalExtensions*) 0)->present),
...
asn_TYPE_member_t asn_MBR_ProvideLocationInformation_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct ProvideLocationInformation, criticalExtensions),
     (ASN_TAG_CLASS_CONTEXT | (0 << 2)),
     +1, /* EXPLICIT tag at current level */
