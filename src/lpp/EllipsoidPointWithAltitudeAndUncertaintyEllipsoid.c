...
static /* Use -fall-defs-global to expose */
    asn_TYPE_descriptor_t asn_DEF_altitudeDirection_7 = {
        ...
        {0, &asn_PER_type_altitudeDirection_constr_7,
...
asn_TYPE_member_t
    asn_MBR_EllipsoidPointWithAltitudeAndUncertaintyEllipsoid_1[] = {
        ...
        {ATF_NOFLAGS,
         ...
         &asn_DEF_NativeInteger,
         0,
         {0, &asn_PER_memb_uncertaintySemiMajor_constr_11,
        ...
        {ATF_NOFLAGS,
         ...
         &asn_DEF_NativeInteger,
         0,
         {0, &asn_PER_memb_uncertaintySemiMinor_constr_12,
        ...
        {ATF_NOFLAGS,
         ...
         &asn_DEF_NativeInteger,
         0,
         {0, &asn_PER_memb_orientationMajorAxis_constr_13,
