...
static int memb_uncertaintySemiMajor_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  long value;
...
static int memb_uncertaintySemiMinor_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  long value;
...
static int memb_orientationMajorAxis_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  long value;
...
static int memb_confidence_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  long value;
...
static asn_oer_constraints_t asn_OER_type_altitudeDirection_constr_7
    CC_NOTUSED = {{0, 0}, -1};
...
static asn_oer_constraints_t asn_OER_memb_degreesLatitude_constr_5
    CC_NOTUSED = {{4, 1} /* (0..8388607) */, -1};
...
static asn_oer_constraints_t asn_OER_memb_degreesLongitude_constr_6
...
static asn_oer_constraints_t asn_OER_memb_uncertaintySemiMajor_constr_11
...
static asn_oer_constraints_t asn_OER_memb_uncertaintySemiMinor_constr_12
    CC_NOTUSED = {{1, 1} /* (0..127) */, -1};
...
static asn_oer_constraints_t asn_OER_memb_orientationMajorAxis_constr_13
...
static asn_oer_constraints_t asn_OER_memb_uncertaintyAltitude_constr_14
    CC_NOTUSED = {{1, 1} /* (0..127) */, -1};
...
static /* Use -fall-defs-global to expose */
    asn_TYPE_descriptor_t asn_DEF_latitudeSign_2 = {
        ...
        {&asn_OER_type_latitudeSign_constr_2,
         &asn_PER_type_latitudeSign_constr_2, NativeEnumerated_constraint},
        0,
        0,                            /* Defined elsewhere */
...
static /* Use -fall-defs-global to expose */
    asn_TYPE_descriptor_t asn_DEF_altitudeDirection_7 = {
        ...
        sizeof(asn_DEF_altitudeDirection_tags_7) /
                sizeof(asn_DEF_altitudeDirection_tags_7[0]) -
            1,                            /* 1 */
        asn_DEF_altitudeDirection_tags_7, /* Same as above */
        sizeof(asn_DEF_altitudeDirection_tags_7) /
            sizeof(asn_DEF_altitudeDirection_tags_7[0]), /* 2 */
        {&asn_OER_type_altitudeDirection_constr_7,
         &asn_PER_type_altitudeDirection_constr_7, NativeEnumerated_constraint},
        0,
        0,                                 /* Defined elsewhere */
...
asn_TYPE_member_t
    asn_MBR_EllipsoidPointWithAltitudeAndUncertaintyEllipsoid_1[] = {
        ...
        {ATF_NOFLAGS,
         ...
         0,
         {&asn_OER_memb_degreesLatitude_constr_5,
        ...
        {ATF_NOFLAGS,
         ...
         &asn_DEF_NativeInteger,
         0,
         {&asn_OER_memb_degreesLongitude_constr_6,
        ...
        {ATF_NOFLAGS,
         ...
         &asn_DEF_NativeInteger,
         0,
         {&asn_OER_memb_altitude_constr_10, &asn_PER_memb_altitude_constr_10,
        ...
        {ATF_NOFLAGS,
         ...
         &asn_DEF_NativeInteger,
         0,
         {&asn_OER_memb_uncertaintySemiMajor_constr_11,
        ...
        {ATF_NOFLAGS,
         ...
         &asn_DEF_NativeInteger,
         0,
         {&asn_OER_memb_uncertaintySemiMinor_constr_12,
        ...
        {ATF_NOFLAGS,
         ...
         &asn_DEF_NativeInteger,
         0,
         {&asn_OER_memb_orientationMajorAxis_constr_13,
        ...
        {ATF_NOFLAGS,
         ...
         {&asn_OER_memb_confidence_constr_15,
          &asn_PER_memb_confidence_constr_15, memb_confidence_constraint_1},
         0,
         0, /* No default value */
         "confidence"},
};
    ...
    asn_DEF_EllipsoidPointWithAltitudeAndUncertaintyEllipsoid = {
        ...
        sizeof(
            ...
            sizeof(
                asn_DEF_EllipsoidPointWithAltitudeAndUncertaintyEllipsoid_tags_1
                    [0]), /* 1 */
        asn_DEF_EllipsoidPointWithAltitudeAndUncertaintyEllipsoid_tags_1, /* Same
                                                                             as
                                                                             above
                                                                           */
        sizeof(
        ...
        asn_MBR_EllipsoidPointWithAltitudeAndUncertaintyEllipsoid_1,
        10, /* Elements count */
        &asn_SPC_EllipsoidPointWithAltitudeAndUncertaintyEllipsoid_specs_1 /* Additional
                                                                              specs
                                                                            */
};
