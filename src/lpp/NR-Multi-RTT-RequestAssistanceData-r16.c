...
static int memb_nr_AdType_r16_constraint_1(
...
asn_TYPE_member_t asn_MBR_NR_Multi_RTT_RequestAssistanceData_r16_1[] = {
    {ATF_POINTER,
     1,
     offsetof(struct NR_Multi_RTT_RequestAssistanceData_r16, nr_PhysCellID_r16),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct NR_Multi_RTT_RequestAssistanceData_r16, nr_AdType_r16),
...
asn_SEQUENCE_specifics_t
    asn_SPC_NR_Multi_RTT_RequestAssistanceData_r16_specs_1 = {
        ...
        asn_MAP_NR_Multi_RTT_RequestAssistanceData_r16_oms_1, /* Optional
                                                                 members */
        1,
        0, /* Root/Additions */
...
asn_TYPE_descriptor_t asn_DEF_NR_Multi_RTT_RequestAssistanceData_r16 = {
    ...
    sizeof(asn_DEF_NR_Multi_RTT_RequestAssistanceData_r16_tags_1) /
        sizeof(
            asn_DEF_NR_Multi_RTT_RequestAssistanceData_r16_tags_1[0]), /* 1 */
