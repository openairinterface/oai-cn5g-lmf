...
static int memb_bandEUTRA_constraint_1(
...
static asn_oer_constraints_t asn_OER_memb_bandEUTRA_constr_2 CC_NOTUSED = {
    {1, 1} /* (1..64) */,
    -1};
...
asn_TYPE_member_t asn_MBR_SupportedBandEUTRA_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct SupportedBandEUTRA, bandEUTRA),
     (ASN_TAG_CLASS_CONTEXT | (0 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_bandEUTRA_constr_2, &asn_PER_memb_bandEUTRA_constr_2,
