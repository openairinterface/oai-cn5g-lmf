...
static const asn_TYPE_tag2member_t asn_MAP_ext1_tag2el_10[] = {
    {(ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0,
     0}, /* highAccuracyEllipsoidPointWithUncertaintyEllipse-r15 */
    {(ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0,
     0} /* highAccuracyEllipsoidPointWithAltitudeAndUncertaintyEllipsoid-r15 */
};
...
static const asn_TYPE_tag2member_t asn_MAP_ext2_tag2el_13[] = {
    {(ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0,
     0}, /* ha-EllipsoidPointWithScalableUncertaintyEllipse-r16 */
    {(ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0,
     0} /* ha-EllipsoidPointWithAltitudeAndScalableUncertaintyEllipsoid-r16 */
};
...
asn_TYPE_member_t asn_MBR_LocationCoordinateTypes_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct LocationCoordinateTypes, ellipsoidPoint),
     (ASN_TAG_CLASS_CONTEXT | (0 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_BOOLEAN,
     0,
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(
         struct LocationCoordinateTypes, ellipsoidPointWithUncertaintyCircle),
     (ASN_TAG_CLASS_CONTEXT | (1 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_BOOLEAN,
     0,
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(
         struct LocationCoordinateTypes, ellipsoidPointWithUncertaintyEllipse),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct LocationCoordinateTypes, polygon),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct LocationCoordinateTypes, ellipsoidPointWithAltitude),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct LocationCoordinateTypes, ellipsoidArc),
    ...
    {ATF_POINTER,
     2,
     offsetof(struct LocationCoordinateTypes, ext1),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct LocationCoordinateTypes, ext2),
...
static const asn_TYPE_tag2member_t asn_MAP_LocationCoordinateTypes_tag2el_1[] =
    {
        ...
        {(ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0,
         0}, /* ellipsoidPointWithUncertaintyCircle */
        {(ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0,
         0}, /* ellipsoidPointWithUncertaintyEllipse */
        {(ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0}, /* polygon */
        {(ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0,
         0}, /* ellipsoidPointWithAltitude */
        {(ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0,
         0}, /* ellipsoidPointWithAltitudeAndUncertaintyEllipsoid */
