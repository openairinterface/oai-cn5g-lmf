...
static asn_oer_constraints_t asn_OER_memb_periodicAssistanceData_r15_constr_12 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..8)) */};
...
static asn_TYPE_member_t asn_MBR_ext2_11[] = {
	{ ATF_POINTER, 1, offsetof(struct A_GNSS_ProvideCapabilities__ext2, periodicAssistanceData_r15),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_periodicAssistanceData_r15_constr_12, &asn_PER_memb_periodicAssistanceData_r15_constr_12,  memb_periodicAssistanceData_r15_constraint_11 },
		0, 0, /* No default value */
