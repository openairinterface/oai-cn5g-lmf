 ...
 */
static int memb_periodicAssistanceData_r15_constraint_11(
...
static asn_oer_constraints_t asn_OER_type_idleStateForMeasurements_r14_constr_9
    CC_NOTUSED = {{0, 0}, -1};
static asn_per_constraints_t asn_PER_type_idleStateForMeasurements_r14_constr_9
    CC_NOTUSED = {
...
static asn_oer_constraints_t asn_OER_memb_periodicAssistanceData_r15_constr_12
    CC_NOTUSED = {{0, 0}, -1 /* (SIZE(1..8)) */};
static asn_per_constraints_t asn_PER_memb_periodicAssistanceData_r15_constr_12
    CC_NOTUSED = {
        {APC_UNCONSTRAINED, -1, -1, 0, 0},
...
static const asn_INTEGER_enum_map_t
    asn_MAP_idleStateForMeasurements_r14_value2enum_9[] = {{0, 8, "required"}};
static const unsigned int asn_MAP_idleStateForMeasurements_r14_enum2value_9[] =
    {
        0 /* required(0) */
};
static const asn_INTEGER_specifics_t
    asn_SPC_idleStateForMeasurements_r14_specs_9 = {
        asn_MAP_idleStateForMeasurements_r14_value2enum_9, /* "tag" => N; sorted
                                                              by tag */
        asn_MAP_idleStateForMeasurements_r14_enum2value_9, /* N => "tag"; sorted
                                                              by N */
...
static asn_TYPE_member_t asn_MBR_ext1_7[] = {
    ...
    {ATF_POINTER,
     1,
     offsetof(
         struct A_GNSS_ProvideCapabilities__ext1, idleStateForMeasurements_r14),
...
static const asn_TYPE_tag2member_t asn_MAP_ext1_tag2el_7[] = {
    {(ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0,
     0}, /* periodicalReportingNotSupported-r14 */
...
static asn_TYPE_member_t asn_MBR_ext2_11[] = {
    {ATF_POINTER,
     1,
     offsetof(
         struct A_GNSS_ProvideCapabilities__ext2, periodicAssistanceData_r15),
     (ASN_TAG_CLASS_CONTEXT | (0 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_BIT_STRING,
     0,
     {&asn_OER_memb_periodicAssistanceData_r15_constr_12,
...
asn_TYPE_member_t asn_MBR_A_GNSS_ProvideCapabilities_1[] = {
    {ATF_POINTER,
     6,
     offsetof(struct A_GNSS_ProvideCapabilities, gnss_SupportList),
     (ASN_TAG_CLASS_CONTEXT | (0 << 2)),
     -1, /* IMPLICIT tag at current level */
    ...
    {ATF_POINTER,
     5,
     offsetof(struct A_GNSS_ProvideCapabilities, assistanceDataSupportList),
     (ASN_TAG_CLASS_CONTEXT | (1 << 2)),
     -1, /* IMPLICIT tag at current level */
    ...
    {ATF_POINTER,
     4,
     offsetof(struct A_GNSS_ProvideCapabilities, locationCoordinateTypes),
    ...
    {ATF_POINTER,
     3,
     offsetof(struct A_GNSS_ProvideCapabilities, velocityTypes),
    ...
    {ATF_POINTER,
     2,
     offsetof(struct A_GNSS_ProvideCapabilities, ext1),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct A_GNSS_ProvideCapabilities, ext2),
...
static const int asn_MAP_A_GNSS_ProvideCapabilities_oms_1[] = {0, 1, 2,
                                                               3, 4, 5};
...
static const asn_TYPE_tag2member_t
    asn_MAP_A_GNSS_ProvideCapabilities_tag2el_1[] = {
        ...
        {(ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0,
         0}, /* assistanceDataSupportList */
        {(ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0,
         0}, /* locationCoordinateTypes */
