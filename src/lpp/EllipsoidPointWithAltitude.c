...
asn_TYPE_member_t asn_MBR_EllipsoidPointWithAltitude_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct EllipsoidPointWithAltitude, latitudeSign),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct EllipsoidPointWithAltitude, degreesLatitude),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct EllipsoidPointWithAltitude, degreesLongitude),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct EllipsoidPointWithAltitude, altitudeDirection),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct EllipsoidPointWithAltitude, altitude),
