...
static asn_oer_constraints_t asn_OER_memb_rough_range_r15_constr_4 CC_NOTUSED = {
	{ 2, 1 }	/* (0..1023) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_rough_phase_range_rate_r15_constr_5 CC_NOTUSED = {
	{ 2, 0 }	/* (-8192..8191) */,
	-1};
...
asn_TYPE_member_t asn_MBR_GNSS_RTK_SatelliteDataElement_r15_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct GNSS_RTK_SatelliteDataElement_r15, integer_ms_r15),
		...
		0,
		{ &asn_OER_memb_integer_ms_r15_constr_3, &asn_PER_memb_integer_ms_r15_constr_3,  memb_integer_ms_r15_constraint_1 },
		0, 0, /* No default value */
		"integer-ms-r15"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct GNSS_RTK_SatelliteDataElement_r15, rough_range_r15),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_rough_range_r15_constr_4, &asn_PER_memb_rough_range_r15_constr_4,  memb_rough_range_r15_constraint_1 },
		0, 0, /* No default value */
		"rough-range-r15"
		},
	{ ATF_POINTER, 1, offsetof(struct GNSS_RTK_SatelliteDataElement_r15, rough_phase_range_rate_r15),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_rough_phase_range_rate_r15_constr_5, &asn_PER_memb_rough_phase_range_rate_r15_constr_5,  memb_rough_phase_range_rate_r15_constraint_1 },
		0, 0, /* No default value */
