...
static int memb_integer_ms_r15_constraint_1(
...
static int memb_rough_range_r15_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  long value;
...
static int memb_rough_phase_range_rate_r15_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  long value;
...
static asn_oer_constraints_t asn_OER_memb_integer_ms_r15_constr_3 CC_NOTUSED = {
    {1, 1} /* (0..254) */,
    -1};
...
static asn_oer_constraints_t asn_OER_memb_rough_range_r15_constr_4
    CC_NOTUSED = {{2, 1} /* (0..1023) */, -1};
static asn_per_constraints_t asn_PER_memb_rough_range_r15_constr_4
    CC_NOTUSED = {
...
static asn_oer_constraints_t asn_OER_memb_rough_phase_range_rate_r15_constr_5
    CC_NOTUSED = {{2, 0} /* (-8192..8191) */, -1};
static asn_per_constraints_t asn_PER_memb_rough_phase_range_rate_r15_constr_5
    CC_NOTUSED = {
...
asn_TYPE_member_t asn_MBR_GNSS_RTK_SatelliteDataElement_r15_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct GNSS_RTK_SatelliteDataElement_r15, svID_r15),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct GNSS_RTK_SatelliteDataElement_r15, integer_ms_r15),
     (ASN_TAG_CLASS_CONTEXT | (1 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_integer_ms_r15_constr_3,
      &asn_PER_memb_integer_ms_r15_constr_3, memb_integer_ms_r15_constraint_1},
     0,
     0, /* No default value */
     "integer-ms-r15"},
    {ATF_NOFLAGS,
     0,
     offsetof(struct GNSS_RTK_SatelliteDataElement_r15, rough_range_r15),
     (ASN_TAG_CLASS_CONTEXT | (2 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_rough_range_r15_constr_4,
    ...
    {ATF_POINTER,
     1,
     offsetof(
         struct GNSS_RTK_SatelliteDataElement_r15, rough_phase_range_rate_r15),
     (ASN_TAG_CLASS_CONTEXT | (3 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_rough_phase_range_rate_r15_constr_5,
...
static const asn_TYPE_tag2member_t
    asn_MAP_GNSS_RTK_SatelliteDataElement_r15_tag2el_1[] = {
        ...
        {(ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0,
         0}, /* rough-phase-range-rate-r15 */
        {(ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0,
         0} /* gnss-rtk-SatelliteSignalDataList-r15 */
};
