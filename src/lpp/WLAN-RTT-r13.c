 ...
 */
static int memb_rttValue_r13_constraint_1(
...
static int memb_rttAccuracy_r13_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  long value;
...
static asn_oer_constraints_t asn_OER_type_rttUnits_r13_constr_3 CC_NOTUSED = {
    {0, 0},
    -1};
...
static asn_oer_constraints_t asn_OER_memb_rttValue_r13_constr_2 CC_NOTUSED = {
    {4, 1} /* (0..16777215) */,
    -1};
...
static asn_oer_constraints_t asn_OER_memb_rttAccuracy_r13_constr_10
    CC_NOTUSED = {{1, 1} /* (0..255) */, -1};
static asn_per_constraints_t asn_PER_memb_rttAccuracy_r13_constr_10
    CC_NOTUSED = {
...
static /* Use -fall-defs-global to expose */
    asn_TYPE_descriptor_t asn_DEF_rttUnits_r13_3 = {
        ...
        sizeof(asn_DEF_rttUnits_r13_tags_3) /
                sizeof(asn_DEF_rttUnits_r13_tags_3[0]) -
            1,                       /* 1 */
        asn_DEF_rttUnits_r13_tags_3, /* Same as above */
        sizeof(asn_DEF_rttUnits_r13_tags_3) /
            sizeof(asn_DEF_rttUnits_r13_tags_3[0]), /* 2 */
        {&asn_OER_type_rttUnits_r13_constr_3,
         &asn_PER_type_rttUnits_r13_constr_3, NativeEnumerated_constraint},
        0,
        0,                            /* Defined elsewhere */
...
asn_TYPE_member_t asn_MBR_WLAN_RTT_r13_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct WLAN_RTT_r13, rttValue_r13),
     (ASN_TAG_CLASS_CONTEXT | (0 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_rttValue_r13_constr_2, &asn_PER_memb_rttValue_r13_constr_2,
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct WLAN_RTT_r13, rttUnits_r13),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct WLAN_RTT_r13, rttAccuracy_r13),
     (ASN_TAG_CLASS_CONTEXT | (2 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_rttAccuracy_r13_constr_10,
