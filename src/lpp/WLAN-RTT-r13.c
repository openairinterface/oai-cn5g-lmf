...
static asn_oer_constraints_t asn_OER_memb_rttAccuracy_r13_constr_10 CC_NOTUSED = {
	{ 1, 1 }	/* (0..255) */,
	-1};
...
asn_TYPE_descriptor_t asn_DEF_rttUnits_r13_3 = {
	...
	{ &asn_OER_type_rttUnits_r13_constr_3, &asn_PER_type_rttUnits_r13_constr_3, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_WLAN_RTT_r13_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct WLAN_RTT_r13, rttValue_r13),
		...
		0,
		{ &asn_OER_memb_rttValue_r13_constr_2, &asn_PER_memb_rttValue_r13_constr_2,  memb_rttValue_r13_constraint_1 },
	...
	{ ATF_POINTER, 1, offsetof(struct WLAN_RTT_r13, rttAccuracy_r13),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_rttAccuracy_r13_constr_10, &asn_PER_memb_rttAccuracy_r13_constr_10,  memb_rttAccuracy_r13_constraint_1 },
		0, 0, /* No default value */
		"rttAccuracy-r13"
		},
};
