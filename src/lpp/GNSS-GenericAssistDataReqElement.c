...
static asn_TYPE_member_t asn_MBR_ext1_14[] = {
    ...
    {ATF_POINTER,
     1,
     offsetof(
         struct GNSS_GenericAssistDataReqElement__ext1, bds_GridModelReq_r12),
...
static const asn_TYPE_tag2member_t asn_MAP_ext1_tag2el_14[] = {
    {(ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0,
     0}, /* bds-DifferentialCorrectionsReq-r12 */
...
static const asn_TYPE_tag2member_t asn_MAP_ext2_tag2el_17[] = {
    {(ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0,
     0}, /* gnss-RTK-ObservationsReq-r15 */
    {(ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0,
     0}, /* glo-RTK-BiasInformationReq-r15 */
    {(ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0,
     0}, /* gnss-RTK-MAC-CorrectionDifferencesReq-r15 */
    {(ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0,
     0}, /* gnss-RTK-ResidualsReq-r15 */
    {(ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0,
     0}, /* gnss-RTK-FKP-GradientsReq-r15 */
    {(ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0,
     0}, /* gnss-SSR-OrbitCorrectionsReq-r15 */
    {(ASN_TAG_CLASS_CONTEXT | (6 << 2)), 6, 0,
     0}, /* gnss-SSR-ClockCorrectionsReq-r15 */
...
static asn_TYPE_member_t asn_MBR_ext3_26[] = {
    {ATF_POINTER,
     6,
     offsetof(
         struct GNSS_GenericAssistDataReqElement__ext3, gnss_SSR_URA_Req_r16),
     (ASN_TAG_CLASS_CONTEXT | (0 << 2)),
     -1, /* IMPLICIT tag at current level */
    ...
    {ATF_POINTER,
     1,
     offsetof(
         struct GNSS_GenericAssistDataReqElement__ext3, navic_GridModelReq_r16),
     (ASN_TAG_CLASS_CONTEXT | (5 << 2)),
     -1, /* IMPLICIT tag at current level */
...
static const asn_TYPE_tag2member_t asn_MAP_ext3_tag2el_26[] = {
    ...
    {(ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0,
     0}, /* gnss-SSR-PhaseBiasReq-r16 */
    {(ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0,
     0}, /* gnss-SSR-STEC-CorrectionReq-r16 */
    {(ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0,
     0}, /* gnss-SSR-GriddedCorrectionReq-r16 */
    {(ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0,
     0}, /* navic-DifferentialCorrectionsReq-r16 */
...
asn_TYPE_member_t asn_MBR_GNSS_GenericAssistDataReqElement_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct GNSS_GenericAssistDataReqElement, gnss_ID),
     (ASN_TAG_CLASS_CONTEXT | (0 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_GNSS_ID,
     0,
    ...
    {ATF_POINTER,
     13,
     offsetof(struct GNSS_GenericAssistDataReqElement, sbas_ID),
     (ASN_TAG_CLASS_CONTEXT | (1 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_SBAS_ID,
     0,
    ...
    {ATF_POINTER,
     12,
     offsetof(struct GNSS_GenericAssistDataReqElement, gnss_TimeModelsReq),
     (ASN_TAG_CLASS_CONTEXT | (2 << 2)),
     -1, /* IMPLICIT tag at current level */
    ...
    {ATF_POINTER,
     10,
     offsetof(struct GNSS_GenericAssistDataReqElement, gnss_NavigationModelReq),
     (ASN_TAG_CLASS_CONTEXT | (4 << 2)),
    ...
    {ATF_POINTER,
     9,
     offsetof(
         struct GNSS_GenericAssistDataReqElement, gnss_RealTimeIntegrityReq),
     (ASN_TAG_CLASS_CONTEXT | (5 << 2)),
     -1, /* IMPLICIT tag at current level */
    ...
    {ATF_POINTER,
     8,
     offsetof(
         struct GNSS_GenericAssistDataReqElement, gnss_DataBitAssistanceReq),
     (ASN_TAG_CLASS_CONTEXT | (6 << 2)),
     -1, /* IMPLICIT tag at current level */
    ...
    {ATF_POINTER,
     6,
     offsetof(struct GNSS_GenericAssistDataReqElement, gnss_AlmanacReq),
    ...
    {ATF_POINTER,
     5,
     offsetof(struct GNSS_GenericAssistDataReqElement, gnss_UTCModelReq),
    ...
    {ATF_POINTER,
     4,
     offsetof(
         struct GNSS_GenericAssistDataReqElement, gnss_AuxiliaryInformationReq),
    ...
    {ATF_POINTER,
     3,
     offsetof(struct GNSS_GenericAssistDataReqElement, ext1),
    ...
    {ATF_POINTER,
     2,
     offsetof(struct GNSS_GenericAssistDataReqElement, ext2),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct GNSS_GenericAssistDataReqElement, ext3),
...
static const int asn_MAP_GNSS_GenericAssistDataReqElement_oms_1[] = {
...
static const asn_TYPE_tag2member_t
    asn_MAP_GNSS_GenericAssistDataReqElement_tag2el_1[] = {
        ...
        {(ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0,
         0}, /* gnss-DifferentialCorrectionsReq */
        {(ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0,
         0}, /* gnss-NavigationModelReq */
        {(ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0,
         0}, /* gnss-RealTimeIntegrityReq */
        {(ASN_TAG_CLASS_CONTEXT | (6 << 2)), 6, 0,
         0}, /* gnss-DataBitAssistanceReq */
        {(ASN_TAG_CLASS_CONTEXT | (7 << 2)), 7, 0,
         0}, /* gnss-AcquisitionAssistanceReq */
        ...
        {(ASN_TAG_CLASS_CONTEXT | (10 << 2)), 10, 0,
         0}, /* gnss-AuxiliaryInformationReq */
