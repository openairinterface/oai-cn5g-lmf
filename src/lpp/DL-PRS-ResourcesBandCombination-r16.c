...
static asn_TYPE_member_t asn_MBR_maxNrOfDL_PRS_ResourcesAcrossAllFL_TRP_ResourceSet_r16_4[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct DL_PRS_ResourcesBandCombination_r16__maxNrOfDL_PRS_ResourcesAcrossAllFL_TRP_ResourceSet_r16, choice.fr1_FR2Mix_r16),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
...
asn_TYPE_descriptor_t asn_DEF_maxNrOfDL_PRS_ResourcesAcrossAllFL_TRP_ResourceSet_r16_4 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_maxNrOfDL_PRS_ResourcesAcrossAllFL_TRP_ResourceSet_r16_constr_4, CHOICE_constraint },
