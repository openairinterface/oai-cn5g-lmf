...
static asn_oer_constraints_t asn_OER_memb_subNetworkID_r15_constr_2 CC_NOTUSED = {
	{ 1, 1 }	/* (0..15) */,
	-1};
...
asn_TYPE_member_t asn_MBR_GNSS_SubNetworkID_r15_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct GNSS_SubNetworkID_r15, subNetworkID_r15),
		...
		0,
		{ &asn_OER_memb_subNetworkID_r15_constr_2, &asn_PER_memb_subNetworkID_r15_constr_2,  memb_subNetworkID_r15_constraint_1 },
