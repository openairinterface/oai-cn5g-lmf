...
static int memb_subNetworkID_r15_constraint_1(
...
static asn_oer_constraints_t asn_OER_memb_subNetworkID_r15_constr_2
    CC_NOTUSED = {{1, 1} /* (0..15) */, -1};
static asn_per_constraints_t asn_PER_memb_subNetworkID_r15_constr_2
    CC_NOTUSED = {
...
asn_TYPE_member_t asn_MBR_GNSS_SubNetworkID_r15_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct GNSS_SubNetworkID_r15, subNetworkID_r15),
     (ASN_TAG_CLASS_CONTEXT | (0 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_subNetworkID_r15_constr_2,
