...
static asn_per_constraints_t asn_PER_type_dl_PRS_Resource_ARP_List_r16_constr_3
    CC_NOTUSED = {
...
static asn_per_constraints_t asn_PER_memb_dl_PRS_Resource_ARP_List_r16_constr_3
    CC_NOTUSED = {
        {APC_UNCONSTRAINED, -1, -1, 0, 0},
        {APC_CONSTRAINED, 6, 6, 1, 64} /* (SIZE(1..64)) */,
        0,
...
static asn_SET_OF_specifics_t asn_SPC_dl_PRS_Resource_ARP_List_r16_specs_3 = {
    sizeof(struct
           DL_PRS_ResourceSets_TRP_Element_r16__dl_PRS_Resource_ARP_List_r16),
    offsetof(
        struct
        DL_PRS_ResourceSets_TRP_Element_r16__dl_PRS_Resource_ARP_List_r16,
        _asn_ctx),
...
asn_TYPE_member_t asn_MBR_DL_PRS_ResourceSets_TRP_Element_r16_1[] = {
    ...
    {ATF_POINTER,
     ...
     0,
     {0, &asn_PER_memb_dl_PRS_Resource_ARP_List_r16_constr_3,
...
static const asn_TYPE_tag2member_t
    asn_MAP_DL_PRS_ResourceSets_TRP_Element_r16_tag2el_1[] = {
        {(ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0,
         0}, /* dl-PRS-ResourceSetARP-r16 */
        {(ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0,
         0} /* dl-PRS-Resource-ARP-List-r16 */
};
