...
static asn_oer_constraints_t asn_OER_type_wlan_AP_List_r14_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..128)) */};
...
static asn_oer_constraints_t asn_OER_memb_wlan_AP_List_r14_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..128)) */};
...
asn_TYPE_descriptor_t asn_DEF_wlan_AP_List_r14_2 = {
	...
	{ &asn_OER_type_wlan_AP_List_r14_constr_2, &asn_PER_type_wlan_AP_List_r14_constr_2, SEQUENCE_OF_constraint },
...
asn_TYPE_member_t asn_MBR_WLAN_DataSet_r14_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct WLAN_DataSet_r14, wlan_AP_List_r14),
		...
		0,
		{ &asn_OER_memb_wlan_AP_List_r14_constr_2, &asn_PER_memb_wlan_AP_List_r14_constr_2,  memb_wlan_AP_List_r14_constraint_1 },
		0, 0, /* No default value */
		"wlan-AP-List-r14"
		},
