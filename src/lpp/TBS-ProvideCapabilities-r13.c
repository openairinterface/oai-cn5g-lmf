 ...
 */
static int memb_mbs_ConfigSupport_r14_constraint_7(
...
static int memb_tbs_Modes_r13_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  const BIT_STRING_t* st = (const BIT_STRING_t*) sptr;
  size_t size;
...
static asn_oer_constraints_t
    asn_OER_type_mbs_IdleStateForMeasurements_r14_constr_15 CC_NOTUSED = {
        {0, 0},
        -1};
static asn_per_constraints_t
    asn_PER_type_mbs_IdleStateForMeasurements_r14_constr_15 CC_NOTUSED = {
        {APC_CONSTRAINED, 0, 0, 0, 0} /* (0..0) */,
        {APC_UNCONSTRAINED, -1, -1, 0, 0},
        0,
        0 /* No PER value map */
};
static asn_oer_constraints_t asn_OER_memb_mbs_ConfigSupport_r14_constr_10
    CC_NOTUSED = {{0, 0}, -1 /* (SIZE(1..8)) */};
static asn_per_constraints_t asn_PER_memb_mbs_ConfigSupport_r14_constr_10
    CC_NOTUSED = {
        {APC_UNCONSTRAINED, -1, -1, 0, 0},
...
static asn_oer_constraints_t asn_OER_memb_tbs_Modes_r13_constr_2 CC_NOTUSED = {
    {0, 0},
    -1 /* (SIZE(1..8)) */};
...
static const asn_INTEGER_enum_map_t
    asn_MAP_mbs_IdleStateForMeasurements_r14_value2enum_15[] = {
        {0, 8, "required"}};
static const unsigned int
    asn_MAP_mbs_IdleStateForMeasurements_r14_enum2value_15[] = {
        0 /* required(0) */
};
static const asn_INTEGER_specifics_t
    asn_SPC_mbs_IdleStateForMeasurements_r14_specs_15 = {
        asn_MAP_mbs_IdleStateForMeasurements_r14_value2enum_15, /* "tag" => N;
                                                                   sorted by tag
                                                                 */
        asn_MAP_mbs_IdleStateForMeasurements_r14_enum2value_15, /* N => "tag";
                                                                   sorted by N
                                                                 */
...
static /* Use -fall-defs-global to expose */
    asn_TYPE_descriptor_t asn_DEF_mbs_IdleStateForMeasurements_r14_15 = {
        ...
        sizeof(asn_DEF_mbs_IdleStateForMeasurements_r14_tags_15) /
                sizeof(asn_DEF_mbs_IdleStateForMeasurements_r14_tags_15[0]) -
            1,                                            /* 1 */
        ...
        {&asn_OER_type_mbs_IdleStateForMeasurements_r14_constr_15,
...
static asn_TYPE_member_t asn_MBR_ext1_7[] = {
    ...
    {ATF_POINTER,
     2,
     offsetof(struct TBS_ProvideCapabilities_r13__ext1, mbs_ConfigSupport_r14),
     (ASN_TAG_CLASS_CONTEXT | (2 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_BIT_STRING,
     0,
     {&asn_OER_memb_mbs_ConfigSupport_r14_constr_10,
...
static const asn_TYPE_tag2member_t asn_MAP_ext1_tag2el_7[] = {
    {(ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0,
     0}, /* mbs-AssistanceDataSupportList-r14 */
    ...
    {(ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0,
     0} /* mbs-IdleStateForMeasurements-r14 */
};
...
asn_TYPE_member_t asn_MBR_TBS_ProvideCapabilities_r13_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct TBS_ProvideCapabilities_r13, tbs_Modes_r13),
     (ASN_TAG_CLASS_CONTEXT | (0 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_BIT_STRING,
     0,
     {&asn_OER_memb_tbs_Modes_r13_constr_2,
      &asn_PER_memb_tbs_Modes_r13_constr_2, memb_tbs_Modes_r13_constraint_1},
     0,
     0, /* No default value */
     "tbs-Modes-r13"},
    {ATF_POINTER,
     1,
     offsetof(struct TBS_ProvideCapabilities_r13, ext1),
     (ASN_TAG_CLASS_CONTEXT | (1 << 2)),
     0,
     &asn_DEF_ext1_7,
     0,
