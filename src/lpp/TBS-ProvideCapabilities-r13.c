...
static asn_oer_constraints_t asn_OER_type_mbs_IdleStateForMeasurements_r14_constr_15 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_mbs_ConfigSupport_r14_constr_10 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..8)) */};
...
asn_TYPE_descriptor_t asn_DEF_mbs_IdleStateForMeasurements_r14_15 = {
	...
	{ &asn_OER_type_mbs_IdleStateForMeasurements_r14_constr_15, &asn_PER_type_mbs_IdleStateForMeasurements_r14_constr_15, NativeEnumerated_constraint },
...
static asn_TYPE_member_t asn_MBR_ext1_7[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct TBS_ProvideCapabilities_r13__ext1, mbs_ConfigSupport_r14),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_mbs_ConfigSupport_r14_constr_10, &asn_PER_memb_mbs_ConfigSupport_r14_constr_10,  memb_mbs_ConfigSupport_r14_constraint_7 },
		0, 0, /* No default value */
...
asn_TYPE_member_t asn_MBR_TBS_ProvideCapabilities_r13_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct TBS_ProvideCapabilities_r13, tbs_Modes_r13),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_tbs_Modes_r13_constr_2, &asn_PER_memb_tbs_Modes_r13_constr_2,  memb_tbs_Modes_r13_constraint_1 },
		0, 0, /* No default value */
		"tbs-Modes-r13"
		},
