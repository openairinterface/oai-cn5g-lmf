 ...
 */
static asn_oer_constraints_t asn_OER_type_cause_r13_constr_2 CC_NOTUSED = {
    {0, 0},
    -1};
...
static /* Use -fall-defs-global to expose */
    asn_TYPE_descriptor_t asn_DEF_cause_r13_2 = {
        ...
        sizeof(asn_DEF_cause_r13_tags_2) / sizeof(asn_DEF_cause_r13_tags_2[0]) -
            1,                    /* 1 */
        asn_DEF_cause_r13_tags_2, /* Same as above */
        sizeof(asn_DEF_cause_r13_tags_2) /
            sizeof(asn_DEF_cause_r13_tags_2[0]), /* 2 */
        {&asn_OER_type_cause_r13_constr_2, &asn_PER_type_cause_r13_constr_2,
...
asn_TYPE_member_t asn_MBR_WLAN_TargetDeviceErrorCauses_r13_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct WLAN_TargetDeviceErrorCauses_r13, cause_r13),
    ...
    {ATF_POINTER,
     2,
     offsetof(
         struct WLAN_TargetDeviceErrorCauses_r13,
         wlan_AP_RSSI_MeasurementNotPossible_r13),
    ...
    {ATF_POINTER,
     ...
     offsetof(
         struct WLAN_TargetDeviceErrorCauses_r13,
         wlan_AP_RTT_MeasurementNotPossible_r13),
...
static const asn_TYPE_tag2member_t
    asn_MAP_WLAN_TargetDeviceErrorCauses_r13_tag2el_1[] = {
        ...
        {(ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0,
         0}, /* wlan-AP-RSSI-MeasurementNotPossible-r13 */
        {(ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0,
         0} /* wlan-AP-RTT-MeasurementNotPossible-r13 */
};
