...
asn_TYPE_member_t asn_MBR_LocationCoordinates_1[] = {
    {ATF_POINTER,
     0,
     offsetof(struct LocationCoordinates, choice.ellipsoidPoint),
    ...
    {ATF_POINTER,
     ...
     offsetof(
         ...
         choice.ellipsoidPointWithUncertaintyCircle),
    ...
    {ATF_POINTER,
     ...
     offsetof(
         struct LocationCoordinates,
         choice.ellipsoidPointWithUncertaintyEllipse),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct LocationCoordinates, choice.polygon),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct LocationCoordinates, choice.ellipsoidPointWithAltitude),
    ...
    {ATF_POINTER,
     ...
     offsetof(
         struct LocationCoordinates,
         choice.ellipsoidPointWithAltitudeAndUncertaintyEllipsoid),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct LocationCoordinates, choice.ellipsoidArc),
    ...
    {ATF_POINTER,
     ...
     offsetof(
         struct LocationCoordinates,
         choice.highAccuracyEllipsoidPointWithUncertaintyEllipse_v1510),
    ...
    {ATF_POINTER,
     ...
     offsetof(
         struct LocationCoordinates,
         choice.ha_EllipsoidPointWithScalableUncertaintyEllipse_v1680),
...
static const asn_TYPE_tag2member_t asn_MAP_LocationCoordinates_tag2el_1[] = {
    ...
    {(ASN_TAG_CLASS_CONTEXT | (9 << 2)), 9, 0,
     0}, /* ha-EllipsoidPointWithScalableUncertaintyEllipse-v1680 */
    {(ASN_TAG_CLASS_CONTEXT | (10 << 2)), 10, 0,
     0} /* ha-EllipsoidPointWithAltitudeAndScalableUncertaintyEllipsoid-v1680 */
};
