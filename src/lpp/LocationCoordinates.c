...
static asn_oer_constraints_t asn_OER_type_LocationCoordinates_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_member_t asn_MBR_LocationCoordinates_1[] = {
	{ ATF_POINTER, 0, offsetof(struct LocationCoordinates, choice.ellipsoidPoint),
	...
	{ ATF_POINTER, 0, offsetof(struct LocationCoordinates, choice.ellipsoidPointWithUncertaintyCircle),
	...
	{ ATF_POINTER, 0, offsetof(struct LocationCoordinates, choice.ellipsoidPointWithUncertaintyEllipse),
	...
	{ ATF_POINTER, 0, offsetof(struct LocationCoordinates, choice.polygon),
	...
	{ ATF_POINTER, 0, offsetof(struct LocationCoordinates, choice.ellipsoidPointWithAltitude),
	...
	{ ATF_POINTER, 0, offsetof(struct LocationCoordinates, choice.ellipsoidPointWithAltitudeAndUncertaintyEllipsoid),
	...
	{ ATF_POINTER, 0, offsetof(struct LocationCoordinates, choice.ellipsoidArc),
	...
	{ ATF_POINTER, 0, offsetof(struct LocationCoordinates, choice.highAccuracyEllipsoidPointWithUncertaintyEllipse_v1510),
	...
	{ ATF_POINTER, 0, offsetof(struct LocationCoordinates, choice.highAccuracyEllipsoidPointWithAltitudeAndUncertaintyEllipsoid_v1510),
...
asn_TYPE_descriptor_t asn_DEF_LocationCoordinates = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_LocationCoordinates_constr_1, &asn_PER_type_LocationCoordinates_constr_1, CHOICE_constraint },
