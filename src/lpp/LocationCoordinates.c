...
asn_TYPE_member_t asn_MBR_LocationCoordinates_1[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct LocationCoordinates, choice.ha_EllipsoidPointWithScalableUncertaintyEllipse_v1680),
	...
	{ ATF_POINTER, 0, offsetof(struct LocationCoordinates, choice.ha_EllipsoidPointWithAltitudeAndScalableUncertaintyEllipsoid_v1680),
