...
asn_TYPE_member_t asn_MBR_NR_Multi_RTT_ProvideAssistanceData_r16_1[] = {
    ...
    {ATF_POINTER,
     1,
     offsetof(
         struct NR_Multi_RTT_ProvideAssistanceData_r16, nr_Multi_RTT_Error_r16),
...
static const int asn_MAP_NR_Multi_RTT_ProvideAssistanceData_r16_oms_1[] = {
    0, 1, 2};
...
static const asn_TYPE_tag2member_t
    asn_MAP_NR_Multi_RTT_ProvideAssistanceData_r16_tag2el_1[] = {
        ...
        {(ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0,
         0} /* nr-Multi-RTT-Error-r16 */
};
asn_SEQUENCE_specifics_t
    asn_SPC_NR_Multi_RTT_ProvideAssistanceData_r16_specs_1 = {
        sizeof(struct NR_Multi_RTT_ProvideAssistanceData_r16),
        offsetof(struct NR_Multi_RTT_ProvideAssistanceData_r16, _asn_ctx),
        asn_MAP_NR_Multi_RTT_ProvideAssistanceData_r16_tag2el_1,
        3, /* Count of tags in the map */
        asn_MAP_NR_Multi_RTT_ProvideAssistanceData_r16_oms_1, /* Optional
                                                                 members */
        3,
        0, /* Root/Additions */
...
asn_TYPE_descriptor_t asn_DEF_NR_Multi_RTT_ProvideAssistanceData_r16 = {
    ...
    sizeof(asn_DEF_NR_Multi_RTT_ProvideAssistanceData_r16_tags_1) /
        sizeof(
            asn_DEF_NR_Multi_RTT_ProvideAssistanceData_r16_tags_1[0]), /* 1 */
