...
static asn_oer_constraints_t asn_OER_type_A_GNSS_Error_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_member_t asn_MBR_A_GNSS_Error_1[] = {
	{ ATF_POINTER, 0, offsetof(struct A_GNSS_Error, choice.locationServerErrorCauses),
	...
	{ ATF_POINTER, 0, offsetof(struct A_GNSS_Error, choice.targetDeviceErrorCauses),
...
asn_TYPE_descriptor_t asn_DEF_A_GNSS_Error = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_A_GNSS_Error_constr_1, &asn_PER_type_A_GNSS_Error_constr_1, CHOICE_constraint },
