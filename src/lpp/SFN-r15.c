...
static asn_oer_constraints_t asn_OER_memb_sfn_r15_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	10	/* (SIZE(10..10)) */};
...
static asn_oer_constraints_t asn_OER_memb_hyperSFN_r15_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	10	/* (SIZE(10..10)) */};
...
asn_TYPE_member_t asn_MBR_SFN_r15_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct SFN_r15, sfn_r15),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_sfn_r15_constr_2, &asn_PER_memb_sfn_r15_constr_2,  memb_sfn_r15_constraint_1 },
	...
	{ ATF_POINTER, 1, offsetof(struct SFN_r15, hyperSFN_r15),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_hyperSFN_r15_constr_3, &asn_PER_memb_hyperSFN_r15_constr_3,  memb_hyperSFN_r15_constraint_1 },
		0, 0, /* No default value */
		"hyperSFN-r15"
		},
};
