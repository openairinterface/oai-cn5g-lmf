...
static int memb_gnss_ids_constraint_1(
...
static asn_oer_constraints_t asn_OER_memb_gnss_ids_constr_2 CC_NOTUSED = {
    {0, 0},
    -1 /* (SIZE(1..16)) */};
...
asn_TYPE_member_t asn_MBR_GNSS_ID_Bitmap_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct GNSS_ID_Bitmap, gnss_ids),
     (ASN_TAG_CLASS_CONTEXT | (0 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_BIT_STRING,
     0,
     {&asn_OER_memb_gnss_ids_constr_2, &asn_PER_memb_gnss_ids_constr_2,
