...
asn_TYPE_member_t asn_MBR_TBS_ProvideAssistanceData_r14_1[] = {
    {ATF_POINTER,
     2,
     offsetof(struct TBS_ProvideAssistanceData_r14, tbs_AssistanceDataList_r14),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct TBS_ProvideAssistanceData_r14, tbs_Error_r14),
