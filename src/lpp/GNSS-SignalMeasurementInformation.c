...
asn_TYPE_member_t asn_MBR_GNSS_SignalMeasurementInformation_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(
         struct GNSS_SignalMeasurementInformation, measurementReferenceTime),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct GNSS_SignalMeasurementInformation, gnss_MeasurementList),
