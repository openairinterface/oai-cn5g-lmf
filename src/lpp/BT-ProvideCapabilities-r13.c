...
static asn_oer_constraints_t asn_OER_type_idleStateForMeasurements_r14_constr_9 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_bt_MeasSupported_r13_constr_5 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..8)) */};
...
asn_TYPE_descriptor_t asn_DEF_idleStateForMeasurements_r14_9 = {
	...
	{ &asn_OER_type_idleStateForMeasurements_r14_constr_9, &asn_PER_type_idleStateForMeasurements_r14_constr_9, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_BT_ProvideCapabilities_r13_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct BT_ProvideCapabilities_r13, bt_Modes_r13),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_bt_Modes_r13_constr_2, &asn_PER_memb_bt_Modes_r13_constr_2,  memb_bt_Modes_r13_constraint_1 },
		0, 0, /* No default value */
		"bt-Modes-r13"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct BT_ProvideCapabilities_r13, bt_MeasSupported_r13),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_bt_MeasSupported_r13_constr_5, &asn_PER_memb_bt_MeasSupported_r13_constr_5,  memb_bt_MeasSupported_r13_constraint_1 },
		0, 0, /* No default value */
