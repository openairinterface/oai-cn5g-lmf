 ...
 */
static int memb_bt_Modes_r13_constraint_1(
...
static int memb_bt_MeasSupported_r13_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  const BIT_STRING_t* st = (const BIT_STRING_t*) sptr;
  size_t size;
...
static asn_oer_constraints_t asn_OER_memb_bt_Modes_r13_constr_2 CC_NOTUSED = {
    {0, 0},
    -1 /* (SIZE(1..8)) */};
...
static asn_oer_constraints_t asn_OER_memb_bt_MeasSupported_r13_constr_5
    CC_NOTUSED = {{0, 0}, -1 /* (SIZE(1..8)) */};
static asn_per_constraints_t asn_PER_memb_bt_MeasSupported_r13_constr_5
    CC_NOTUSED = {
        {APC_UNCONSTRAINED, -1, -1, 0, 0},
        {APC_CONSTRAINED, 3, 3, 1, 8} /* (SIZE(1..8)) */,
        0,
...
static asn_TYPE_member_t asn_MBR_ext1_8[] = {
    {ATF_POINTER,
     2,
     offsetof(
         struct BT_ProvideCapabilities_r13__ext1, idleStateForMeasurements_r14),
...
asn_TYPE_member_t asn_MBR_BT_ProvideCapabilities_r13_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct BT_ProvideCapabilities_r13, bt_Modes_r13),
     (ASN_TAG_CLASS_CONTEXT | (0 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_BIT_STRING,
     0,
     {&asn_OER_memb_bt_Modes_r13_constr_2, &asn_PER_memb_bt_Modes_r13_constr_2,
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct BT_ProvideCapabilities_r13, bt_MeasSupported_r13),
     (ASN_TAG_CLASS_CONTEXT | (1 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_BIT_STRING,
     0,
     {&asn_OER_memb_bt_MeasSupported_r13_constr_5,
    ...
    {ATF_POINTER,
     1,
     offsetof(struct BT_ProvideCapabilities_r13, ext1),
