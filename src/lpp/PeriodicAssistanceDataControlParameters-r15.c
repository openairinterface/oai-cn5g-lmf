...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_4 = {
    ...
    offsetof(
        struct PeriodicAssistanceDataControlParameters_r15__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_PeriodicAssistanceDataControlParameters_r15_1[] = {
    ...
    {ATF_POINTER,
     1,
     offsetof(struct PeriodicAssistanceDataControlParameters_r15, ext1),
...
static const int asn_MAP_PeriodicAssistanceDataControlParameters_r15_oms_1[] = {
    1};
...
asn_SEQUENCE_specifics_t
    asn_SPC_PeriodicAssistanceDataControlParameters_r15_specs_1 = {
        ...
        asn_MAP_PeriodicAssistanceDataControlParameters_r15_oms_1, /* Optional
                                                                      members */
        0,
        1, /* Root/Additions */
        1, /* First extension addition */
...
asn_TYPE_descriptor_t asn_DEF_PeriodicAssistanceDataControlParameters_r15 = {
    ...
    2, /* Elements count */
    &asn_SPC_PeriodicAssistanceDataControlParameters_r15_specs_1 /* Additional
                                                                    specs */
};
