...
static const asn_TYPE_tag2member_t asn_MAP_ext1_tag2el_14[] = {
    {(ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0,
     0}, /* bds-DifferentialCorrectionsSupport-r12 */
...
static const asn_TYPE_tag2member_t asn_MAP_ext2_tag2el_17[] = {
    {(ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0,
     0}, /* gnss-RTK-ObservationsSupport-r15 */
    {(ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0,
     0}, /* glo-RTK-BiasInformationSupport-r15 */
    {(ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0,
     0}, /* gnss-RTK-MAC-CorrectionDifferencesSupport-r15 */
    {(ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0,
     0}, /* gnss-RTK-ResidualsSupport-r15 */
    {(ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0,
     0}, /* gnss-RTK-FKP-GradientsSupport-r15 */
    {(ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0,
     0}, /* gnss-SSR-OrbitCorrectionsSupport-r15 */
    {(ASN_TAG_CLASS_CONTEXT | (6 << 2)), 6, 0,
     0}, /* gnss-SSR-ClockCorrectionsSupport-r15 */
    {(ASN_TAG_CLASS_CONTEXT | (7 << 2)), 7, 0,
     0} /* gnss-SSR-CodeBiasSupport-r15 */
};
...
static const asn_TYPE_tag2member_t asn_MAP_ext3_tag2el_26[] = {
    {(ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0,
     0}, /* gnss-SSR-URA-Support-r16 */
    {(ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0,
     0}, /* gnss-SSR-PhaseBiasSupport-r16 */
    {(ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0,
     0}, /* gnss-SSR-STEC-CorrectionSupport-r16 */
    {(ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0,
     0}, /* gnss-SSR-GriddedCorrectionSupport-r16 */
    {(ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0,
     0}, /* navic-DifferentialCorrectionsSupport-r16 */
    {(ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0,
     0} /* navic-GridModelSupport-r16 */
};
...
asn_TYPE_member_t asn_MBR_GNSS_GenericAssistDataSupportElement_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct GNSS_GenericAssistDataSupportElement, gnss_ID),
     (ASN_TAG_CLASS_CONTEXT | (0 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_GNSS_ID,
     0,
    ...
    {ATF_POINTER,
     13,
     offsetof(struct GNSS_GenericAssistDataSupportElement, sbas_ID),
     (ASN_TAG_CLASS_CONTEXT | (1 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_SBAS_ID,
     0,
    ...
    {ATF_POINTER,
     12,
     offsetof(
         struct GNSS_GenericAssistDataSupportElement, gnss_TimeModelsSupport),
     (ASN_TAG_CLASS_CONTEXT | (2 << 2)),
     -1, /* IMPLICIT tag at current level */
    ...
    {ATF_POINTER,
     6,
     offsetof(struct GNSS_GenericAssistDataSupportElement, gnss_AlmanacSupport),
    ...
    {ATF_POINTER,
     5,
     offsetof(
         struct GNSS_GenericAssistDataSupportElement, gnss_UTC_ModelSupport),
    ...
    {ATF_POINTER,
     3,
     offsetof(struct GNSS_GenericAssistDataSupportElement, ext1),
    ...
    {ATF_POINTER,
     2,
     offsetof(struct GNSS_GenericAssistDataSupportElement, ext2),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct GNSS_GenericAssistDataSupportElement, ext3),
...
static const int asn_MAP_GNSS_GenericAssistDataSupportElement_oms_1[] = {
...
static const asn_TYPE_tag2member_t
    asn_MAP_GNSS_GenericAssistDataSupportElement_tag2el_1[] = {
        ...
        {(ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0,
         0}, /* gnss-TimeModelsSupport */
        {(ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0,
         0}, /* gnss-DifferentialCorrectionsSupport */
        {(ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0,
         0}, /* gnss-NavigationModelSupport */
        {(ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0,
         0}, /* gnss-RealTimeIntegritySupport */
        {(ASN_TAG_CLASS_CONTEXT | (6 << 2)), 6, 0,
         0}, /* gnss-DataBitAssistanceSupport */
        {(ASN_TAG_CLASS_CONTEXT | (7 << 2)), 7, 0,
         0}, /* gnss-AcquisitionAssistanceSupport */
        {(ASN_TAG_CLASS_CONTEXT | (8 << 2)), 8, 0, 0}, /* gnss-AlmanacSupport */
        {(ASN_TAG_CLASS_CONTEXT | (9 << 2)), 9, 0,
         0}, /* gnss-UTC-ModelSupport */
        {(ASN_TAG_CLASS_CONTEXT | (10 << 2)), 10, 0,
         0}, /* gnss-AuxiliaryInformationSupport */
