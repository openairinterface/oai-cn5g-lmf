...
static const asn_TYPE_tag2member_t asn_MAP_ext1_tag2el_5[] = {
    {(ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0,
     0} /* otdoaSignalMeasurementInformation-NB-r14 */
};
...
asn_TYPE_member_t asn_MBR_OTDOA_ProvideLocationInformation_1[] = {
    ...
    {ATF_POINTER,
     2,
     offsetof(struct OTDOA_ProvideLocationInformation, otdoa_Error),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct OTDOA_ProvideLocationInformation, ext1),
...
static const asn_TYPE_tag2member_t
    asn_MAP_OTDOA_ProvideLocationInformation_tag2el_1[] = {
        {(ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0,
         0}, /* otdoaSignalMeasurementInformation */
