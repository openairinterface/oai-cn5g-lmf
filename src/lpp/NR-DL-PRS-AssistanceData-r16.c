...
static int memb_nr_DL_PRS_AssistanceDataList_r16_constraint_1(
...
static int memb_nr_SSB_Config_r16_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  size_t size;
...
static asn_per_constraints_t
    asn_PER_type_nr_DL_PRS_AssistanceDataList_r16_constr_3 CC_NOTUSED = {
        {APC_UNCONSTRAINED, -1, -1, 0, 0},
        {APC_CONSTRAINED, 2, 2, 1, 4} /* (SIZE(1..4)) */,
        0,
        0 /* No PER value map */
};
static asn_per_constraints_t asn_PER_type_nr_SSB_Config_r16_constr_5
    CC_NOTUSED = {
        {APC_UNCONSTRAINED, -1, -1, 0, 0},
...
static asn_per_constraints_t
    asn_PER_memb_nr_DL_PRS_AssistanceDataList_r16_constr_3 CC_NOTUSED = {
        {APC_UNCONSTRAINED, -1, -1, 0, 0},
        {APC_CONSTRAINED, 2, 2, 1, 4} /* (SIZE(1..4)) */,
        0,
        0 /* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_nr_SSB_Config_r16_constr_5
    CC_NOTUSED = {
        {APC_UNCONSTRAINED, -1, -1, 0, 0},
        {APC_CONSTRAINED, 8, 8, 1, 256} /* (SIZE(1..256)) */,
        0,
...
static asn_SET_OF_specifics_t asn_SPC_nr_DL_PRS_AssistanceDataList_r16_specs_3 =
    {
        sizeof(struct
               NR_DL_PRS_AssistanceData_r16__nr_DL_PRS_AssistanceDataList_r16),
        offsetof(
            struct
            NR_DL_PRS_AssistanceData_r16__nr_DL_PRS_AssistanceDataList_r16,
            _asn_ctx),
...
static /* Use -fall-defs-global to expose */
    asn_TYPE_descriptor_t asn_DEF_nr_SSB_Config_r16_5 = {
        ...
        sizeof(asn_DEF_nr_SSB_Config_r16_tags_5) /
                sizeof(asn_DEF_nr_SSB_Config_r16_tags_5[0]) -
            1,                            /* 1 */
...
asn_TYPE_member_t asn_MBR_NR_DL_PRS_AssistanceData_r16_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct NR_DL_PRS_AssistanceData_r16, nr_DL_PRS_ReferenceInfo_r16),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(
         struct NR_DL_PRS_AssistanceData_r16, nr_DL_PRS_AssistanceDataList_r16),
     (ASN_TAG_CLASS_CONTEXT | (1 << 2)),
     0,
     &asn_DEF_nr_DL_PRS_AssistanceDataList_r16_3,
     0,
     {0, &asn_PER_memb_nr_DL_PRS_AssistanceDataList_r16_constr_3,
    ...
    {ATF_POINTER,
     1,
     offsetof(struct NR_DL_PRS_AssistanceData_r16, nr_SSB_Config_r16),
     (ASN_TAG_CLASS_CONTEXT | (2 << 2)),
     0,
     &asn_DEF_nr_SSB_Config_r16_5,
     0,
     {0, &asn_PER_memb_nr_SSB_Config_r16_constr_5,
...
static const asn_TYPE_tag2member_t
    asn_MAP_NR_DL_PRS_AssistanceData_r16_tag2el_1[] = {
        {(ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0,
         0}, /* nr-DL-PRS-ReferenceInfo-r16 */
        {(ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0,
         0}, /* nr-DL-PRS-AssistanceDataList-r16 */
