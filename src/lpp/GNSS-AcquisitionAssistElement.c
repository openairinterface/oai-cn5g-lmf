...
static asn_oer_constraints_t asn_OER_type_dopplerUncertaintyExt_r10_constr_13 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_dopplerUncertainty_constr_5 CC_NOTUSED = {
	{ 1, 1 }	/* (0..4) */,
	-1};
...
asn_TYPE_descriptor_t asn_DEF_dopplerUncertaintyExt_r10_13 = {
	...
	{ &asn_OER_type_dopplerUncertaintyExt_r10_constr_13, &asn_PER_type_dopplerUncertaintyExt_r10_constr_13, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_GNSS_AcquisitionAssistElement_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct GNSS_AcquisitionAssistElement, doppler1),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_doppler1_constr_4, &asn_PER_memb_doppler1_constr_4,  memb_doppler1_constraint_1 },
		0, 0, /* No default value */
		"doppler1"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct GNSS_AcquisitionAssistElement, dopplerUncertainty),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_dopplerUncertainty_constr_5, &asn_PER_memb_dopplerUncertainty_constr_5,  memb_dopplerUncertainty_constraint_1 },
		0, 0, /* No default value */
		"dopplerUncertainty"
		},
	...
	{ ATF_NOFLAGS, 0, offsetof(struct GNSS_AcquisitionAssistElement, intCodePhase),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_intCodePhase_constr_7, &asn_PER_memb_intCodePhase_constr_7,  memb_intCodePhase_constraint_1 },
		0, 0, /* No default value */
		"intCodePhase"
		},
	...
	{ ATF_NOFLAGS, 0, offsetof(struct GNSS_AcquisitionAssistElement, azimuth),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_azimuth_constr_9, &asn_PER_memb_azimuth_constr_9,  memb_azimuth_constraint_1 },
		0, 0, /* No default value */
		"azimuth"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct GNSS_AcquisitionAssistElement, elevation),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_elevation_constr_10, &asn_PER_memb_elevation_constr_10,  memb_elevation_constraint_1 },
		0, 0, /* No default value */
		"elevation"
		},
