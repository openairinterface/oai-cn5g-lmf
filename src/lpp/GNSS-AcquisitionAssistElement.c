 ...
 */
static int memb_doppler0_constraint_1(
...
static int memb_doppler1_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  long value;
...
static int memb_intCodePhase_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  long value;
...
static int memb_azimuth_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  long value;
...
static int memb_elevation_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  long value;
...
static asn_oer_constraints_t asn_OER_type_dopplerUncertaintyExt_r10_constr_13
    CC_NOTUSED = {{0, 0}, -1};
static asn_per_constraints_t asn_PER_type_dopplerUncertaintyExt_r10_constr_13
    CC_NOTUSED = {
...
static asn_oer_constraints_t asn_OER_memb_doppler1_constr_4 CC_NOTUSED = {
    {1, 1} /* (0..63) */,
    -1};
...
static asn_oer_constraints_t asn_OER_memb_dopplerUncertainty_constr_5
    CC_NOTUSED = {{1, 1} /* (0..4) */, -1};
...
static asn_oer_constraints_t asn_OER_memb_intCodePhase_constr_7 CC_NOTUSED = {
    {1, 1} /* (0..127) */,
    -1};
...
static asn_oer_constraints_t asn_OER_memb_codePhaseSearchWindow_constr_8
    CC_NOTUSED = {{1, 1} /* (0..31) */, -1};
...
static asn_oer_constraints_t asn_OER_memb_azimuth_constr_9 CC_NOTUSED = {
    {2, 1} /* (0..511) */,
    -1};
...
static asn_oer_constraints_t asn_OER_memb_elevation_constr_10 CC_NOTUSED = {
    {1, 1} /* (0..127) */,
    -1};
...
static const asn_INTEGER_specifics_t
    asn_SPC_dopplerUncertaintyExt_r10_specs_13 = {
        asn_MAP_dopplerUncertaintyExt_r10_value2enum_13, /* "tag" => N; sorted
                                                            by tag */
        asn_MAP_dopplerUncertaintyExt_r10_enum2value_13, /* N => "tag"; sorted
                                                            by N */
...
asn_TYPE_member_t asn_MBR_GNSS_AcquisitionAssistElement_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct GNSS_AcquisitionAssistElement, svID),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct GNSS_AcquisitionAssistElement, doppler0),
     (ASN_TAG_CLASS_CONTEXT | (1 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_doppler0_constr_3, &asn_PER_memb_doppler0_constr_3,
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct GNSS_AcquisitionAssistElement, doppler1),
     (ASN_TAG_CLASS_CONTEXT | (2 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_doppler1_constr_4, &asn_PER_memb_doppler1_constr_4,
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct GNSS_AcquisitionAssistElement, dopplerUncertainty),
     (ASN_TAG_CLASS_CONTEXT | (3 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_dopplerUncertainty_constr_5,
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct GNSS_AcquisitionAssistElement, codePhase),
     (ASN_TAG_CLASS_CONTEXT | (4 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_codePhase_constr_6, &asn_PER_memb_codePhase_constr_6,
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct GNSS_AcquisitionAssistElement, intCodePhase),
     (ASN_TAG_CLASS_CONTEXT | (5 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_intCodePhase_constr_7, &asn_PER_memb_intCodePhase_constr_7,
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct GNSS_AcquisitionAssistElement, codePhaseSearchWindow),
     (ASN_TAG_CLASS_CONTEXT | (6 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_codePhaseSearchWindow_constr_8,
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct GNSS_AcquisitionAssistElement, azimuth),
     (ASN_TAG_CLASS_CONTEXT | (7 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_azimuth_constr_9, &asn_PER_memb_azimuth_constr_9,
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct GNSS_AcquisitionAssistElement, elevation),
     (ASN_TAG_CLASS_CONTEXT | (8 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_elevation_constr_10, &asn_PER_memb_elevation_constr_10,
    ...
    {ATF_POINTER,
     2,
     offsetof(struct GNSS_AcquisitionAssistElement, codePhase1023),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct GNSS_AcquisitionAssistElement, dopplerUncertaintyExt_r10),
