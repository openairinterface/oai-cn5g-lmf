...
struct ECID_LocationServerErrorCauses;
struct ECID_TargetDeviceErrorCauses;

/* ECID-Error */
typedef struct ECID_Error {
	ECID_Error_PR present;
	union ECID_Error_u {
		struct ECID_LocationServerErrorCauses	*locationServerErrorCauses;
		struct ECID_TargetDeviceErrorCauses	*targetDeviceErrorCauses;
		/*
