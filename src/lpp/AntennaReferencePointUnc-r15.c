...
static asn_oer_constraints_t asn_OER_memb_uncertainty_X_r15_constr_2 CC_NOTUSED = {
	{ 1, 1 }	/* (0..255) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_confidence_X_r15_constr_3 CC_NOTUSED = {
	{ 1, 1 }	/* (0..100) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_uncertainty_Y_r15_constr_4 CC_NOTUSED = {
	{ 1, 1 }	/* (0..255) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_confidence_Y_r15_constr_5 CC_NOTUSED = {
	{ 1, 1 }	/* (0..100) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_uncertainty_Z_r15_constr_6 CC_NOTUSED = {
	{ 1, 1 }	/* (0..255) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_confidence_Z_r15_constr_7 CC_NOTUSED = {
	{ 1, 1 }	/* (0..100) */,
	-1};
...
asn_TYPE_member_t asn_MBR_AntennaReferencePointUnc_r15_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct AntennaReferencePointUnc_r15, uncertainty_X_r15),
		...
		0,
		{ &asn_OER_memb_uncertainty_X_r15_constr_2, &asn_PER_memb_uncertainty_X_r15_constr_2,  memb_uncertainty_X_r15_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct AntennaReferencePointUnc_r15, confidence_X_r15),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_confidence_X_r15_constr_3, &asn_PER_memb_confidence_X_r15_constr_3,  memb_confidence_X_r15_constraint_1 },
		0, 0, /* No default value */
		"confidence-X-r15"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct AntennaReferencePointUnc_r15, uncertainty_Y_r15),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_uncertainty_Y_r15_constr_4, &asn_PER_memb_uncertainty_Y_r15_constr_4,  memb_uncertainty_Y_r15_constraint_1 },
		0, 0, /* No default value */
		"uncertainty-Y-r15"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct AntennaReferencePointUnc_r15, confidence_Y_r15),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_confidence_Y_r15_constr_5, &asn_PER_memb_confidence_Y_r15_constr_5,  memb_confidence_Y_r15_constraint_1 },
		0, 0, /* No default value */
		"confidence-Y-r15"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct AntennaReferencePointUnc_r15, uncertainty_Z_r15),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_uncertainty_Z_r15_constr_6, &asn_PER_memb_uncertainty_Z_r15_constr_6,  memb_uncertainty_Z_r15_constraint_1 },
		0, 0, /* No default value */
		"uncertainty-Z-r15"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct AntennaReferencePointUnc_r15, confidence_Z_r15),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_confidence_Z_r15_constr_7, &asn_PER_memb_confidence_Z_r15_constr_7,  memb_confidence_Z_r15_constraint_1 },
		0, 0, /* No default value */
		"confidence-Z-r15"
		},
};
