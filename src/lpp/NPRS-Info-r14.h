...
typedef enum NPRS_Info_r14__partA_r14__nprs_MutingInfoA_r14_PR {
  NPRS_Info_r14__partA_r14__nprs_MutingInfoA_r14_PR_NOTHING, /* No components
                                                                present */
...
typedef enum NPRS_Info_r14__partB_r14__nprs_MutingInfoB_r14_PR {
  NPRS_Info_r14__partB_r14__nprs_MutingInfoB_r14_PR_NOTHING, /* No components
                                                                present */
...
typedef enum NPRS_Info_r14__ext1__partA_TDD_r15__nprsBitmap_r15_PR {
  NPRS_Info_r14__ext1__partA_TDD_r15__nprsBitmap_r15_PR_NOTHING, /* No
                                                                    components
                                                                    present */
...
typedef enum NPRS_Info_r14__ext1__partA_TDD_r15__nprs_MutingInfoA_r15_PR {
  NPRS_Info_r14__ext1__partA_TDD_r15__nprs_MutingInfoA_r15_PR_NOTHING, /* No
                                                                          components
                                                                          present
                                                                        */
...
/* Implementation */
/* extern asn_TYPE_descriptor_t asn_DEF_operationModeInfoNPRS_r14_2;	//
 * (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_nprs_Period_r14_20;	// (Use
 * -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_nprs_startSF_r14_27;	// (Use
 * -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_nprs_NumSF_r14_37;	// (Use
 * -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_sib1_SF_TDD_r15_56;	// (Use
 * -fall-defs-global to expose) */
