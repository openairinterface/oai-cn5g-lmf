...
static asn_oer_constraints_t asn_OER_memb_dgnss_RefTime_constr_2 CC_NOTUSED = {
	{ 2, 1 }	/* (0..3599) */,
	-1};
...
asn_TYPE_member_t asn_MBR_GNSS_DifferentialCorrections_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct GNSS_DifferentialCorrections, dgnss_RefTime),
		...
		0,
		{ &asn_OER_memb_dgnss_RefTime_constr_2, &asn_PER_memb_dgnss_RefTime_constr_2,  memb_dgnss_RefTime_constraint_1 },
