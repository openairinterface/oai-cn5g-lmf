...
static asn_oer_constraints_t asn_OER_memb_requestedMeasurements_r13_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..8)) */};
...
asn_TYPE_member_t asn_MBR_BT_RequestLocationInformation_r13_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct BT_RequestLocationInformation_r13, requestedMeasurements_r13),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_requestedMeasurements_r13_constr_2, &asn_PER_memb_requestedMeasurements_r13_constr_2,  memb_requestedMeasurements_r13_constraint_1 },
