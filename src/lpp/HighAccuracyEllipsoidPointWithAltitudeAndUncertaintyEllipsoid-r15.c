...
static asn_oer_constraints_t asn_OER_memb_degreesLatitude_r15_constr_2 CC_NOTUSED = {
...
static asn_oer_constraints_t asn_OER_memb_degreesLongitude_r15_constr_3 CC_NOTUSED = {
	{ 4, 0 }	/* (-2147483648..2147483647) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_uncertaintySemiMajor_r15_constr_5 CC_NOTUSED = {
	{ 1, 1 }	/* (0..255) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_uncertaintySemiMinor_r15_constr_6 CC_NOTUSED = {
	{ 1, 1 }	/* (0..255) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_orientationMajorAxis_r15_constr_7 CC_NOTUSED = {
	{ 1, 1 }	/* (0..179) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_horizontalConfidence_r15_constr_8 CC_NOTUSED = {
	{ 1, 1 }	/* (0..100) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_uncertaintyAltitude_r15_constr_9 CC_NOTUSED = {
	{ 1, 1 }	/* (0..255) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_verticalConfidence_r15_constr_10 CC_NOTUSED = {
	{ 1, 1 }	/* (0..100) */,
	-1};
...
asn_TYPE_member_t asn_MBR_HighAccuracyEllipsoidPointWithAltitudeAndUncertaintyEllipsoid_r15_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct HighAccuracyEllipsoidPointWithAltitudeAndUncertaintyEllipsoid_r15, degreesLatitude_r15),
		...
		0,
		{ &asn_OER_memb_degreesLatitude_r15_constr_2, &asn_PER_memb_degreesLatitude_r15_constr_2,  memb_degreesLatitude_r15_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct HighAccuracyEllipsoidPointWithAltitudeAndUncertaintyEllipsoid_r15, degreesLongitude_r15),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_degreesLongitude_r15_constr_3, &asn_PER_memb_degreesLongitude_r15_constr_3,  memb_degreesLongitude_r15_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct HighAccuracyEllipsoidPointWithAltitudeAndUncertaintyEllipsoid_r15, altitude_r15),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_altitude_r15_constr_4, &asn_PER_memb_altitude_r15_constr_4,  memb_altitude_r15_constraint_1 },
		0, 0, /* No default value */
		"altitude-r15"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct HighAccuracyEllipsoidPointWithAltitudeAndUncertaintyEllipsoid_r15, uncertaintySemiMajor_r15),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_uncertaintySemiMajor_r15_constr_5, &asn_PER_memb_uncertaintySemiMajor_r15_constr_5,  memb_uncertaintySemiMajor_r15_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct HighAccuracyEllipsoidPointWithAltitudeAndUncertaintyEllipsoid_r15, uncertaintySemiMinor_r15),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_uncertaintySemiMinor_r15_constr_6, &asn_PER_memb_uncertaintySemiMinor_r15_constr_6,  memb_uncertaintySemiMinor_r15_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct HighAccuracyEllipsoidPointWithAltitudeAndUncertaintyEllipsoid_r15, orientationMajorAxis_r15),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_orientationMajorAxis_r15_constr_7, &asn_PER_memb_orientationMajorAxis_r15_constr_7,  memb_orientationMajorAxis_r15_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct HighAccuracyEllipsoidPointWithAltitudeAndUncertaintyEllipsoid_r15, horizontalConfidence_r15),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_horizontalConfidence_r15_constr_8, &asn_PER_memb_horizontalConfidence_r15_constr_8,  memb_horizontalConfidence_r15_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct HighAccuracyEllipsoidPointWithAltitudeAndUncertaintyEllipsoid_r15, uncertaintyAltitude_r15),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_uncertaintyAltitude_r15_constr_9, &asn_PER_memb_uncertaintyAltitude_r15_constr_9,  memb_uncertaintyAltitude_r15_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct HighAccuracyEllipsoidPointWithAltitudeAndUncertaintyEllipsoid_r15, verticalConfidence_r15),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_verticalConfidence_r15_constr_10, &asn_PER_memb_verticalConfidence_r15_constr_10,  memb_verticalConfidence_r15_constraint_1 },
		0, 0, /* No default value */
