 ...
 */
static int memb_ssb_Index_r16_constraint_2(
...
static /* Use -fall-defs-global to expose */
    asn_TYPE_descriptor_t asn_DEF_rs_Type_r16_5 = {
        ...
        sizeof(asn_DEF_rs_Type_r16_tags_5) /
                sizeof(asn_DEF_rs_Type_r16_tags_5[0]) -
            1,                      /* 1 */
...
static asn_TYPE_member_t asn_MBR_ssb_r16_2[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct DL_PRS_QCL_Info_r16__ssb_r16, pci_r16),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct DL_PRS_QCL_Info_r16__ssb_r16, ssb_Index_r16),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct DL_PRS_QCL_Info_r16__ssb_r16, rs_Type_r16),
...
static /* Use -fall-defs-global to expose */
    asn_TYPE_descriptor_t asn_DEF_ssb_r16_2 = {
        ...
        sizeof(asn_DEF_ssb_r16_tags_2) / sizeof(asn_DEF_ssb_r16_tags_2[0]) -
            1,                  /* 1 */
...
static asn_TYPE_member_t asn_MBR_dl_PRS_r16_9[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(
         struct DL_PRS_QCL_Info_r16__dl_PRS_r16, qcl_DL_PRS_ResourceID_r16),
     (ASN_TAG_CLASS_CONTEXT | (0 << 2)),
     -1, /* IMPLICIT tag at current level */
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(
         struct DL_PRS_QCL_Info_r16__dl_PRS_r16, qcl_DL_PRS_ResourceSetID_r16),
     (ASN_TAG_CLASS_CONTEXT | (1 << 2)),
     -1, /* IMPLICIT tag at current level */
...
static const asn_TYPE_tag2member_t asn_MAP_dl_PRS_r16_tag2el_9[] = {
    {(ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0,
     0}, /* qcl-DL-PRS-ResourceID-r16 */
    {(ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0,
     0} /* qcl-DL-PRS-ResourceSetID-r16 */
};
...
static /* Use -fall-defs-global to expose */
    asn_TYPE_descriptor_t asn_DEF_dl_PRS_r16_9 = {
        ...
        sizeof(asn_DEF_dl_PRS_r16_tags_9) /
                sizeof(asn_DEF_dl_PRS_r16_tags_9[0]) -
            1,                     /* 1 */
...
asn_TYPE_member_t asn_MBR_DL_PRS_QCL_Info_r16_1[] = {
    {ATF_POINTER,
     0,
     offsetof(struct DL_PRS_QCL_Info_r16, choice.ssb_r16),
     (ASN_TAG_CLASS_CONTEXT | (0 << 2)),
     0,
     &asn_DEF_ssb_r16_2,
     0,
    ...
    {ATF_POINTER,
     0,
     offsetof(struct DL_PRS_QCL_Info_r16, choice.dl_PRS_r16),
     (ASN_TAG_CLASS_CONTEXT | (1 << 2)),
     0,
