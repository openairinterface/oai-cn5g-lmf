...
asn_TYPE_member_t asn_MBR_GNSS_RTK_MAC_CorrectionDifferences_r15_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct GNSS_RTK_MAC_CorrectionDifferences_r15, networkID_r15),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct GNSS_RTK_MAC_CorrectionDifferences_r15, subNetworkID_r15),
    ...
    {ATF_POINTER,
     2,
     offsetof(struct GNSS_RTK_MAC_CorrectionDifferences_r15, l1_r15),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct GNSS_RTK_MAC_CorrectionDifferences_r15, l2_r15),
...
static const int asn_MAP_GNSS_RTK_MAC_CorrectionDifferences_r15_oms_1[] = {
    1, 3, 4};
...
static const asn_TYPE_tag2member_t
    asn_MAP_GNSS_RTK_MAC_CorrectionDifferences_r15_tag2el_1[] = {
        ...
        {(ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0,
         0} /* rtkCorrectionDifferencesList-r15 */
};
asn_SEQUENCE_specifics_t
    asn_SPC_GNSS_RTK_MAC_CorrectionDifferences_r15_specs_1 = {
        sizeof(struct GNSS_RTK_MAC_CorrectionDifferences_r15),
        offsetof(struct GNSS_RTK_MAC_CorrectionDifferences_r15, _asn_ctx),
        asn_MAP_GNSS_RTK_MAC_CorrectionDifferences_r15_tag2el_1,
        6, /* Count of tags in the map */
        asn_MAP_GNSS_RTK_MAC_CorrectionDifferences_r15_oms_1, /* Optional
                                                                 members */
        3,
        0, /* Root/Additions */
...
asn_TYPE_descriptor_t asn_DEF_GNSS_RTK_MAC_CorrectionDifferences_r15 = {
    ...
    sizeof(asn_DEF_GNSS_RTK_MAC_CorrectionDifferences_r15_tags_1) /
        sizeof(
            asn_DEF_GNSS_RTK_MAC_CorrectionDifferences_r15_tags_1[0]), /* 1 */
