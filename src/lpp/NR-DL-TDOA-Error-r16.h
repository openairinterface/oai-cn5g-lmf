...
struct NR_DL_TDOA_LocationServerErrorCauses_r16;
struct NR_DL_TDOA_TargetDeviceErrorCauses_r16;

/* NR-DL-TDOA-Error-r16 */
typedef struct NR_DL_TDOA_Error_r16 {
	NR_DL_TDOA_Error_r16_PR present;
	union NR_DL_TDOA_Error_r16_u {
		struct NR_DL_TDOA_LocationServerErrorCauses_r16	*locationServerErrorCauses_r16;
		struct NR_DL_TDOA_TargetDeviceErrorCauses_r16	*targetDeviceErrorCauses_r16;
		/*
