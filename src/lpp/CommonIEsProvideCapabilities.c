...
static asn_TYPE_member_t asn_MBR_ext1_3[] = {
    {ATF_POINTER,
     2,
     offsetof(struct CommonIEsProvideCapabilities__ext1, segmentationInfo_r14),
...
static const asn_TYPE_tag2member_t asn_MAP_ext1_tag2el_3[] = {
    ...
    {(ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0,
     0} /* lpp-message-segmentation-r14 */
};
...
asn_TYPE_member_t asn_MBR_CommonIEsProvideCapabilities_1[] = {
    {ATF_POINTER,
     1,
     offsetof(struct CommonIEsProvideCapabilities, ext1),
     (ASN_TAG_CLASS_CONTEXT | (0 << 2)),
     0,
     &asn_DEF_ext1_3,
     0,
