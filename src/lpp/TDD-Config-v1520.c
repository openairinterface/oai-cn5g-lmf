 ...
 */
static asn_oer_constraints_t asn_OER_type_subframeAssignment_v1520_constr_2
    CC_NOTUSED = {{0, 0}, -1};
static asn_per_constraints_t asn_PER_type_subframeAssignment_v1520_constr_2
    CC_NOTUSED = {
...
static const asn_INTEGER_enum_map_t
    asn_MAP_subframeAssignment_v1520_value2enum_2[] = {
...
asn_TYPE_member_t asn_MBR_TDD_Config_v1520_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct TDD_Config_v1520, subframeAssignment_v1520),
