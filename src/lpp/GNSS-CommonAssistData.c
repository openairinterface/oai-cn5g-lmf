...
static asn_TYPE_member_t asn_MBR_ext1_7[] = {
    {ATF_POINTER,
     3,
     offsetof(
         struct GNSS_CommonAssistData__ext1, gnss_RTK_ReferenceStationInfo_r15),
    ...
    {ATF_POINTER,
     1,
     offsetof(
         struct GNSS_CommonAssistData__ext1, gnss_RTK_AuxiliaryStationData_r15),
...
static const asn_TYPE_tag2member_t asn_MAP_ext1_tag2el_7[] = {
    {(ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0,
     0}, /* gnss-RTK-ReferenceStationInfo-r15 */
    {(ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0,
     0}, /* gnss-RTK-CommonObservationInfo-r15 */
    {(ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0,
     0} /* gnss-RTK-AuxiliaryStationData-r15 */
};
...
static asn_TYPE_member_t asn_MBR_ext2_11[] = {
    {ATF_POINTER,
     1,
     offsetof(
         struct GNSS_CommonAssistData__ext2, gnss_SSR_CorrectionPoints_r16),
     (ASN_TAG_CLASS_CONTEXT | (0 << 2)),
     -1, /* IMPLICIT tag at current level */
...
static const asn_TYPE_tag2member_t asn_MAP_ext2_tag2el_11[] = {
    {(ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0,
     0} /* gnss-SSR-CorrectionPoints-r16 */
};
...
asn_TYPE_member_t asn_MBR_GNSS_CommonAssistData_1[] = {
    {ATF_POINTER,
     6,
     offsetof(struct GNSS_CommonAssistData, gnss_ReferenceTime),
     (ASN_TAG_CLASS_CONTEXT | (0 << 2)),
     -1, /* IMPLICIT tag at current level */
    ...
    {ATF_POINTER,
     5,
     offsetof(struct GNSS_CommonAssistData, gnss_ReferenceLocation),
     (ASN_TAG_CLASS_CONTEXT | (1 << 2)),
     -1, /* IMPLICIT tag at current level */
    ...
    {ATF_POINTER,
     4,
     offsetof(struct GNSS_CommonAssistData, gnss_IonosphericModel),
     (ASN_TAG_CLASS_CONTEXT | (2 << 2)),
     -1, /* IMPLICIT tag at current level */
    ...
    {ATF_POINTER,
     3,
     offsetof(struct GNSS_CommonAssistData, gnss_EarthOrientationParameters),
    ...
    {ATF_POINTER,
     2,
     offsetof(struct GNSS_CommonAssistData, ext1),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct GNSS_CommonAssistData, ext2),
...
static const asn_TYPE_tag2member_t asn_MAP_GNSS_CommonAssistData_tag2el_1[] = {
    ...
    {(ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0,
     0}, /* gnss-EarthOrientationParameters */
