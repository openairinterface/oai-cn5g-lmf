...
static asn_oer_constraints_t asn_OER_memb_bssid_r13_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	6	/* (SIZE(6..6)) */};
...
static asn_oer_constraints_t asn_OER_memb_ssid_r13_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..32)) */};
...
asn_TYPE_member_t asn_MBR_WLAN_AP_Identifier_r13_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct WLAN_AP_Identifier_r13, bssid_r13),
		...
		0,
		{ &asn_OER_memb_bssid_r13_constr_2, &asn_PER_memb_bssid_r13_constr_2,  memb_bssid_r13_constraint_1 },
	...
	{ ATF_POINTER, 1, offsetof(struct WLAN_AP_Identifier_r13, ssid_r13),
		...
		&asn_DEF_OCTET_STRING,
		0,
		{ &asn_OER_memb_ssid_r13_constr_3, &asn_PER_memb_ssid_r13_constr_3,  memb_ssid_r13_constraint_1 },
		0, 0, /* No default value */
		"ssid-r13"
		},
};
