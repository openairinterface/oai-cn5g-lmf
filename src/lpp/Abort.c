...
static asn_TYPE_member_t asn_MBR_c1_3[] = {
    {ATF_POINTER,
     0,
     offsetof(struct Abort__criticalExtensions__c1, choice.abort_r9),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct Abort__criticalExtensions__c1, choice.spare3),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct Abort__criticalExtensions__c1, choice.spare2),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct Abort__criticalExtensions__c1, choice.spare1),
...
static asn_SEQUENCE_specifics_t asn_SPC_criticalExtensionsFuture_specs_8 = {
    ...
    offsetof(
        struct Abort__criticalExtensions__criticalExtensionsFuture, _asn_ctx),
    0, /* No top level tags */
...
static asn_TYPE_member_t asn_MBR_criticalExtensions_2[] = {
    {ATF_POINTER,
     0,
     offsetof(struct Abort__criticalExtensions, choice.c1),
     (ASN_TAG_CLASS_CONTEXT | (0 << 2)),
    ...
    {ATF_POINTER,
     0,
     offsetof(
         struct Abort__criticalExtensions, choice.criticalExtensionsFuture),
     (ASN_TAG_CLASS_CONTEXT | (1 << 2)),
     0,
...
asn_TYPE_member_t asn_MBR_Abort_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct Abort, criticalExtensions),
     (ASN_TAG_CLASS_CONTEXT | (0 << 2)),
     +1, /* EXPLICIT tag at current level */
...
asn_TYPE_descriptor_t asn_DEF_Abort = {
    ...
    sizeof(asn_DEF_Abort_tags_1) / sizeof(asn_DEF_Abort_tags_1[0]), /* 1 */
