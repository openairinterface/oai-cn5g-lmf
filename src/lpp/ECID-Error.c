...
asn_TYPE_member_t asn_MBR_ECID_Error_1[] = {
    {ATF_POINTER,
     0,
     offsetof(struct ECID_Error, choice.locationServerErrorCauses),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct ECID_Error, choice.targetDeviceErrorCauses),
...
asn_TYPE_descriptor_t asn_DEF_ECID_Error = {
    ...
    0, /* No tags (pointer) */
    0, /* No tags (count) */
    {&asn_OER_type_ECID_Error_constr_1, &asn_PER_type_ECID_Error_constr_1,
     CHOICE_constraint},
