...
oer_type_decoder_f Environment_decode_oer;
oer_type_encoder_f Environment_encode_oer;
per_type_decoder_f Environment_decode_uper;
per_type_encoder_f Environment_encode_uper;
per_type_decoder_f Environment_decode_aper;
per_type_encoder_f Environment_encode_aper;
