...
static int memb_correctionPointSetID_Req_r16_constraint_1(
...
static asn_per_constraints_t asn_PER_memb_correctionPointSetID_Req_r16_constr_2
    CC_NOTUSED = {
...
asn_TYPE_member_t asn_MBR_GNSS_SSR_CorrectionPointsReq_r16_1[] = {
    {ATF_POINTER,
     1,
     offsetof(
         struct GNSS_SSR_CorrectionPointsReq_r16, correctionPointSetID_Req_r16),
...
static const asn_TYPE_tag2member_t
    asn_MAP_GNSS_SSR_CorrectionPointsReq_r16_tag2el_1[] = {
        {(ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0,
         0} /* correctionPointSetID-Req-r16 */
};
