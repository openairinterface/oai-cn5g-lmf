...
asn_TYPE_member_t asn_MBR_WLAN_MeasurementInformation_r13_1[] = {
    {ATF_POINTER,
     2,
     offsetof(
         struct WLAN_MeasurementInformation_r13, measurementReferenceTime_r13),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct WLAN_MeasurementInformation_r13, wlan_MeasurementList_r13),
