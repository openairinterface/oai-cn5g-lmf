...
asn_per_constraints_t asn_PER_type_GNSS_AuxiliaryInformation_constr_1
    CC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_ext1_5[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct GNSS_AuxiliaryInformation__ext1, gnss_ID_BDS_r16),
...
asn_TYPE_member_t asn_MBR_GNSS_AuxiliaryInformation_1[] = {
    {ATF_POINTER,
     0,
     offsetof(struct GNSS_AuxiliaryInformation, choice.gnss_ID_GPS),
     (ASN_TAG_CLASS_CONTEXT | (0 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_GNSS_ID_GPS,
     0,
    ...
    {ATF_POINTER,
     0,
     offsetof(struct GNSS_AuxiliaryInformation, choice.gnss_ID_GLONASS),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct GNSS_AuxiliaryInformation, choice.ext1),
