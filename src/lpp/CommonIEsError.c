 ...
 */
static asn_oer_constraints_t asn_OER_type_errorCause_constr_2 CC_NOTUSED = {
    {0, 0},
    -1};
...
static /* Use -fall-defs-global to expose */
    asn_TYPE_descriptor_t asn_DEF_errorCause_2 = {
        ...
        sizeof(asn_DEF_errorCause_tags_2) /
                sizeof(asn_DEF_errorCause_tags_2[0]) -
            1,                     /* 1 */
        asn_DEF_errorCause_tags_2, /* Same as above */
        sizeof(asn_DEF_errorCause_tags_2) /
            sizeof(asn_DEF_errorCause_tags_2[0]), /* 2 */
        {&asn_OER_type_errorCause_constr_2, &asn_PER_type_errorCause_constr_2,
...
asn_TYPE_member_t asn_MBR_CommonIEsError_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct CommonIEsError, errorCause),
