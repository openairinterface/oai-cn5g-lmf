...
asn_TYPE_member_t asn_MBR_A_GNSS_ProvideLocationInformation_1[] = {
    ...
    {ATF_POINTER,
     2,
     offsetof(
         struct A_GNSS_ProvideLocationInformation, gnss_LocationInformation),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct A_GNSS_ProvideLocationInformation, gnss_Error),
...
static const asn_TYPE_tag2member_t
    asn_MAP_A_GNSS_ProvideLocationInformation_tag2el_1[] = {
        {(ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0,
         0}, /* gnss-SignalMeasurementInformation */
        {(ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0,
         0}, /* gnss-LocationInformation */
