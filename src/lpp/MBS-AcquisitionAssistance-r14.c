...
static asn_oer_constraints_t asn_OER_type_mbsConfiguration_r14_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_pnCodeIndex_r14_constr_9 CC_NOTUSED = {
	{ 1, 1 }	/* (1..128) */,
	-1};
...
asn_TYPE_descriptor_t asn_DEF_mbsConfiguration_r14_3 = {
	...
	{ &asn_OER_type_mbsConfiguration_r14_constr_3, &asn_PER_type_mbsConfiguration_r14_constr_3, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_MBS_AcquisitionAssistance_r14_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct MBS_AcquisitionAssistance_r14, pnCodeIndex_r14),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_pnCodeIndex_r14_constr_9, &asn_PER_memb_pnCodeIndex_r14_constr_9,  memb_pnCodeIndex_r14_constraint_1 },
		0, 0, /* No default value */
		"pnCodeIndex-r14"
		},
	{ ATF_POINTER, 1, offsetof(struct MBS_AcquisitionAssistance_r14, freq_r14),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_freq_r14_constr_10, &asn_PER_memb_freq_r14_constr_10,  memb_freq_r14_constraint_1 },
		0, 0, /* No default value */
		"freq-r14"
		},
};
