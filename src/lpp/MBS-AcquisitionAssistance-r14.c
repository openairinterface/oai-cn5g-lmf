...
static int memb_pnCodeIndex_r14_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  long value;
...
static int memb_freq_r14_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  long value;
...
static asn_oer_constraints_t asn_OER_type_mbsConfiguration_r14_constr_3
    CC_NOTUSED = {{0, 0}, -1};
static asn_per_constraints_t asn_PER_type_mbsConfiguration_r14_constr_3
    CC_NOTUSED = {
...
static asn_oer_constraints_t asn_OER_memb_pnCodeIndex_r14_constr_9
    CC_NOTUSED = {{1, 1} /* (1..128) */, -1};
static asn_per_constraints_t asn_PER_memb_pnCodeIndex_r14_constr_9
    CC_NOTUSED = {
...
static asn_oer_constraints_t asn_OER_memb_freq_r14_constr_10 CC_NOTUSED = {
    {4, 1} /* (919750000..927250000) */,
    -1};
static asn_per_constraints_t asn_PER_memb_freq_r14_constr_10 CC_NOTUSED = {
    {APC_CONSTRAINED, 23, -1, 919750000,
     927250000} /* (919750000..927250000) */,
    {APC_UNCONSTRAINED, -1, -1, 0, 0},
    0,
    0 /* No PER value map */
};
static const asn_INTEGER_enum_map_t
    asn_MAP_mbsConfiguration_r14_value2enum_3[] = {
        {0, 3, "tb1"},
        {1, 3, "tb2"},
        {2, 3, "tb3"},
        {3, 3, "tb4"}
...
asn_TYPE_member_t asn_MBR_MBS_AcquisitionAssistance_r14_1[] = {
    {ATF_POINTER,
     4,
     offsetof(struct MBS_AcquisitionAssistance_r14, transmitterID_r14),
    ...
    {ATF_POINTER,
     3,
     offsetof(struct MBS_AcquisitionAssistance_r14, mbsConfiguration_r14),
    ...
    {ATF_POINTER,
     2,
     offsetof(struct MBS_AcquisitionAssistance_r14, pnCodeIndex_r14),
     (ASN_TAG_CLASS_CONTEXT | (2 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_pnCodeIndex_r14_constr_9,
    ...
    {ATF_POINTER,
     1,
     offsetof(struct MBS_AcquisitionAssistance_r14, freq_r14),
     (ASN_TAG_CLASS_CONTEXT | (3 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_freq_r14_constr_10, &asn_PER_memb_freq_r14_constr_10,
