...
static asn_TYPE_member_t asn_MBR_referencePointGeographicLocation_r16_2[] = {
	{ ATF_POINTER, 0, offsetof(struct ReferencePoint_r16__referencePointGeographicLocation_r16, choice.location3D_r16),
	...
	{ ATF_POINTER, 0, offsetof(struct ReferencePoint_r16__referencePointGeographicLocation_r16, choice.ha_location3D_r16),
