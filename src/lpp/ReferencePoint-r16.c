...
static asn_per_constraints_t
    asn_PER_type_referencePointGeographicLocation_r16_constr_2 CC_NOTUSED = {
...
static asn_CHOICE_specifics_t
    asn_SPC_referencePointGeographicLocation_r16_specs_2 = {
        ...
        offsetof(
            ...
            present),
        sizeof(((struct
                 ReferencePoint_r16__referencePointGeographicLocation_r16*) 0)
                   ->present),
        asn_MAP_referencePointGeographicLocation_r16_tag2el_2,
...
static /* Use -fall-defs-global to expose */
    asn_TYPE_descriptor_t asn_DEF_referencePointGeographicLocation_r16_2 = {
        ...
        2, /* Elements count */
        &asn_SPC_referencePointGeographicLocation_r16_specs_2 /* Additional
                                                                 specs */
};
...
asn_TYPE_member_t asn_MBR_ReferencePoint_r16_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct ReferencePoint_r16, referencePointGeographicLocation_r16),
     (ASN_TAG_CLASS_CONTEXT | (0 << 2)),
...
static const asn_TYPE_tag2member_t asn_MAP_ReferencePoint_r16_tag2el_1[] = {
    {(ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0,
     0} /* referencePointGeographicLocation-r16 */
};
