...
static asn_oer_constraints_t asn_OER_type_idleStateForMeasurements_r14_constr_10 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_type_sensor_MotionInformationSup_r15_constr_13 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_sensor_Modes_r13_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..8)) */};
...
asn_TYPE_descriptor_t asn_DEF_idleStateForMeasurements_r14_10 = {
	...
	{ &asn_OER_type_idleStateForMeasurements_r14_constr_10, &asn_PER_type_idleStateForMeasurements_r14_constr_10, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_sensor_MotionInformationSup_r15_13 = {
	...
	{ &asn_OER_type_sensor_MotionInformationSup_r15_constr_13, &asn_PER_type_sensor_MotionInformationSup_r15_constr_13, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_member_t asn_MBR_Sensor_ProvideCapabilities_r13_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct Sensor_ProvideCapabilities_r13, sensor_Modes_r13),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_sensor_Modes_r13_constr_2, &asn_PER_memb_sensor_Modes_r13_constr_2,  memb_sensor_Modes_r13_constraint_1 },
		0, 0, /* No default value */
		"sensor-Modes-r13"
		},
	{ ATF_POINTER, 2, offsetof(struct Sensor_ProvideCapabilities_r13, ext1),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_ext1_7,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct Sensor_ProvideCapabilities_r13, ext2),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		&asn_DEF_ext2_12,
		0,
