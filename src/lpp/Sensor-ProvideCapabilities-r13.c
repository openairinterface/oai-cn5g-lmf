...
static asn_per_constraints_t asn_PER_type_adjustmentSupported_r16_constr_16
    CC_NOTUSED = {
        {APC_CONSTRAINED, 0, 0, 0, 0} /* (0..0) */,
        {APC_UNCONSTRAINED, -1, -1, 0, 0},
        0,
...
static /* Use -fall-defs-global to expose */
    asn_TYPE_descriptor_t asn_DEF_idleStateForMeasurements_r14_10 = {
        ...
        {0, &asn_PER_type_idleStateForMeasurements_r14_constr_10,
...
static /* Use -fall-defs-global to expose */
    asn_TYPE_descriptor_t asn_DEF_sensor_MotionInformationSup_r15_13 = {
        ...
        {0, &asn_PER_type_sensor_MotionInformationSup_r15_constr_13,
         NativeEnumerated_constraint},
        0,
        0, /* Defined elsewhere */
...
static const asn_INTEGER_enum_map_t
    asn_MAP_adjustmentSupported_r16_value2enum_16[] = {{0, 4, "true"}};
...
static asn_TYPE_member_t asn_MBR_ext3_15[] = {
    {ATF_POINTER,
     1,
     offsetof(
         struct Sensor_ProvideCapabilities_r13__ext3, adjustmentSupported_r16),
     (ASN_TAG_CLASS_CONTEXT | (0 << 2)),
     -1, /* IMPLICIT tag at current level */
...
static /* Use -fall-defs-global to expose */
    asn_TYPE_descriptor_t asn_DEF_ext3_15 = {
        ...
        sizeof(asn_DEF_ext3_tags_15) / sizeof(asn_DEF_ext3_tags_15[0]) -
            1,                /* 1 */
        asn_DEF_ext3_tags_15, /* Same as above */
        sizeof(asn_DEF_ext3_tags_15) / sizeof(asn_DEF_ext3_tags_15[0]), /* 2 */
        {0, 0, SEQUENCE_constraint},
        asn_MBR_ext3_15,
        1,                     /* Elements count */
...
asn_TYPE_member_t asn_MBR_Sensor_ProvideCapabilities_r13_1[] = {
    {ATF_NOFLAGS,
     ...
     &asn_DEF_BIT_STRING,
     0,
     {0, &asn_PER_memb_sensor_Modes_r13_constr_2,
    ...
    {ATF_POINTER,
     1,
     offsetof(struct Sensor_ProvideCapabilities_r13, ext3),
