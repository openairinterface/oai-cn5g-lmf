...
static const asn_TYPE_tag2member_t asn_MAP_ext2_tag2el_13[] = {
    {(ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0,
     0}, /* nr-ECID-ProvideCapabilities-r16 */
    {(ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0,
     0}, /* nr-Multi-RTT-ProvideCapabilities-r16 */
    {(ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0,
     0}, /* nr-DL-AoD-ProvideCapabilities-r16 */
    {(ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0,
     0}, /* nr-DL-TDOA-ProvideCapabilities-r16 */
    {(ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0,
     0} /* nr-UL-ProvideCapabilities-r16 */
};
...
asn_TYPE_member_t asn_MBR_ProvideCapabilities_r9_IEs_1[] = {
    ...
    {ATF_POINTER,
     1,
     offsetof(struct ProvideCapabilities_r9_IEs, ext2),
...
static const int asn_MAP_ProvideCapabilities_r9_IEs_oms_1[] = {0, 1, 2, 3,
                                                               4, 5, 6};
