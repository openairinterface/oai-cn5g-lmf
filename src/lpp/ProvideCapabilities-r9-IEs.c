...
asn_TYPE_member_t asn_MBR_ProvideCapabilities_r9_IEs_1[] = {
	{ ATF_POINTER, 6, offsetof(struct ProvideCapabilities_r9_IEs, commonIEsProvideCapabilities),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 5, offsetof(struct ProvideCapabilities_r9_IEs, a_gnss_ProvideCapabilities),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 4, offsetof(struct ProvideCapabilities_r9_IEs, otdoa_ProvideCapabilities),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 3, offsetof(struct ProvideCapabilities_r9_IEs, ecid_ProvideCapabilities),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct ProvideCapabilities_r9_IEs, epdu_ProvideCapabilities),
	...
	{ ATF_POINTER, 1, offsetof(struct ProvideCapabilities_r9_IEs, ext1),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
		&asn_DEF_ext1_8,
		0,
...
static const int asn_MAP_ProvideCapabilities_r9_IEs_oms_1[] = { 0, 1, 2, 3, 4, 5 };
