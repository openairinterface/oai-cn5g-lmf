...
typedef enum NR_UL_SRS_Capability_r16__maxNumberSRS_PosPathLossEstimateAllServingCells_r16 {
  NR_UL_SRS_Capability_r16__maxNumberSRS_PosPathLossEstimateAllServingCells_r16_n1 =
      0,
  NR_UL_SRS_Capability_r16__maxNumberSRS_PosPathLossEstimateAllServingCells_r16_n4 =
      1,
  NR_UL_SRS_Capability_r16__maxNumberSRS_PosPathLossEstimateAllServingCells_r16_n8 =
      2,
  NR_UL_SRS_Capability_r16__maxNumberSRS_PosPathLossEstimateAllServingCells_r16_n16 =
      3
...
typedef enum NR_UL_SRS_Capability_r16__maxNumberSRS_PosSpatialRelationsAllServingCells_r16 {
  NR_UL_SRS_Capability_r16__maxNumberSRS_PosSpatialRelationsAllServingCells_r16_n0 =
      0,
  NR_UL_SRS_Capability_r16__maxNumberSRS_PosSpatialRelationsAllServingCells_r16_n1 =
      1,
  NR_UL_SRS_Capability_r16__maxNumberSRS_PosSpatialRelationsAllServingCells_r16_n2 =
      2,
  NR_UL_SRS_Capability_r16__maxNumberSRS_PosSpatialRelationsAllServingCells_r16_n4 =
      3,
  NR_UL_SRS_Capability_r16__maxNumberSRS_PosSpatialRelationsAllServingCells_r16_n8 =
      4,
  NR_UL_SRS_Capability_r16__maxNumberSRS_PosSpatialRelationsAllServingCells_r16_n16 =
      5
 ...
 * asn_DEF_maxNumberSRS_PosPathLossEstimateAllServingCells_r16_6;	// (Use
 * -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t
 * asn_DEF_maxNumberSRS_PosSpatialRelationsAllServingCells_r16_11;	// (Use
 * -fall-defs-global to expose) */
