...
static asn_oer_constraints_t asn_OER_type_MeasuredResultsList_constr_1
...
asn_TYPE_descriptor_t asn_DEF_MeasuredResultsList = {
    ...
    sizeof(asn_DEF_MeasuredResultsList_tags_1) /
        sizeof(asn_DEF_MeasuredResultsList_tags_1[0]), /* 1 */
    {&asn_OER_type_MeasuredResultsList_constr_1,
     &asn_PER_type_MeasuredResultsList_constr_1, SEQUENCE_OF_constraint},
