...
static asn_oer_constraints_t asn_OER_type_Error_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_member_t asn_MBR_Error_1[] = {
	{ ATF_POINTER, 0, offsetof(struct Error, choice.error_r9),
	...
	{ ATF_POINTER, 0, offsetof(struct Error, choice.criticalExtensionsFuture),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
...
asn_TYPE_descriptor_t asn_DEF_Error = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_Error_constr_1, &asn_PER_type_Error_constr_1, CHOICE_constraint },
	asn_MBR_Error_1,
	2,	/* Elements count */
