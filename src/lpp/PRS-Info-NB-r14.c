...
static asn_oer_constraints_t asn_OER_type_PRS_Info_NB_r14_constr_1
    CC_NOTUSED = {{0, 0}, -1 /* (SIZE(1..5)) */};
...
asn_SET_OF_specifics_t asn_SPC_PRS_Info_NB_r14_specs_1 = {
    sizeof(struct PRS_Info_NB_r14), offsetof(struct PRS_Info_NB_r14, _asn_ctx),
...
asn_TYPE_descriptor_t asn_DEF_PRS_Info_NB_r14 = {
    ...
    sizeof(asn_DEF_PRS_Info_NB_r14_tags_1) /
        sizeof(asn_DEF_PRS_Info_NB_r14_tags_1[0]), /* 1 */
    {&asn_OER_type_PRS_Info_NB_r14_constr_1,
     &asn_PER_type_PRS_Info_NB_r14_constr_1, SEQUENCE_OF_constraint},
