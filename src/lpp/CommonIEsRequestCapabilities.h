...
typedef enum CommonIEsRequestCapabilities__ext1__lpp_message_segmentation_req_r14 {
  CommonIEsRequestCapabilities__ext1__lpp_message_segmentation_req_r14_serverToTarget =
      0,
  CommonIEsRequestCapabilities__ext1__lpp_message_segmentation_req_r14_targetToServer =
      1
