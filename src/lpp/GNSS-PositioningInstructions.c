 ...
 */
static asn_oer_constraints_t asn_OER_type_ha_GNSS_Req_r15_constr_9 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_descriptor_t asn_DEF_ha_GNSS_Req_r15_9 = {
	...
	{ &asn_OER_type_ha_GNSS_Req_r15_constr_9, &asn_PER_type_ha_GNSS_Req_r15_constr_9, NativeEnumerated_constraint },
