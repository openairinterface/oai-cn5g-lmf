...
static int memb_networkID_r15_constraint_1(
...
static asn_oer_constraints_t asn_OER_memb_networkID_r15_constr_2 CC_NOTUSED = {
    {1, 1} /* (0..255) */,
    -1};
...
asn_TYPE_member_t asn_MBR_GNSS_NetworkID_r15_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct GNSS_NetworkID_r15, networkID_r15),
     (ASN_TAG_CLASS_CONTEXT | (0 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_networkID_r15_constr_2,
      &asn_PER_memb_networkID_r15_constr_2, memb_networkID_r15_constraint_1},
     0,
     0, /* No default value */
     "networkID-r15"},
};
