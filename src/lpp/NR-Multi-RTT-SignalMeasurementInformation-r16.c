...
asn_TYPE_descriptor_t asn_DEF_nr_NTA_Offset_r16_3 = {
	...
	{ 0, &asn_PER_type_nr_NTA_Offset_r16_constr_3, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_NR_Multi_RTT_SignalMeasurementInformation_r16_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct NR_Multi_RTT_SignalMeasurementInformation_r16, nr_NTA_Offset_r16),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const int asn_MAP_NR_Multi_RTT_SignalMeasurementInformation_r16_oms_1[] = { 1 };
