...
static asn_oer_constraints_t asn_OER_type_GNSS_ClockModel_constr_1
    CC_NOTUSED = {{0, 0}, -1};
...
asn_TYPE_member_t asn_MBR_GNSS_ClockModel_1[] = {
    {ATF_POINTER,
     0,
     offsetof(struct GNSS_ClockModel, choice.standardClockModelList),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct GNSS_ClockModel, choice.nav_ClockModel),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct GNSS_ClockModel, choice.cnav_ClockModel),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct GNSS_ClockModel, choice.glonass_ClockModel),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct GNSS_ClockModel, choice.sbas_ClockModel),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct GNSS_ClockModel, choice.bds_ClockModel_r12),
...
asn_TYPE_descriptor_t asn_DEF_GNSS_ClockModel = {
    ...
    0, /* No tags (pointer) */
    0, /* No tags (count) */
    {&asn_OER_type_GNSS_ClockModel_constr_1,
     &asn_PER_type_GNSS_ClockModel_constr_1, CHOICE_constraint},
