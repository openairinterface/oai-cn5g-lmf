...
static asn_oer_constraints_t asn_OER_type_GNSS_OrbitModel_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_member_t asn_MBR_GNSS_OrbitModel_1[] = {
	{ ATF_POINTER, 0, offsetof(struct GNSS_OrbitModel, choice.keplerianSet),
	...
	{ ATF_POINTER, 0, offsetof(struct GNSS_OrbitModel, choice.nav_KeplerianSet),
	...
	{ ATF_POINTER, 0, offsetof(struct GNSS_OrbitModel, choice.cnav_KeplerianSet),
	...
	{ ATF_POINTER, 0, offsetof(struct GNSS_OrbitModel, choice.glonass_ECEF),
	...
	{ ATF_POINTER, 0, offsetof(struct GNSS_OrbitModel, choice.sbas_ECEF),
	...
	{ ATF_POINTER, 0, offsetof(struct GNSS_OrbitModel, choice.bds_KeplerianSet_r12),
...
asn_TYPE_descriptor_t asn_DEF_GNSS_OrbitModel = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_GNSS_OrbitModel_constr_1, &asn_PER_type_GNSS_OrbitModel_constr_1, CHOICE_constraint },
