...
static asn_per_constraints_t asn_PER_type_dl_PRS_ResourcesCapabilityBandList_r16_constr_14 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
...
static asn_per_constraints_t asn_PER_memb_maxNrOfPosLayer_r16_constr_13 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 2,  2,  1,  4 }	/* (1..4) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_dl_PRS_ResourcesCapabilityBandList_r16_constr_14 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 10,  10,  1,  1024 }	/* (SIZE(1..1024)) */,
	0, 0	/* No PER value map */
};
...
asn_TYPE_descriptor_t asn_DEF_maxNrOfTRP_AcrossFreqs_r16_3 = {
	...
	{ 0, &asn_PER_type_maxNrOfTRP_AcrossFreqs_r16_constr_3, NativeEnumerated_constraint },
...
static const ber_tlv_tag_t asn_DEF_dl_PRS_ResourcesCapabilityBandList_r16_tags_14[] = {
	(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_SET_OF_specifics_t asn_SPC_dl_PRS_ResourcesCapabilityBandList_r16_specs_14 = {
...
asn_TYPE_descriptor_t asn_DEF_dl_PRS_ResourcesCapabilityBandList_r16_14 = {
	...
	sizeof(asn_DEF_dl_PRS_ResourcesCapabilityBandList_r16_tags_14)
		/sizeof(asn_DEF_dl_PRS_ResourcesCapabilityBandList_r16_tags_14[0]) - 1, /* 1 */
	asn_DEF_dl_PRS_ResourcesCapabilityBandList_r16_tags_14,	/* Same as above */
	sizeof(asn_DEF_dl_PRS_ResourcesCapabilityBandList_r16_tags_14)
		/sizeof(asn_DEF_dl_PRS_ResourcesCapabilityBandList_r16_tags_14[0]), /* 2 */
	{ 0, &asn_PER_type_dl_PRS_ResourcesCapabilityBandList_r16_constr_14, SEQUENCE_OF_constraint },
	asn_MBR_dl_PRS_ResourcesCapabilityBandList_r16_14,
	1,	/* Single element */
	&asn_SPC_dl_PRS_ResourcesCapabilityBandList_r16_specs_14	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_NR_DL_PRS_ResourcesCapability_r16_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct NR_DL_PRS_ResourcesCapability_r16, maxNrOfDL_PRS_ResourceSetPerTrpPerFrequencyLayer_r16),
		...
		0,
		{ 0, &asn_PER_memb_maxNrOfDL_PRS_ResourceSetPerTrpPerFrequencyLayer_r16_constr_2,  memb_maxNrOfDL_PRS_ResourceSetPerTrpPerFrequencyLayer_r16_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NR_DL_PRS_ResourcesCapability_r16, maxNrOfPosLayer_r16),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_maxNrOfPosLayer_r16_constr_13,  memb_maxNrOfPosLayer_r16_constraint_1 },
		0, 0, /* No default value */
		"maxNrOfPosLayer-r16"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct NR_DL_PRS_ResourcesCapability_r16, dl_PRS_ResourcesCapabilityBandList_r16),
		...
		0,
		{ 0, &asn_PER_memb_dl_PRS_ResourcesCapabilityBandList_r16_constr_14,  memb_dl_PRS_ResourcesCapabilityBandList_r16_constraint_1 },
		0, 0, /* No default value */
		"dl-PRS-ResourcesCapabilityBandList-r16"
		},
