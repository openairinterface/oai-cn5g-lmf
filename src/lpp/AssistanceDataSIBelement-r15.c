...
static int memb_valueTag_r15_constraint_1(
...
static asn_oer_constraints_t asn_OER_memb_valueTag_r15_constr_2 CC_NOTUSED = {
    {1, 1} /* (0..63) */,
    -1};
...
static asn_TYPE_member_t asn_MBR_AssistanceDataSIBelement_r15_1[] = {
    {ATF_POINTER,
     4,
     offsetof(struct AssistanceDataSIBelement_r15, valueTag_r15),
     (ASN_TAG_CLASS_CONTEXT | (0 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_valueTag_r15_constr_2, &asn_PER_memb_valueTag_r15_constr_2,
    ...
    {ATF_POINTER,
     3,
     offsetof(struct AssistanceDataSIBelement_r15, expirationTime_r15),
    ...
    {ATF_POINTER,
     2,
     offsetof(struct AssistanceDataSIBelement_r15, cipheringKeyData_r15),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct AssistanceDataSIBelement_r15, segmentationInfo_r15),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct AssistanceDataSIBelement_r15, assistanceDataElement_r15),
...
static const asn_TYPE_tag2member_t
    asn_MAP_AssistanceDataSIBelement_r15_tag2el_1[] = {
        ...
        {(ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0,
         0}, /* cipheringKeyData-r15 */
        {(ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0,
         0}, /* segmentationInfo-r15 */
        {(ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0,
         0} /* assistanceDataElement-r15 */
};
