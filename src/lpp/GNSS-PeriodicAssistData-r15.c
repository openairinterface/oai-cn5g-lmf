...
static asn_TYPE_member_t asn_MBR_ext1_11[] = {
    {ATF_POINTER,
     4,
     offsetof(
         struct GNSS_PeriodicAssistData_r15__ext1, gnss_SSR_PeriodicURA_r16),
...
static const asn_TYPE_tag2member_t asn_MAP_ext1_tag2el_11[] = {
    {(ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0,
     0}, /* gnss-SSR-PeriodicURA-r16 */
    {(ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0,
     0}, /* gnss-SSR-PeriodicPhaseBias-r16 */
    {(ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0,
     0}, /* gnss-SSR-PeriodicSTEC-Correction-r16 */
    {(ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0,
     0} /* gnss-SSR-PeriodicGriddedCorrection-r16 */
};
...
asn_TYPE_member_t asn_MBR_GNSS_PeriodicAssistData_r15_1[] = {
    {ATF_POINTER,
     9,
     offsetof(
         struct GNSS_PeriodicAssistData_r15, gnss_RTK_PeriodicObservations_r15),
     (ASN_TAG_CLASS_CONTEXT | (0 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_GNSS_PeriodicControlParam_r15,
     0,
    ...
    {ATF_POINTER,
     ...
     offsetof(
         ...
         glo_RTK_PeriodicBiasInformation_r15),
     (ASN_TAG_CLASS_CONTEXT | (1 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_GNSS_PeriodicControlParam_r15,
     0,
    ...
    {ATF_POINTER,
     ...
     offsetof(
         struct GNSS_PeriodicAssistData_r15,
         gnss_RTK_MAC_PeriodicCorrectionDifferences_r15),
     (ASN_TAG_CLASS_CONTEXT | (2 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_GNSS_PeriodicControlParam_r15,
     0,
    ...
    {ATF_POINTER,
     6,
     offsetof(
         struct GNSS_PeriodicAssistData_r15, gnss_RTK_PeriodicResiduals_r15),
     (ASN_TAG_CLASS_CONTEXT | (3 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_GNSS_PeriodicControlParam_r15,
     0,
    ...
    {ATF_POINTER,
     ...
     offsetof(
         struct GNSS_PeriodicAssistData_r15,
         gnss_RTK_FKP_PeriodicGradients_r15),
    ...
    {ATF_POINTER,
     ...
     offsetof(
         struct GNSS_PeriodicAssistData_r15,
         gnss_SSR_PeriodicOrbitCorrections_r15),
    ...
    {ATF_POINTER,
     ...
     offsetof(
         struct GNSS_PeriodicAssistData_r15,
         gnss_SSR_PeriodicClockCorrections_r15),
    ...
    {ATF_POINTER,
     2,
     offsetof(
         struct GNSS_PeriodicAssistData_r15, gnss_SSR_PeriodicCodeBias_r15),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct GNSS_PeriodicAssistData_r15, ext1),
...
static const int asn_MAP_GNSS_PeriodicAssistData_r15_oms_1[] = {0, 1, 2, 3, 4,
                                                                5, 6, 7, 8};
...
static const asn_TYPE_tag2member_t
    asn_MAP_GNSS_PeriodicAssistData_r15_tag2el_1[] = {
        {(ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0,
         0}, /* gnss-RTK-PeriodicObservations-r15 */
        {(ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0,
         0}, /* glo-RTK-PeriodicBiasInformation-r15 */
        {(ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0,
         0}, /* gnss-RTK-MAC-PeriodicCorrectionDifferences-r15 */
        {(ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0,
         0}, /* gnss-RTK-PeriodicResiduals-r15 */
        {(ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0,
         0}, /* gnss-RTK-FKP-PeriodicGradients-r15 */
        {(ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0,
         0}, /* gnss-SSR-PeriodicOrbitCorrections-r15 */
        {(ASN_TAG_CLASS_CONTEXT | (6 << 2)), 6, 0,
         0}, /* gnss-SSR-PeriodicClockCorrections-r15 */
        {(ASN_TAG_CLASS_CONTEXT | (7 << 2)), 7, 0,
         0}, /* gnss-SSR-PeriodicCodeBias-r15 */
