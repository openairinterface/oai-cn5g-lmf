...
static asn_oer_constraints_t asn_OER_memb_latitudeUncertainty_r14_constr_2
...
static asn_oer_constraints_t asn_OER_memb_longitudeUncertainty_r14_constr_4
    CC_NOTUSED = {{0, 0}, 6 /* (SIZE(6..6)) */};
...
static asn_oer_constraints_t asn_OER_memb_altitudeUncertainty_r14_constr_6
    CC_NOTUSED = {{0, 0}, 6 /* (SIZE(6..6)) */};
...
asn_TYPE_member_t asn_MBR_LocationDataLCI_r14_1[] = {
    {ATF_NOFLAGS,
     ...
     &asn_DEF_BIT_STRING,
     0,
     {&asn_OER_memb_latitudeUncertainty_r14_constr_2,
    ...
    {ATF_NOFLAGS,
     ...
     &asn_DEF_BIT_STRING,
     0,
     {&asn_OER_memb_latitude_r14_constr_3, &asn_PER_memb_latitude_r14_constr_3,
    ...
    {ATF_NOFLAGS,
     ...
     &asn_DEF_BIT_STRING,
     0,
     {&asn_OER_memb_longitudeUncertainty_r14_constr_4,
    ...
    {ATF_NOFLAGS,
     ...
     &asn_DEF_BIT_STRING,
     0,
     {&asn_OER_memb_longitude_r14_constr_5,
      &asn_PER_memb_longitude_r14_constr_5, memb_longitude_r14_constraint_1},
     0,
     0, /* No default value */
     "longitude-r14"},
    {ATF_POINTER,
     ...
     &asn_DEF_BIT_STRING,
     0,
     {&asn_OER_memb_altitudeUncertainty_r14_constr_6,
    ...
    {ATF_POINTER,
     ...
     &asn_DEF_BIT_STRING,
     0,
     {&asn_OER_memb_altitude_r14_constr_7, &asn_PER_memb_altitude_r14_constr_7,
    ...
    {ATF_NOFLAGS,
     ...
     &asn_DEF_BIT_STRING,
     0,
     {&asn_OER_memb_datum_r14_constr_8, &asn_PER_memb_datum_r14_constr_8,
