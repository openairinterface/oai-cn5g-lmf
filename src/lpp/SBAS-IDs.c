...
static int memb_sbas_IDs_constraint_1(
...
static asn_oer_constraints_t asn_OER_memb_sbas_IDs_constr_2 CC_NOTUSED = {
    {0, 0},
    -1 /* (SIZE(1..8)) */};
...
asn_TYPE_member_t asn_MBR_SBAS_IDs_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct SBAS_IDs, sbas_IDs),
     (ASN_TAG_CLASS_CONTEXT | (0 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_BIT_STRING,
     0,
     {&asn_OER_memb_sbas_IDs_constr_2, &asn_PER_memb_sbas_IDs_constr_2,
