...
static asn_TYPE_member_t asn_MBR_ext1_4[] = {
    {ATF_POINTER,
     1,
     offsetof(
         struct CommonIEsRequestAssistanceData__ext1, segmentationInfo_r14),
...
static asn_TYPE_member_t asn_MBR_ext2_6[] = {
    ...
    {ATF_POINTER,
     1,
     offsetof(struct CommonIEsRequestAssistanceData__ext2, primaryCellID_r15),
...
static const asn_TYPE_tag2member_t asn_MAP_ext2_tag2el_6[] = {
    {(ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0,
     0}, /* periodicAssistanceDataReq-r15 */
...
asn_TYPE_member_t asn_MBR_CommonIEsRequestAssistanceData_1[] = {
    {ATF_POINTER,
     3,
     offsetof(struct CommonIEsRequestAssistanceData, primaryCellID),
     (ASN_TAG_CLASS_CONTEXT | (0 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_ECGI,
     0,
    ...
    {ATF_POINTER,
     2,
     offsetof(struct CommonIEsRequestAssistanceData, ext1),
     (ASN_TAG_CLASS_CONTEXT | (1 << 2)),
     0,
     &asn_DEF_ext1_4,
     0,
    ...
    {ATF_POINTER,
     1,
     offsetof(struct CommonIEsRequestAssistanceData, ext2),
