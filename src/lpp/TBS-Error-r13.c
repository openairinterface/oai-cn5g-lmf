...
static asn_oer_constraints_t asn_OER_type_TBS_Error_r13_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_member_t asn_MBR_TBS_Error_r13_1[] = {
	{ ATF_POINTER, 0, offsetof(struct TBS_Error_r13, choice.locationServerErrorCauses_r13),
	...
	{ ATF_POINTER, 0, offsetof(struct TBS_Error_r13, choice.targetDeviceErrorCauses_r13),
...
asn_TYPE_descriptor_t asn_DEF_TBS_Error_r13 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_TBS_Error_r13_constr_1, &asn_PER_type_TBS_Error_r13_constr_1, CHOICE_constraint },
