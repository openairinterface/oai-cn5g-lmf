...
typedef enum NR_DL_TDOA_LocationServerErrorCauses_r16__cause_r16 {
  ...
  NR_DL_TDOA_LocationServerErrorCauses_r16__cause_r16_assistanceDataNotSupportedByServer =
      1,
  NR_DL_TDOA_LocationServerErrorCauses_r16__cause_r16_assistanceDataSupportedButCurrentlyNotAvailableByServer =
      2,
  NR_DL_TDOA_LocationServerErrorCauses_r16__cause_r16_notProvidedAssistanceDataNotSupportedByServer =
      3
  /*
...
extern asn_SEQUENCE_specifics_t
    asn_SPC_NR_DL_TDOA_LocationServerErrorCauses_r16_specs_1;
