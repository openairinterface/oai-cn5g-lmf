...
static asn_oer_constraints_t asn_OER_memb_delta_radial_r15_constr_4 CC_NOTUSED = {
	{ 4, 0 }	/* (-2097152..2097151) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_delta_AlongTrack_r15_constr_5 CC_NOTUSED = {
	{ 4, 0 }	/* (-524288..524287) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_delta_CrossTrack_r15_constr_6 CC_NOTUSED = {
	{ 4, 0 }	/* (-524288..524287) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_dot_delta_radial_r15_constr_7 CC_NOTUSED = {
	{ 4, 0 }	/* (-1048576..1048575) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_dot_delta_AlongTrack_r15_constr_8 CC_NOTUSED = {
	{ 4, 0 }	/* (-262144..262143) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_dot_delta_CrossTrack_r15_constr_9 CC_NOTUSED = {
	{ 4, 0 }	/* (-262144..262143) */,
	-1};
...
asn_TYPE_member_t asn_MBR_SSR_OrbitCorrectionSatelliteElement_r15_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SSR_OrbitCorrectionSatelliteElement_r15, iod_r15),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_iod_r15_constr_3, &asn_PER_memb_iod_r15_constr_3,  memb_iod_r15_constraint_1 },
		0, 0, /* No default value */
		"iod-r15"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct SSR_OrbitCorrectionSatelliteElement_r15, delta_radial_r15),
		...
		0,
		{ &asn_OER_memb_delta_radial_r15_constr_4, &asn_PER_memb_delta_radial_r15_constr_4,  memb_delta_radial_r15_constraint_1 },
		0, 0, /* No default value */
		"delta-radial-r15"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct SSR_OrbitCorrectionSatelliteElement_r15, delta_AlongTrack_r15),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_delta_AlongTrack_r15_constr_5, &asn_PER_memb_delta_AlongTrack_r15_constr_5,  memb_delta_AlongTrack_r15_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SSR_OrbitCorrectionSatelliteElement_r15, delta_CrossTrack_r15),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_delta_CrossTrack_r15_constr_6, &asn_PER_memb_delta_CrossTrack_r15_constr_6,  memb_delta_CrossTrack_r15_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 3, offsetof(struct SSR_OrbitCorrectionSatelliteElement_r15, dot_delta_radial_r15),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_dot_delta_radial_r15_constr_7, &asn_PER_memb_dot_delta_radial_r15_constr_7,  memb_dot_delta_radial_r15_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 2, offsetof(struct SSR_OrbitCorrectionSatelliteElement_r15, dot_delta_AlongTrack_r15),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_dot_delta_AlongTrack_r15_constr_8, &asn_PER_memb_dot_delta_AlongTrack_r15_constr_8,  memb_dot_delta_AlongTrack_r15_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 1, offsetof(struct SSR_OrbitCorrectionSatelliteElement_r15, dot_delta_CrossTrack_r15),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_dot_delta_CrossTrack_r15_constr_9, &asn_PER_memb_dot_delta_CrossTrack_r15_constr_9,  memb_dot_delta_CrossTrack_r15_constraint_1 },
		0, 0, /* No default value */
