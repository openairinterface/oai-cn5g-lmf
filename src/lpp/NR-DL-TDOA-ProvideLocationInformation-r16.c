...
static const int asn_MAP_NR_DL_TDOA_ProvideLocationInformation_r16_oms_1[] = {
    0, 1, 2};
...
static const asn_TYPE_tag2member_t
    asn_MAP_NR_DL_TDOA_ProvideLocationInformation_r16_tag2el_1[] = {
        {(ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0,
         0}, /* nr-DL-TDOA-SignalMeasurementInformation-r16 */
        {(ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0,
         0}, /* nr-dl-tdoa-LocationInformation-r16 */
        {(ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0} /* nr-DL-TDOA-Error-r16 */
};
asn_SEQUENCE_specifics_t
    asn_SPC_NR_DL_TDOA_ProvideLocationInformation_r16_specs_1 = {
        ...
        asn_MAP_NR_DL_TDOA_ProvideLocationInformation_r16_oms_1, /* Optional
                                                                    members */
        3,
        0, /* Root/Additions */
...
asn_TYPE_descriptor_t asn_DEF_NR_DL_TDOA_ProvideLocationInformation_r16 = {
    ...
    sizeof(asn_DEF_NR_DL_TDOA_ProvideLocationInformation_r16_tags_1) /
        sizeof(
            asn_DEF_NR_DL_TDOA_ProvideLocationInformation_r16_tags_1[0]), /* 1
                                                                           */
    ...
    3, /* Elements count */
    &asn_SPC_NR_DL_TDOA_ProvideLocationInformation_r16_specs_1 /* Additional
                                                                  specs */
};
