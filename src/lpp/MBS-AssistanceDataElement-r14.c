...
asn_TYPE_member_t asn_MBR_MBS_AssistanceDataElement_r14_1[] = {
    {ATF_POINTER,
     2,
     offsetof(struct MBS_AssistanceDataElement_r14, mbs_AlmanacAssistance_r14),
    ...
    {ATF_POINTER,
     1,
     offsetof(
         struct MBS_AssistanceDataElement_r14, mbs_AcquisitionAssistance_r14),
...
static const asn_TYPE_tag2member_t
    asn_MAP_MBS_AssistanceDataElement_r14_tag2el_1[] = {
        {(ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0,
         0}, /* mbs-AlmanacAssistance-r14 */
        {(ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0,
         0} /* mbs-AcquisitionAssistance-r14 */
};
