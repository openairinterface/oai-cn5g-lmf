...
static asn_oer_constraints_t asn_OER_memb_validityAreaWidth_v1520_constr_3 CC_NOTUSED = {
	{ 1, 1 }	/* (1..128) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_validityAreaHeight_v1520_constr_4 CC_NOTUSED = {
	{ 1, 1 }	/* (1..128) */,
	-1};
...
asn_TYPE_member_t asn_MBR_PressureValidityArea_v1520_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PressureValidityArea_v1520, validityAreaWidth_v1520),
		...
		0,
		{ &asn_OER_memb_validityAreaWidth_v1520_constr_3, &asn_PER_memb_validityAreaWidth_v1520_constr_3,  memb_validityAreaWidth_v1520_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PressureValidityArea_v1520, validityAreaHeight_v1520),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_validityAreaHeight_v1520_constr_4, &asn_PER_memb_validityAreaHeight_v1520_constr_4,  memb_validityAreaHeight_v1520_constraint_1 },
		0, 0, /* No default value */
