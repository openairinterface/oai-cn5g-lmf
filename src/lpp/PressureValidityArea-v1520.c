...
static int memb_validityAreaWidth_v1520_constraint_1(
...
static int memb_validityAreaHeight_v1520_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  long value;
...
static asn_oer_constraints_t asn_OER_memb_validityAreaWidth_v1520_constr_3
    CC_NOTUSED = {{1, 1} /* (1..128) */, -1};
static asn_per_constraints_t asn_PER_memb_validityAreaWidth_v1520_constr_3
    CC_NOTUSED = {
...
static asn_oer_constraints_t asn_OER_memb_validityAreaHeight_v1520_constr_4
    CC_NOTUSED = {{1, 1} /* (1..128) */, -1};
static asn_per_constraints_t asn_PER_memb_validityAreaHeight_v1520_constr_4
    CC_NOTUSED = {
        {APC_CONSTRAINED, 7, 7, 1, 128} /* (1..128) */,
        {APC_UNCONSTRAINED, -1, -1, 0, 0},
        0,
...
asn_TYPE_member_t asn_MBR_PressureValidityArea_v1520_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct PressureValidityArea_v1520, centerPoint_v1520),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct PressureValidityArea_v1520, validityAreaWidth_v1520),
     (ASN_TAG_CLASS_CONTEXT | (1 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_validityAreaWidth_v1520_constr_3,
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct PressureValidityArea_v1520, validityAreaHeight_v1520),
     (ASN_TAG_CLASS_CONTEXT | (2 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_validityAreaHeight_v1520_constr_4,
...
static const asn_TYPE_tag2member_t
    asn_MAP_PressureValidityArea_v1520_tag2el_1[] = {
        ...
        {(ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0,
         0}, /* validityAreaWidth-v1520 */
        {(ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0,
         0} /* validityAreaHeight-v1520 */
};
