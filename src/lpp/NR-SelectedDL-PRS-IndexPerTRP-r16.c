...
static int memb_nr_SelectedTRP_Index_r16_constraint_1(
...
static int memb_dl_SelectedPRS_ResourceSetIndexList_r16_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  size_t size;
...
static asn_per_constraints_t
    asn_PER_type_dl_SelectedPRS_ResourceSetIndexList_r16_constr_3 CC_NOTUSED = {
        {APC_UNCONSTRAINED, -1, -1, 0, 0},
        {APC_CONSTRAINED, 1, 1, 1, 2} /* (SIZE(1..2)) */,
        0,
        0 /* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_nr_SelectedTRP_Index_r16_constr_2
    CC_NOTUSED = {
...
static asn_per_constraints_t
    asn_PER_memb_dl_SelectedPRS_ResourceSetIndexList_r16_constr_3 CC_NOTUSED = {
        {APC_UNCONSTRAINED, -1, -1, 0, 0},
        {APC_CONSTRAINED, 1, 1, 1, 2} /* (SIZE(1..2)) */,
        0,
        0 /* No PER value map */
...
static asn_SET_OF_specifics_t
    asn_SPC_dl_SelectedPRS_ResourceSetIndexList_r16_specs_3 = {
        sizeof(
            struct
            NR_SelectedDL_PRS_IndexPerTRP_r16__dl_SelectedPRS_ResourceSetIndexList_r16),
        offsetof(
            struct
            NR_SelectedDL_PRS_IndexPerTRP_r16__dl_SelectedPRS_ResourceSetIndexList_r16,
            _asn_ctx),
...
static /* Use -fall-defs-global to expose */
    asn_TYPE_descriptor_t asn_DEF_dl_SelectedPRS_ResourceSetIndexList_r16_3 = {
        ...
        sizeof(asn_DEF_dl_SelectedPRS_ResourceSetIndexList_r16_tags_3) /
                sizeof(
                    asn_DEF_dl_SelectedPRS_ResourceSetIndexList_r16_tags_3[0]) -
            1,                                                  /* 1 */
        ...
        sizeof(asn_DEF_dl_SelectedPRS_ResourceSetIndexList_r16_tags_3) /
            sizeof(asn_DEF_dl_SelectedPRS_ResourceSetIndexList_r16_tags_3
                       [0]), /* 2 */
        {0, &asn_PER_type_dl_SelectedPRS_ResourceSetIndexList_r16_constr_3,
         SEQUENCE_OF_constraint},
        asn_MBR_dl_SelectedPRS_ResourceSetIndexList_r16_3,
        1, /* Single element */
        &asn_SPC_dl_SelectedPRS_ResourceSetIndexList_r16_specs_3 /* Additional
                                                                    specs */
};
...
asn_TYPE_member_t asn_MBR_NR_SelectedDL_PRS_IndexPerTRP_r16_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(
         struct NR_SelectedDL_PRS_IndexPerTRP_r16, nr_SelectedTRP_Index_r16),
     (ASN_TAG_CLASS_CONTEXT | (0 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {0, &asn_PER_memb_nr_SelectedTRP_Index_r16_constr_2,
    ...
    {ATF_POINTER,
     ...
     0,
     {0, &asn_PER_memb_dl_SelectedPRS_ResourceSetIndexList_r16_constr_3,
...
static const asn_TYPE_tag2member_t
    asn_MAP_NR_SelectedDL_PRS_IndexPerTRP_r16_tag2el_1[] = {
        {(ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0,
         0}, /* nr-SelectedTRP-Index-r16 */
        {(ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0,
         0} /* dl-SelectedPRS-ResourceSetIndexList-r16 */
};
