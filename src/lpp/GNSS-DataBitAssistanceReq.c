...
static asn_oer_constraints_t asn_OER_memb_gnss_TOD_FracReq_constr_3 CC_NOTUSED = {
	{ 2, 1 }	/* (0..999) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_dataBitInterval_constr_4 CC_NOTUSED = {
	{ 1, 1 }	/* (0..15) */,
	-1};
...
asn_TYPE_member_t asn_MBR_GNSS_DataBitAssistanceReq_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct GNSS_DataBitAssistanceReq, gnss_TOD_Req),
		...
		0,
		{ &asn_OER_memb_gnss_TOD_Req_constr_2, &asn_PER_memb_gnss_TOD_Req_constr_2,  memb_gnss_TOD_Req_constraint_1 },
	...
	{ ATF_POINTER, 1, offsetof(struct GNSS_DataBitAssistanceReq, gnss_TOD_FracReq),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_gnss_TOD_FracReq_constr_3, &asn_PER_memb_gnss_TOD_FracReq_constr_3,  memb_gnss_TOD_FracReq_constraint_1 },
		0, 0, /* No default value */
		"gnss-TOD-FracReq"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct GNSS_DataBitAssistanceReq, dataBitInterval),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_dataBitInterval_constr_4, &asn_PER_memb_dataBitInterval_constr_4,  memb_dataBitInterval_constraint_1 },
		0, 0, /* No default value */
		"dataBitInterval"
		},
