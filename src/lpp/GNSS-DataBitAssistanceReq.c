...
static int memb_gnss_TOD_Req_constraint_1(
...
static int memb_gnss_TOD_FracReq_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  long value;
...
static int memb_dataBitInterval_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  long value;
...
static asn_oer_constraints_t asn_OER_memb_gnss_TOD_Req_constr_2 CC_NOTUSED = {
    {2, 1} /* (0..3599) */,
    -1};
...
static asn_oer_constraints_t asn_OER_memb_gnss_TOD_FracReq_constr_3
...
static asn_oer_constraints_t asn_OER_memb_dataBitInterval_constr_4
...
asn_TYPE_member_t asn_MBR_GNSS_DataBitAssistanceReq_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct GNSS_DataBitAssistanceReq, gnss_TOD_Req),
     (ASN_TAG_CLASS_CONTEXT | (0 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_gnss_TOD_Req_constr_2, &asn_PER_memb_gnss_TOD_Req_constr_2,
    ...
    {ATF_POINTER,
     1,
     offsetof(struct GNSS_DataBitAssistanceReq, gnss_TOD_FracReq),
     (ASN_TAG_CLASS_CONTEXT | (1 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_gnss_TOD_FracReq_constr_3,
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct GNSS_DataBitAssistanceReq, dataBitInterval),
     (ASN_TAG_CLASS_CONTEXT | (2 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_dataBitInterval_constr_4,
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct GNSS_DataBitAssistanceReq, gnss_SignalType),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct GNSS_DataBitAssistanceReq, gnss_DataBitsReq),
