...
static asn_oer_constraints_t asn_OER_memb_measurementSFN_r15_constr_5 CC_NOTUSED = {
	{ 2, 0 }	/* (-8192..9214) */,
	-1};
...
static asn_oer_constraints_t asn_OER_type_DisplacementTimeStamp_r15_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_member_t asn_MBR_DisplacementTimeStamp_r15_1[] = {
	{ ATF_POINTER, 0, offsetof(struct DisplacementTimeStamp_r15, choice.utcTime_r15),
	...
	{ ATF_POINTER, 0, offsetof(struct DisplacementTimeStamp_r15, choice.gnssTime_r15),
	...
	{ ATF_POINTER, 0, offsetof(struct DisplacementTimeStamp_r15, choice.systemFrameNumber_r15),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct DisplacementTimeStamp_r15, choice.measurementSFN_r15),
		...
		0,
		{ &asn_OER_memb_measurementSFN_r15_constr_5, &asn_PER_memb_measurementSFN_r15_constr_5,  memb_measurementSFN_r15_constraint_1 },
		0, 0, /* No default value */
		"measurementSFN-r15"
		},
};
...
asn_TYPE_descriptor_t asn_DEF_DisplacementTimeStamp_r15 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_DisplacementTimeStamp_r15_constr_1, &asn_PER_type_DisplacementTimeStamp_r15_constr_1, CHOICE_constraint },
