...
typedef enum NR_ECID_RequestLocationInformation_r16__requestedMeasurements_r16 {
  NR_ECID_RequestLocationInformation_r16__requestedMeasurements_r16_ssrsrpReq =
      0,
  NR_ECID_RequestLocationInformation_r16__requestedMeasurements_r16_ssrsrqReq =
      1,
  NR_ECID_RequestLocationInformation_r16__requestedMeasurements_r16_csirsrpReq =
      2,
  NR_ECID_RequestLocationInformation_r16__requestedMeasurements_r16_csirsrqReq =
      3
...
extern asn_SEQUENCE_specifics_t
    asn_SPC_NR_ECID_RequestLocationInformation_r16_specs_1;
