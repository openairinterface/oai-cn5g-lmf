...
static asn_oer_constraints_t asn_OER_memb_confidence_r10_constr_5 CC_NOTUSED = {
	{ 1, 1 }	/* (0..100) */,
	-1};
...
asn_TYPE_member_t asn_MBR_GNSS_AcquisitionAssistance_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct GNSS_AcquisitionAssistance, confidence_r10),
		...
		0,
		{ &asn_OER_memb_confidence_r10_constr_5, &asn_PER_memb_confidence_r10_constr_5,  memb_confidence_r10_constraint_1 },
		0, 0, /* No default value */
		"confidence-r10"
		},
};
