...
asn_TYPE_member_t asn_MBR_NR_Multi_RTT_MeasElement_r16_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct NR_Multi_RTT_MeasElement_r16, nr_DL_PRS_RSRP_Result_r16),
	...
	{ ATF_POINTER, 1, offsetof(struct NR_Multi_RTT_MeasElement_r16, nr_Multi_RTT_AdditionalMeasurements_r16),
...
static const int asn_MAP_NR_Multi_RTT_MeasElement_r16_oms_1[] = { 1, 2, 3, 4, 5, 7, 10, 11 };
