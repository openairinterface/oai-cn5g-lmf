...
static asn_oer_constraints_t asn_OER_memb_referenceStationID_r15_constr_2 CC_NOTUSED = {
	{ 2, 1 }	/* (0..65535) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_providerName_r15_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..32)) */};
...
asn_TYPE_member_t asn_MBR_GNSS_ReferenceStationID_r15_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct GNSS_ReferenceStationID_r15, referenceStationID_r15),
		...
		0,
		{ &asn_OER_memb_referenceStationID_r15_constr_2, &asn_PER_memb_referenceStationID_r15_constr_2,  memb_referenceStationID_r15_constraint_1 },
	...
	{ ATF_POINTER, 1, offsetof(struct GNSS_ReferenceStationID_r15, providerName_r15),
		...
		0,
		{ &asn_OER_memb_providerName_r15_constr_3, &asn_PER_memb_providerName_r15_constr_3,  memb_providerName_r15_constraint_1 },
		0, 0, /* No default value */
		"providerName-r15"
		},
};
