...
static int memb_referenceStationID_r15_constraint_1(
...
static int memb_providerName_r15_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  const VisibleString_t* st = (const VisibleString_t*) sptr;
  size_t size;
  ...
  if ((size >= 1 && size <= 32) && !check_permitted_alphabet_3(st)) {
    /* Constraint check succeeded */
    return 0;
  } else {
    ASN__CTFAIL(
...
static asn_oer_constraints_t asn_OER_memb_referenceStationID_r15_constr_2
    CC_NOTUSED = {{2, 1} /* (0..65535) */, -1};
static asn_per_constraints_t asn_PER_memb_referenceStationID_r15_constr_2
    CC_NOTUSED = {
...
static asn_oer_constraints_t asn_OER_memb_providerName_r15_constr_3
    CC_NOTUSED = {{0, 0}, -1 /* (SIZE(1..32)) */};
static asn_per_constraints_t asn_PER_memb_providerName_r15_constr_3
    CC_NOTUSED = {
...
asn_TYPE_member_t asn_MBR_GNSS_ReferenceStationID_r15_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct GNSS_ReferenceStationID_r15, referenceStationID_r15),
     (ASN_TAG_CLASS_CONTEXT | (0 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_referenceStationID_r15_constr_2,
    ...
    {ATF_POINTER,
     1,
     offsetof(struct GNSS_ReferenceStationID_r15, providerName_r15),
     (ASN_TAG_CLASS_CONTEXT | (1 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_VisibleString,
     0,
     {&asn_OER_memb_providerName_r15_constr_3,
