...
static asn_oer_constraints_t asn_OER_memb_adrRMSerror_r15_constr_22 CC_NOTUSED = {
	{ 1, 1 }	/* (0..127) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_delta_codePhase_r15_constr_23 CC_NOTUSED = {
	{ 1, 1 }	/* (0..7) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_carrierQualityInd_constr_10 CC_NOTUSED = {
	{ 1, 1 }	/* (0..3) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_integerCodePhase_constr_12 CC_NOTUSED = {
	{ 1, 1 }	/* (0..127) */,
	-1};
...
asn_TYPE_descriptor_t asn_DEF_mpathDet_4 = {
	...
	{ &asn_OER_type_mpathDet_constr_4, &asn_PER_type_mpathDet_constr_4, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_adrSign_r15_19 = {
	...
	{ &asn_OER_type_adrSign_r15_constr_19, &asn_PER_type_adrSign_r15_constr_19, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
static asn_TYPE_member_t asn_MBR_ext1_17[] = {
	{ ATF_POINTER, 4, offsetof(struct GNSS_SatMeasElement__ext1, adrMSB_r15),
		...
		0,
		{ &asn_OER_memb_adrMSB_r15_constr_18, &asn_PER_memb_adrMSB_r15_constr_18,  memb_adrMSB_r15_constraint_17 },
	...
	{ ATF_POINTER, 2, offsetof(struct GNSS_SatMeasElement__ext1, adrRMSerror_r15),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_adrRMSerror_r15_constr_22, &asn_PER_memb_adrRMSerror_r15_constr_22,  memb_adrRMSerror_r15_constraint_17 },
		0, 0, /* No default value */
		"adrRMSerror-r15"
		},
	{ ATF_POINTER, 1, offsetof(struct GNSS_SatMeasElement__ext1, delta_codePhase_r15),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_delta_codePhase_r15_constr_23, &asn_PER_memb_delta_codePhase_r15_constr_23,  memb_delta_codePhase_r15_constraint_17 },
		0, 0, /* No default value */
		"delta-codePhase-r15"
		},
};
...
asn_TYPE_member_t asn_MBR_GNSS_SatMeasElement_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct GNSS_SatMeasElement, carrierQualityInd),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_carrierQualityInd_constr_10, &asn_PER_memb_carrierQualityInd_constr_10,  memb_carrierQualityInd_constraint_1 },
		0, 0, /* No default value */
		"carrierQualityInd"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct GNSS_SatMeasElement, codePhase),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_codePhase_constr_11, &asn_PER_memb_codePhase_constr_11,  memb_codePhase_constraint_1 },
		0, 0, /* No default value */
		"codePhase"
		},
	{ ATF_POINTER, 1, offsetof(struct GNSS_SatMeasElement, integerCodePhase),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_integerCodePhase_constr_12, &asn_PER_memb_integerCodePhase_constr_12,  memb_integerCodePhase_constraint_1 },
		0, 0, /* No default value */
		"integerCodePhase"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct GNSS_SatMeasElement, codePhaseRMSError),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_codePhaseRMSError_constr_13, &asn_PER_memb_codePhaseRMSError_constr_13,  memb_codePhaseRMSError_constraint_1 },
		0, 0, /* No default value */
		"codePhaseRMSError"
		},
	{ ATF_POINTER, 3, offsetof(struct GNSS_SatMeasElement, doppler),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_doppler_constr_14, &asn_PER_memb_doppler_constr_14,  memb_doppler_constraint_1 },
		0, 0, /* No default value */
		"doppler"
		},
	{ ATF_POINTER, 2, offsetof(struct GNSS_SatMeasElement, adr),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_adr_constr_15, &asn_PER_memb_adr_constr_15,  memb_adr_constraint_1 },
		0, 0, /* No default value */
		"adr"
		},
