 ...
 * so here we adjust the DEF accordingly.
 */
static int memb_adrMSB_r15_constraint_17(
...
static int memb_adrRMSerror_r15_constraint_17(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  long value;
...
static int memb_delta_codePhase_r15_constraint_17(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  long value;
...
static int memb_cNo_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  long value;
...
static int memb_codePhase_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  long value;
...
static int memb_doppler_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  long value;
...
static int memb_adr_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  long value;
...
static asn_oer_constraints_t asn_OER_type_mpathDet_constr_4 CC_NOTUSED = {
    {0, 0},
    -1};
...
static asn_oer_constraints_t asn_OER_type_adrSign_r15_constr_19 CC_NOTUSED = {
    {0, 0},
    -1};
...
static asn_oer_constraints_t asn_OER_memb_adrMSB_r15_constr_18 CC_NOTUSED = {
    {1, 1} /* (0..15) */,
    -1};
...
static asn_oer_constraints_t asn_OER_memb_adrRMSerror_r15_constr_22
    CC_NOTUSED = {{1, 1} /* (0..127) */, -1};
static asn_per_constraints_t asn_PER_memb_adrRMSerror_r15_constr_22
    CC_NOTUSED = {
...
static asn_oer_constraints_t asn_OER_memb_delta_codePhase_r15_constr_23
    CC_NOTUSED = {{1, 1} /* (0..7) */, -1};
static asn_per_constraints_t asn_PER_memb_delta_codePhase_r15_constr_23
    CC_NOTUSED = {
...
static asn_oer_constraints_t asn_OER_memb_carrierQualityInd_constr_10
    CC_NOTUSED = {{1, 1} /* (0..3) */, -1};
...
static asn_oer_constraints_t asn_OER_memb_codePhase_constr_11 CC_NOTUSED = {
    {4, 1} /* (0..2097151) */,
    -1};
...
static asn_oer_constraints_t asn_OER_memb_integerCodePhase_constr_12
    CC_NOTUSED = {{1, 1} /* (0..127) */, -1};
...
static asn_oer_constraints_t asn_OER_memb_codePhaseRMSError_constr_13
...
static /* Use -fall-defs-global to expose */
    asn_TYPE_descriptor_t asn_DEF_mpathDet_4 = {
        ...
        sizeof(asn_DEF_mpathDet_tags_4) / sizeof(asn_DEF_mpathDet_tags_4[0]) -
            1,                   /* 1 */
        asn_DEF_mpathDet_tags_4, /* Same as above */
        sizeof(asn_DEF_mpathDet_tags_4) /
            sizeof(asn_DEF_mpathDet_tags_4[0]), /* 2 */
        {&asn_OER_type_mpathDet_constr_4, &asn_PER_type_mpathDet_constr_4,
...
static /* Use -fall-defs-global to expose */
    asn_TYPE_descriptor_t asn_DEF_adrSign_r15_19 = {
        ...
        sizeof(asn_DEF_adrSign_r15_tags_19) /
                sizeof(asn_DEF_adrSign_r15_tags_19[0]) -
            1,                       /* 1 */
        asn_DEF_adrSign_r15_tags_19, /* Same as above */
        sizeof(asn_DEF_adrSign_r15_tags_19) /
            sizeof(asn_DEF_adrSign_r15_tags_19[0]), /* 2 */
        {&asn_OER_type_adrSign_r15_constr_19,
         &asn_PER_type_adrSign_r15_constr_19, NativeEnumerated_constraint},
        0,
        0,                            /* Defined elsewhere */
...
static asn_TYPE_member_t asn_MBR_ext1_17[] = {
    {ATF_POINTER,
     4,
     offsetof(struct GNSS_SatMeasElement__ext1, adrMSB_r15),
     (ASN_TAG_CLASS_CONTEXT | (0 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_adrMSB_r15_constr_18, &asn_PER_memb_adrMSB_r15_constr_18,
    ...
    {ATF_POINTER,
     3,
     offsetof(struct GNSS_SatMeasElement__ext1, adrSign_r15),
    ...
    {ATF_POINTER,
     2,
     offsetof(struct GNSS_SatMeasElement__ext1, adrRMSerror_r15),
     (ASN_TAG_CLASS_CONTEXT | (2 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_adrRMSerror_r15_constr_22,
    ...
    {ATF_POINTER,
     1,
     offsetof(struct GNSS_SatMeasElement__ext1, delta_codePhase_r15),
     (ASN_TAG_CLASS_CONTEXT | (3 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_delta_codePhase_r15_constr_23,
...
static /* Use -fall-defs-global to expose */
    asn_TYPE_descriptor_t asn_DEF_ext1_17 = {
        ...
        sizeof(asn_DEF_ext1_tags_17) / sizeof(asn_DEF_ext1_tags_17[0]) -
            1,                /* 1 */
        asn_DEF_ext1_tags_17, /* Same as above */
        sizeof(asn_DEF_ext1_tags_17) / sizeof(asn_DEF_ext1_tags_17[0]), /* 2 */
...
asn_TYPE_member_t asn_MBR_GNSS_SatMeasElement_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct GNSS_SatMeasElement, svID),
     (ASN_TAG_CLASS_CONTEXT | (0 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_SV_ID,
     0,
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct GNSS_SatMeasElement, cNo),
     (ASN_TAG_CLASS_CONTEXT | (1 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_cNo_constr_3, &asn_PER_memb_cNo_constr_3,
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct GNSS_SatMeasElement, mpathDet),
     (ASN_TAG_CLASS_CONTEXT | (2 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_mpathDet_4,
     0,
    ...
    {ATF_POINTER,
     1,
     offsetof(struct GNSS_SatMeasElement, carrierQualityInd),
     (ASN_TAG_CLASS_CONTEXT | (3 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_carrierQualityInd_constr_10,
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct GNSS_SatMeasElement, codePhase),
     (ASN_TAG_CLASS_CONTEXT | (4 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_codePhase_constr_11, &asn_PER_memb_codePhase_constr_11,
    ...
    {ATF_POINTER,
     1,
     offsetof(struct GNSS_SatMeasElement, integerCodePhase),
     (ASN_TAG_CLASS_CONTEXT | (5 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_integerCodePhase_constr_12,
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct GNSS_SatMeasElement, codePhaseRMSError),
     (ASN_TAG_CLASS_CONTEXT | (6 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_codePhaseRMSError_constr_13,
    ...
    {ATF_POINTER,
     3,
     offsetof(struct GNSS_SatMeasElement, doppler),
     (ASN_TAG_CLASS_CONTEXT | (7 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_doppler_constr_14, &asn_PER_memb_doppler_constr_14,
    ...
    {ATF_POINTER,
     2,
     offsetof(struct GNSS_SatMeasElement, adr),
     (ASN_TAG_CLASS_CONTEXT | (8 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_adr_constr_15, &asn_PER_memb_adr_constr_15,
    ...
    {ATF_POINTER,
     1,
     offsetof(struct GNSS_SatMeasElement, ext1),
