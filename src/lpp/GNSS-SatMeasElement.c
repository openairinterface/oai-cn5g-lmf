...
static asn_TYPE_member_t asn_MBR_ext1_17[] = {
    ...
    {ATF_POINTER,
     ...
     &asn_DEF_NativeInteger,
     0,
     {0, &asn_PER_memb_adrRMSerror_r15_constr_22,
    ...
    {ATF_POINTER,
     ...
     &asn_DEF_NativeInteger,
     0,
     {0, &asn_PER_memb_delta_codePhase_r15_constr_23,
...
asn_TYPE_member_t asn_MBR_GNSS_SatMeasElement_1[] = {
    ...
    {ATF_POINTER,
     ...
     &asn_DEF_NativeInteger,
     0,
     {0, &asn_PER_memb_carrierQualityInd_constr_10,
    ...
    {ATF_POINTER,
     ...
     &asn_DEF_NativeInteger,
     0,
     {0, &asn_PER_memb_integerCodePhase_constr_12,
    ...
    {ATF_NOFLAGS,
     ...
     &asn_DEF_NativeInteger,
     0,
     {0, &asn_PER_memb_codePhaseRMSError_constr_13,
