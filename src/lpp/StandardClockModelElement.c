...
asn_TYPE_member_t asn_MBR_StandardClockModelElement_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct StandardClockModelElement, stanClockToc),
		...
		0,
		{ &asn_OER_memb_stanClockToc_constr_2, &asn_PER_memb_stanClockToc_constr_2,  memb_stanClockToc_constraint_1 },
	...
	{ ATF_POINTER, 1, offsetof(struct StandardClockModelElement, stanModelID),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_stanModelID_constr_8, &asn_PER_memb_stanModelID_constr_8,  memb_stanModelID_constraint_1 },
		0, 0, /* No default value */
		"stanModelID"
		},
};
