...
static int memb_stanClockToc_constraint_1(
...
static int memb_stanClockAF2_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  long value;
...
static int memb_stanClockAF1_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  long value;
...
static int memb_stanClockAF0_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  long value;
...
static int memb_stanClockTgd_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  long value;
...
static int memb_sisa_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  long value;
...
static int memb_stanModelID_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  long value;
...
static asn_oer_constraints_t asn_OER_memb_stanClockToc_constr_2 CC_NOTUSED = {
    {2, 1} /* (0..16383) */,
    -1};
...
static asn_oer_constraints_t asn_OER_memb_stanClockAF0_constr_5 CC_NOTUSED = {
    {4, 0} /* (-1073741824..1073741823) */,
    -1};
static asn_per_constraints_t asn_PER_memb_stanClockAF0_constr_5 CC_NOTUSED = {
    {APC_CONSTRAINED, 31, -1, -1073741824,
     1073741823} /* (-1073741824..1073741823) */,
    {APC_UNCONSTRAINED, -1, -1, 0, 0},
    0,
    0 /* No PER value map */
};
...
static asn_oer_constraints_t asn_OER_memb_stanModelID_constr_8 CC_NOTUSED = {
    {1, 1} /* (0..1) */,
    -1};
...
asn_TYPE_member_t asn_MBR_StandardClockModelElement_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct StandardClockModelElement, stanClockToc),
     (ASN_TAG_CLASS_CONTEXT | (0 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_stanClockToc_constr_2, &asn_PER_memb_stanClockToc_constr_2,
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct StandardClockModelElement, stanClockAF2),
     (ASN_TAG_CLASS_CONTEXT | (1 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_stanClockAF2_constr_3, &asn_PER_memb_stanClockAF2_constr_3,
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct StandardClockModelElement, stanClockAF1),
     (ASN_TAG_CLASS_CONTEXT | (2 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_stanClockAF1_constr_4, &asn_PER_memb_stanClockAF1_constr_4,
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct StandardClockModelElement, stanClockAF0),
     (ASN_TAG_CLASS_CONTEXT | (3 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_stanClockAF0_constr_5, &asn_PER_memb_stanClockAF0_constr_5,
    ...
    {ATF_POINTER,
     1,
     offsetof(struct StandardClockModelElement, stanClockTgd),
     (ASN_TAG_CLASS_CONTEXT | (4 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_stanClockTgd_constr_6, &asn_PER_memb_stanClockTgd_constr_6,
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct StandardClockModelElement, sisa),
     (ASN_TAG_CLASS_CONTEXT | (5 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_sisa_constr_7, &asn_PER_memb_sisa_constr_7,
    ...
    {ATF_POINTER,
     1,
     offsetof(struct StandardClockModelElement, stanModelID),
     (ASN_TAG_CLASS_CONTEXT | (6 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_stanModelID_constr_8, &asn_PER_memb_stanModelID_constr_8,
