...
int ARFCN_ValueEUTRA_constraint(
 ...
 */
static asn_oer_constraints_t asn_OER_type_ARFCN_ValueEUTRA_constr_1
...
asn_TYPE_descriptor_t asn_DEF_ARFCN_ValueEUTRA = {
    ...
    sizeof(asn_DEF_ARFCN_ValueEUTRA_tags_1) /
        sizeof(asn_DEF_ARFCN_ValueEUTRA_tags_1[0]), /* 1 */
    {&asn_OER_type_ARFCN_ValueEUTRA_constr_1,
     &asn_PER_type_ARFCN_ValueEUTRA_constr_1, ARFCN_ValueEUTRA_constraint},
    0,
    0, /* No members */
    0  /* No specifics */
};
