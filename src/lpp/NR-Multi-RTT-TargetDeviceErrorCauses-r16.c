...
asn_TYPE_member_t asn_MBR_NR_Multi_RTT_TargetDeviceErrorCauses_r16_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct NR_Multi_RTT_TargetDeviceErrorCauses_r16, cause_r16),
...
asn_TYPE_descriptor_t asn_DEF_NR_Multi_RTT_TargetDeviceErrorCauses_r16 = {
    ...
    sizeof(asn_DEF_NR_Multi_RTT_TargetDeviceErrorCauses_r16_tags_1) /
        sizeof(
            asn_DEF_NR_Multi_RTT_TargetDeviceErrorCauses_r16_tags_1[0]), /* 1 */
    ...
    1, /* Elements count */
    &asn_SPC_NR_Multi_RTT_TargetDeviceErrorCauses_r16_specs_1 /* Additional
                                                                 specs */
};
