...
static asn_oer_constraints_t asn_OER_memb_physical_ARP_ECEF_X_r15_constr_3
    CC_NOTUSED = {{8, 0} /* (-137438953472..137438953471) */, -1};
...
static asn_oer_constraints_t asn_OER_memb_physical_ARP_ECEF_Y_r15_constr_4
    CC_NOTUSED = {{8, 0} /* (-137438953472..137438953471) */, -1};
...
static asn_oer_constraints_t asn_OER_memb_physical_ARP_ECEF_Z_r15_constr_5
    CC_NOTUSED = {{8, 0} /* (-137438953472..137438953471) */, -1};
...
asn_TYPE_member_t asn_MBR_PhysicalReferenceStationInfo_r15_1[] = {
    ...
    {ATF_NOFLAGS,
     ...
     &asn_DEF_INTEGER,
     0,
     {&asn_OER_memb_physical_ARP_ECEF_X_r15_constr_3,
    ...
    {ATF_NOFLAGS,
     ...
     &asn_DEF_INTEGER,
     0,
     {&asn_OER_memb_physical_ARP_ECEF_Y_r15_constr_4,
    ...
    {ATF_NOFLAGS,
     ...
     &asn_DEF_INTEGER,
     0,
     {&asn_OER_memb_physical_ARP_ECEF_Z_r15_constr_5,
