...
oer_type_decoder_f Initiator_decode_oer;
oer_type_encoder_f Initiator_encode_oer;
per_type_decoder_f Initiator_decode_uper;
per_type_encoder_f Initiator_encode_uper;
per_type_decoder_f Initiator_decode_aper;
per_type_encoder_f Initiator_encode_aper;
