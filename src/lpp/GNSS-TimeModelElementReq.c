...
static asn_oer_constraints_t asn_OER_memb_gnss_TO_IDsReq_constr_2 CC_NOTUSED = {
	{ 1, 1 }	/* (1..15) */,
	-1};
...
asn_TYPE_member_t asn_MBR_GNSS_TimeModelElementReq_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct GNSS_TimeModelElementReq, gnss_TO_IDsReq),
		...
		0,
		{ &asn_OER_memb_gnss_TO_IDsReq_constr_2, &asn_PER_memb_gnss_TO_IDsReq_constr_2,  memb_gnss_TO_IDsReq_constraint_1 },
