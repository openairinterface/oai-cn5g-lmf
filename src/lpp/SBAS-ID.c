 ...
 */
static asn_oer_constraints_t asn_OER_type_sbas_id_constr_2 CC_NOTUSED = {{0, 0},
                                                                         -1};
...
static /* Use -fall-defs-global to expose */
    asn_TYPE_descriptor_t asn_DEF_sbas_id_2 = {
        ...
        sizeof(asn_DEF_sbas_id_tags_2) / sizeof(asn_DEF_sbas_id_tags_2[0]) -
            1,                  /* 1 */
        asn_DEF_sbas_id_tags_2, /* Same as above */
        sizeof(asn_DEF_sbas_id_tags_2) /
            sizeof(asn_DEF_sbas_id_tags_2[0]), /* 2 */
        {&asn_OER_type_sbas_id_constr_2, &asn_PER_type_sbas_id_constr_2,
...
asn_TYPE_member_t asn_MBR_SBAS_ID_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct SBAS_ID, sbas_id),
...
asn_TYPE_descriptor_t asn_DEF_SBAS_ID = {
    ...
    sizeof(asn_DEF_SBAS_ID_tags_1) / sizeof(asn_DEF_SBAS_ID_tags_1[0]), /* 1 */
