...
asn_TYPE_member_t asn_MBR_CommonIEsRequestLocationInformation_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(
         struct CommonIEsRequestLocationInformation, locationInformationType),
     (ASN_TAG_CLASS_CONTEXT | (0 << 2)),
     -1, /* IMPLICIT tag at current level */
    ...
    {ATF_POINTER,
     9,
     offsetof(struct CommonIEsRequestLocationInformation, triggeredReporting),
    ...
    {ATF_POINTER,
     8,
     offsetof(struct CommonIEsRequestLocationInformation, periodicalReporting),
    ...
    {ATF_POINTER,
     7,
     offsetof(
         struct CommonIEsRequestLocationInformation, additionalInformation),
    ...
    {ATF_POINTER,
     6,
     offsetof(struct CommonIEsRequestLocationInformation, qos),
    ...
    {ATF_POINTER,
     5,
     offsetof(struct CommonIEsRequestLocationInformation, environment),
    ...
    {ATF_POINTER,
     4,
     offsetof(
         struct CommonIEsRequestLocationInformation, locationCoordinateTypes),
    ...
    {ATF_POINTER,
     3,
     offsetof(struct CommonIEsRequestLocationInformation, velocityTypes),
    ...
    {ATF_POINTER,
     2,
     offsetof(struct CommonIEsRequestLocationInformation, ext1),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct CommonIEsRequestLocationInformation, ext2),
...
static const int asn_MAP_CommonIEsRequestLocationInformation_oms_1[] = {
    1, 2, 3, 4, 5, 6, 7, 8, 9};
