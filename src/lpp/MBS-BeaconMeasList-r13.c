...
static asn_oer_constraints_t asn_OER_type_MBS_BeaconMeasList_r13_constr_1
    CC_NOTUSED = {{0, 0}, -1 /* (SIZE(1..64)) */};
asn_per_constraints_t asn_PER_type_MBS_BeaconMeasList_r13_constr_1
    CC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_MBS_BeaconMeasList_r13 = {
    ...
    sizeof(asn_DEF_MBS_BeaconMeasList_r13_tags_1) /
        sizeof(asn_DEF_MBS_BeaconMeasList_r13_tags_1[0]), /* 1 */
    {&asn_OER_type_MBS_BeaconMeasList_r13_constr_1,
     &asn_PER_type_MBS_BeaconMeasList_r13_constr_1, SEQUENCE_OF_constraint},
