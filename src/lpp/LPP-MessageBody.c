...
static asn_oer_constraints_t asn_OER_type_LPP_MessageBody_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_TYPE_member_t asn_MBR_c1_2[] = {
	{ ATF_POINTER, 0, offsetof(struct LPP_MessageBody__c1, choice.requestCapabilities),
	...
	{ ATF_POINTER, 0, offsetof(struct LPP_MessageBody__c1, choice.provideCapabilities),
	...
	{ ATF_POINTER, 0, offsetof(struct LPP_MessageBody__c1, choice.requestAssistanceData),
	...
	{ ATF_POINTER, 0, offsetof(struct LPP_MessageBody__c1, choice.provideAssistanceData),
	...
	{ ATF_POINTER, 0, offsetof(struct LPP_MessageBody__c1, choice.requestLocationInformation),
	...
	{ ATF_POINTER, 0, offsetof(struct LPP_MessageBody__c1, choice.provideLocationInformation),
	...
	{ ATF_POINTER, 0, offsetof(struct LPP_MessageBody__c1, choice.abort),
	...
	{ ATF_POINTER, 0, offsetof(struct LPP_MessageBody__c1, choice.error),
...
asn_TYPE_member_t asn_MBR_LPP_MessageBody_1[] = {
	{ ATF_POINTER, 0, offsetof(struct LPP_MessageBody, choice.c1),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_c1_2,
		0,
	...
	{ ATF_POINTER, 0, offsetof(struct LPP_MessageBody, choice.messageClassExtension),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
...
asn_TYPE_descriptor_t asn_DEF_LPP_MessageBody = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_LPP_MessageBody_constr_1, &asn_PER_type_LPP_MessageBody_constr_1, CHOICE_constraint },
