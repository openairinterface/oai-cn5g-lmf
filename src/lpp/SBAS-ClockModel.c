...
static asn_oer_constraints_t asn_OER_memb_sbasAgfo_constr_3 CC_NOTUSED = {
	{ 2, 0 }	/* (-2048..2047) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_sbasAgf1_constr_4 CC_NOTUSED = {
	{ 1, 0 }	/* (-128..127) */,
	-1};
...
asn_TYPE_member_t asn_MBR_SBAS_ClockModel_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SBAS_ClockModel, sbasAgfo),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_sbasAgfo_constr_3, &asn_PER_memb_sbasAgfo_constr_3,  memb_sbasAgfo_constraint_1 },
		0, 0, /* No default value */
		"sbasAgfo"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct SBAS_ClockModel, sbasAgf1),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_sbasAgf1_constr_4, &asn_PER_memb_sbasAgf1_constr_4,  memb_sbasAgf1_constraint_1 },
		0, 0, /* No default value */
		"sbasAgf1"
		},
};
