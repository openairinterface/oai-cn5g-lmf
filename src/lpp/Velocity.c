...
asn_TYPE_member_t asn_MBR_Velocity_1[] = {
	{ ATF_POINTER, 0, offsetof(struct Velocity, choice.horizontalVelocity),
	...
	{ ATF_POINTER, 0, offsetof(struct Velocity, choice.horizontalWithVerticalVelocity),
	...
	{ ATF_POINTER, 0, offsetof(struct Velocity, choice.horizontalVelocityWithUncertainty),
	...
	{ ATF_POINTER, 0, offsetof(struct Velocity, choice.horizontalWithVerticalVelocityAndUncertainty),
...
asn_TYPE_descriptor_t asn_DEF_Velocity = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_Velocity_constr_1, &asn_PER_type_Velocity_constr_1, CHOICE_constraint },
	asn_MBR_Velocity_1,
	4,	/* Elements count */
