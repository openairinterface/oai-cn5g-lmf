...
asn_TYPE_member_t asn_MBR_UTC_ModelSet4_1[] = {
    {ATF_NOFLAGS,
     ...
     0,
     {&asn_OER_memb_utcA1wnt_constr_2, &asn_PER_memb_utcA1wnt_constr_2,
    ...
    {ATF_NOFLAGS,
     ...
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_utcA0wnt_constr_3, &asn_PER_memb_utcA0wnt_constr_3,
    ...
    {ATF_NOFLAGS,
     ...
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_utcTot_constr_4, &asn_PER_memb_utcTot_constr_4,
    ...
    {ATF_NOFLAGS,
     ...
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_utcWNt_constr_5, &asn_PER_memb_utcWNt_constr_5,
    ...
    {ATF_NOFLAGS,
     ...
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_utcDeltaTls_constr_6, &asn_PER_memb_utcDeltaTls_constr_6,
    ...
    {ATF_NOFLAGS,
     ...
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_utcWNlsf_constr_7, &asn_PER_memb_utcWNlsf_constr_7,
    ...
    {ATF_NOFLAGS,
     ...
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_utcDN_constr_8, &asn_PER_memb_utcDN_constr_8,
    ...
    {ATF_NOFLAGS,
     ...
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_utcDeltaTlsf_constr_9, &asn_PER_memb_utcDeltaTlsf_constr_9,
    ...
    {ATF_NOFLAGS,
     ...
     &asn_DEF_NativeInteger,
     0,
     {&asn_OER_memb_utcStandardID_constr_10,
      &asn_PER_memb_utcStandardID_constr_10, memb_utcStandardID_constraint_1},
     0,
     0, /* No default value */
     "utcStandardID"},
};
