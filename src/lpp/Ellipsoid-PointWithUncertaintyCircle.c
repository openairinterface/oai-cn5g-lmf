...
static asn_oer_constraints_t asn_OER_memb_uncertainty_constr_7 CC_NOTUSED = {
	{ 1, 1 }	/* (0..127) */,
	-1};
...
asn_TYPE_member_t asn_MBR_Ellipsoid_PointWithUncertaintyCircle_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct Ellipsoid_PointWithUncertaintyCircle, uncertainty),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_uncertainty_constr_7, &asn_PER_memb_uncertainty_constr_7,  memb_uncertainty_constraint_1 },
		0, 0, /* No default value */
		"uncertainty"
		},
};
