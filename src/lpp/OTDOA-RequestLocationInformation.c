 ...
 * so here we adjust the DEF accordingly.
 */
static asn_oer_constraints_t asn_OER_type_multipathRSTD_r14_constr_5
    CC_NOTUSED = {{0, 0}, -1};
...
static asn_oer_constraints_t asn_OER_memb_maxNoOfRSTDmeas_r14_constr_7
...
static asn_oer_constraints_t asn_OER_type_motionMeasurements_r15_constr_9
    CC_NOTUSED = {{0, 0}, -1};
...
static /* Use -fall-defs-global to expose */
    asn_TYPE_descriptor_t asn_DEF_multipathRSTD_r14_5 = {
        ...
        {&asn_OER_type_multipathRSTD_r14_constr_5,
         &asn_PER_type_multipathRSTD_r14_constr_5, NativeEnumerated_constraint},
        0,
        0,                                 /* Defined elsewhere */
...
static asn_TYPE_member_t asn_MBR_ext1_4[] = {
    ...
    {ATF_POINTER,
     ...
     0,
     {&asn_OER_memb_maxNoOfRSTDmeas_r14_constr_7,
...
static /* Use -fall-defs-global to expose */
    asn_TYPE_descriptor_t asn_DEF_motionMeasurements_r15_9 = {
        ...
        {&asn_OER_type_motionMeasurements_r15_constr_9,
