 ...
 * so here we adjust the DEF accordingly.
 */
static asn_oer_constraints_t asn_OER_type_multipathRSTD_r14_constr_5 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_maxNoOfRSTDmeas_r14_constr_7 CC_NOTUSED = {
	{ 1, 1 }	/* (1..32) */,
	-1};
...
static asn_oer_constraints_t asn_OER_type_motionMeasurements_r15_constr_9 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_descriptor_t asn_DEF_multipathRSTD_r14_5 = {
	...
	{ &asn_OER_type_multipathRSTD_r14_constr_5, &asn_PER_type_multipathRSTD_r14_constr_5, NativeEnumerated_constraint },
...
static asn_TYPE_member_t asn_MBR_ext1_4[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct OTDOA_RequestLocationInformation__ext1, maxNoOfRSTDmeas_r14),
		...
		0,
		{ &asn_OER_memb_maxNoOfRSTDmeas_r14_constr_7, &asn_PER_memb_maxNoOfRSTDmeas_r14_constr_7,  memb_maxNoOfRSTDmeas_r14_constraint_4 },
		0, 0, /* No default value */
		"maxNoOfRSTDmeas-r14"
		},
};
...
asn_TYPE_descriptor_t asn_DEF_motionMeasurements_r15_9 = {
	...
	{ &asn_OER_type_motionMeasurements_r15_constr_9, &asn_PER_type_motionMeasurements_r15_constr_9, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
