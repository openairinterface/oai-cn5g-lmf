...
asn_TYPE_member_t asn_MBR_GeographicalCoordinates_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct GeographicalCoordinates, tRPPositionDefinitionType),
    ...
    {ATF_POINTER,
     2,
     offsetof(struct GeographicalCoordinates, dLPRSResourceCoordinates),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct GeographicalCoordinates, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (2 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_ProtocolExtensionContainer_2920P17,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
...
static const asn_TYPE_tag2member_t asn_MAP_GeographicalCoordinates_tag2el_1[] =
    {
        {(ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0,
         0}, /* tRPPositionDefinitionType */
        {(ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0,
         0}, /* dLPRSResourceCoordinates */
