...
asn_TYPE_member_t asn_MBR_TRP_MeasurementRequestItem_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct TRP_MeasurementRequestItem, tRP_ID),
    ...
    {ATF_POINTER,
     2,
     offsetof(struct TRP_MeasurementRequestItem, search_window_information),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct TRP_MeasurementRequestItem, iE_extensions),
     (ASN_TAG_CLASS_CONTEXT | (2 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_ProtocolExtensionContainer_2920P101,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
