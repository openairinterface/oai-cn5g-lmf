...
static asn_TYPE_member_t asn_MBR_value_5[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct UnsuccessfulOutcome__value, choice.OTDOAInformationFailure),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct UnsuccessfulOutcome__value, choice.MeasurementFailure),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
...
asn_TYPE_member_t asn_MBR_UnsuccessfulOutcome_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct UnsuccessfulOutcome, nrppatransactionID),
