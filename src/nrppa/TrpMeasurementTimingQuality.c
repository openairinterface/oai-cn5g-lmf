...
asn_TYPE_descriptor_t asn_DEF_resolution_3 = {
	...
	{ &asn_OER_type_resolution_constr_3, &asn_PER_type_resolution_constr_3, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_TrpMeasurementTimingQuality_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct TrpMeasurementTimingQuality, measurementQuality),
		...
		0,
		{ &asn_OER_memb_measurementQuality_constr_2, &asn_PER_memb_measurementQuality_constr_2,  memb_measurementQuality_constraint_1 },
