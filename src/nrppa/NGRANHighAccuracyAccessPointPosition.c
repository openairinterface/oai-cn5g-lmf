...
static int memb_latitude_constraint_1(
...
static int memb_longitude_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  long value;
...
static int memb_altitude_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  long value;
...
static int memb_uncertaintySemi_major_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  long value;
...
static int memb_uncertaintySemi_minor_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  long value;
...
static int memb_orientationOfMajorAxis_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  long value;
...
static int memb_uncertaintyAltitude_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  long value;
...
static asn_per_constraints_t asn_PER_memb_uncertaintySemi_major_constr_5
    CC_NOTUSED = {
...
static asn_per_constraints_t asn_PER_memb_uncertaintySemi_minor_constr_6
    CC_NOTUSED = {
        {APC_CONSTRAINED, 8, 8, 0, 255} /* (0..255) */,
        {APC_UNCONSTRAINED, -1, -1, 0, 0},
        0,
...
static asn_per_constraints_t asn_PER_memb_orientationOfMajorAxis_constr_7
    CC_NOTUSED = {
...
static asn_per_constraints_t asn_PER_memb_horizontalConfidence_constr_8
    CC_NOTUSED = {
...
static asn_per_constraints_t asn_PER_memb_uncertaintyAltitude_constr_9
    CC_NOTUSED = {
        {APC_CONSTRAINED, 8, 8, 0, 255} /* (0..255) */,
        {APC_UNCONSTRAINED, -1, -1, 0, 0},
        0,
...
static asn_per_constraints_t asn_PER_memb_verticalConfidence_constr_10
    CC_NOTUSED = {
        {APC_CONSTRAINED, 7, 7, 0, 100} /* (0..100) */,
        {APC_UNCONSTRAINED, -1, -1, 0, 0},
        0,
...
asn_TYPE_member_t asn_MBR_NGRANHighAccuracyAccessPointPosition_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct NGRANHighAccuracyAccessPointPosition, latitude),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct NGRANHighAccuracyAccessPointPosition, longitude),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct NGRANHighAccuracyAccessPointPosition, altitude),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(
         struct NGRANHighAccuracyAccessPointPosition, uncertaintySemi_major),
     (ASN_TAG_CLASS_CONTEXT | (3 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {0, &asn_PER_memb_uncertaintySemi_major_constr_5,
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(
         struct NGRANHighAccuracyAccessPointPosition, uncertaintySemi_minor),
     (ASN_TAG_CLASS_CONTEXT | (4 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {0, &asn_PER_memb_uncertaintySemi_minor_constr_6,
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(
         struct NGRANHighAccuracyAccessPointPosition, orientationOfMajorAxis),
     (ASN_TAG_CLASS_CONTEXT | (5 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {0, &asn_PER_memb_orientationOfMajorAxis_constr_7,
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(
         struct NGRANHighAccuracyAccessPointPosition, horizontalConfidence),
     (ASN_TAG_CLASS_CONTEXT | (6 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {0, &asn_PER_memb_horizontalConfidence_constr_8,
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct NGRANHighAccuracyAccessPointPosition, uncertaintyAltitude),
     (ASN_TAG_CLASS_CONTEXT | (7 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {0, &asn_PER_memb_uncertaintyAltitude_constr_9,
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct NGRANHighAccuracyAccessPointPosition, verticalConfidence),
     (ASN_TAG_CLASS_CONTEXT | (8 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {0, &asn_PER_memb_verticalConfidence_constr_10,
    ...
    {ATF_POINTER,
     1,
     offsetof(struct NGRANHighAccuracyAccessPointPosition, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (9 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_ProtocolExtensionContainer_2816P23,
     0,
     {0, 0, 0},
     0,
     0, /* No default value */
...
static const asn_TYPE_tag2member_t
    asn_MAP_NGRANHighAccuracyAccessPointPosition_tag2el_1[] = {
        ...
        {(ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0,
         0}, /* uncertaintySemi-major */
        {(ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0,
         0}, /* uncertaintySemi-minor */
        {(ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0,
         0}, /* orientationOfMajorAxis */
        {(ASN_TAG_CLASS_CONTEXT | (6 << 2)), 6, 0,
         0}, /* horizontalConfidence */
