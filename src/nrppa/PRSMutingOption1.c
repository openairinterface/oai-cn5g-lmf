...
static asn_per_constraints_t asn_PER_type_mutingBitRepetitionFactor_constr_3
    CC_NOTUSED = {
...
static const asn_INTEGER_enum_map_t
    asn_MAP_mutingBitRepetitionFactor_value2enum_3[] = {
        {0, 2, "n1"},
        {1, 2, "n2"},
        {2, 2, "n4"},
        {3, 2, "n8"}
...
static const asn_INTEGER_specifics_t asn_SPC_mutingBitRepetitionFactor_specs_3 =
    {asn_MAP_mutingBitRepetitionFactor_value2enum_3, /* "tag" => N; sorted by
                                                        tag */
...
static /* Use -fall-defs-global to expose */
    asn_TYPE_descriptor_t asn_DEF_mutingBitRepetitionFactor_3 = {
        ...
        sizeof(asn_DEF_mutingBitRepetitionFactor_tags_3) /
                sizeof(asn_DEF_mutingBitRepetitionFactor_tags_3[0]) -
            1,                                    /* 1 */
...
asn_TYPE_member_t asn_MBR_PRSMutingOption1_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct PRSMutingOption1, mutingPattern),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct PRSMutingOption1, mutingBitRepetitionFactor),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct PRSMutingOption1, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (2 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_ProtocolExtensionContainer_2920P44,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
