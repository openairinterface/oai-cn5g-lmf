...
asn_TYPE_member_t asn_MBR_RelativePathDelay_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct RelativePathDelay, choice.k0),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct RelativePathDelay, choice.k1),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct RelativePathDelay, choice.k2),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct RelativePathDelay, choice.k3),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct RelativePathDelay, choice.k4),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct RelativePathDelay, choice.k5),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct RelativePathDelay, choice.choice_Extension),
     (ASN_TAG_CLASS_CONTEXT | (6 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_ProtocolIE_Single_Container_2907P21,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
