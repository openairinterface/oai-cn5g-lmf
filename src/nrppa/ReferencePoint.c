...
asn_TYPE_member_t asn_MBR_ReferencePoint_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct ReferencePoint, choice.relativeCoordinateID),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct ReferencePoint, choice.referencePointCoordinate),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct ReferencePoint, choice.referencePointCoordinateHA),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct ReferencePoint, choice.choice_Extension),
     (ASN_TAG_CLASS_CONTEXT | (3 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_ProtocolIE_Single_Container_2907P20,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
...
static const asn_TYPE_tag2member_t asn_MAP_ReferencePoint_tag2el_1[] = {
    ...
    {(ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0,
     0}, /* referencePointCoordinate */
    {(ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0,
     0}, /* referencePointCoordinateHA */
