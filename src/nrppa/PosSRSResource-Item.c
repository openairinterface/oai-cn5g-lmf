...
static asn_per_constraints_t asn_PER_type_groupOrSequenceHopping_constr_13
    CC_NOTUSED = {
...
static asn_per_constraints_t asn_PER_memb_freqDomainShift_constr_11
    CC_NOTUSED = {
...
static const asn_INTEGER_enum_map_t asn_MAP_nrofSymbols_value2enum_5[] =
    {{0, 2, "n1"}, {1, 2, "n2"}, {2, 2, "n4"}, {3, 2, "n8"}, {4, 3, "n12"}};
...
static /* Use -fall-defs-global to expose */
    asn_TYPE_descriptor_t asn_DEF_nrofSymbols_5 = {
        ...
        sizeof(asn_DEF_nrofSymbols_tags_5) /
                sizeof(asn_DEF_nrofSymbols_tags_5[0]) -
            1,                      /* 1 */
...
static const asn_INTEGER_enum_map_t
    asn_MAP_groupOrSequenceHopping_value2enum_13[] = {
        {0, 7, "neither"},
        {1, 12, "groupHopping"},
...
asn_TYPE_member_t asn_MBR_PosSRSResource_Item_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct PosSRSResource_Item, srs_PosResourceId),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct PosSRSResource_Item, transmissionCombPos),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct PosSRSResource_Item, startPosition),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct PosSRSResource_Item, nrofSymbols),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct PosSRSResource_Item, freqDomainShift),
     (ASN_TAG_CLASS_CONTEXT | (4 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {0, &asn_PER_memb_freqDomainShift_constr_11,
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct PosSRSResource_Item, c_SRS),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct PosSRSResource_Item, groupOrSequenceHopping),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct PosSRSResource_Item, resourceTypePos),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct PosSRSResource_Item, sequenceId),
    ...
    {ATF_POINTER,
     2,
     offsetof(struct PosSRSResource_Item, spatialRelationPos),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct PosSRSResource_Item, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (10 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_ProtocolExtensionContainer_2816P31,
     0,
     {0, 0, 0},
     0,
     0, /* No default value */
