...
asn_TYPE_member_t asn_MBR_CriticalityDiagnostics_1[] = {
    {ATF_POINTER,
     6,
     offsetof(struct CriticalityDiagnostics, procedureCode),
    ...
    {ATF_POINTER,
     5,
     offsetof(struct CriticalityDiagnostics, triggeringMessage),
    ...
    {ATF_POINTER,
     4,
     offsetof(struct CriticalityDiagnostics, procedureCriticality),
    ...
    {ATF_POINTER,
     3,
     offsetof(struct CriticalityDiagnostics, nrppatransactionID),
    ...
    {ATF_POINTER,
     2,
     offsetof(struct CriticalityDiagnostics, iEsCriticalityDiagnostics),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct CriticalityDiagnostics, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (5 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_ProtocolExtensionContainer_2920P10,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
