...
asn_TYPE_member_t asn_MBR_ULRTOAMeas_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct ULRTOAMeas, choice.k0),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct ULRTOAMeas, choice.k1),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct ULRTOAMeas, choice.k2),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct ULRTOAMeas, choice.k3),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct ULRTOAMeas, choice.k4),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct ULRTOAMeas, choice.k5),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct ULRTOAMeas, choice.choice_extension),
     (ASN_TAG_CLASS_CONTEXT | (6 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_ProtocolIE_Single_Container_2907P37,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
