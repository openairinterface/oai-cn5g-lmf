 ...
 */
static asn_oer_constraints_t asn_OER_type_NRPPATransactionID_constr_1 CC_NOTUSED = {
	{ 2, 1 }	/* (0..32767) */,
	-1};
...
asn_TYPE_descriptor_t asn_DEF_NRPPATransactionID = {
	...
	sizeof(asn_DEF_NRPPATransactionID_tags_1)
		/sizeof(asn_DEF_NRPPATransactionID_tags_1[0]), /* 1 */
	{ &asn_OER_type_NRPPATransactionID_constr_1, &asn_PER_type_NRPPATransactionID_constr_1, NRPPATransactionID_constraint },
	0, 0,	/* No members */
	0	/* No specifics */
};
