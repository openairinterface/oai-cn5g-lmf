 ...
 * so here we adjust the DEF accordingly.
 */
static int memb_deltaLatitude_constraint_1(
...
static int memb_deltaLongitude_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  long value;
...
static int memb_deltaHeight_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  long value;
...
static asn_per_constraints_t asn_PER_type_milli_Arc_SecondUnits_constr_2
    CC_NOTUSED = {
...
static asn_per_constraints_t asn_PER_memb_deltaLongitude_constr_13
    CC_NOTUSED = {
        {APC_CONSTRAINED, 11, 11, -1024, 1023} /* (-1024..1023) */,
        {APC_UNCONSTRAINED, -1, -1, 0, 0},
        0,
...
static const asn_INTEGER_enum_map_t
    asn_MAP_milli_Arc_SecondUnits_value2enum_2[] = {
        {0, 9, "zerodot03"},
        {1, 8, "zerodot3"},
        {2, 5, "three"}
...
static /* Use -fall-defs-global to expose */
    asn_TYPE_descriptor_t asn_DEF_heightUnits_7 = {
        ...
        sizeof(asn_DEF_heightUnits_tags_7) /
                sizeof(asn_DEF_heightUnits_tags_7[0]) -
            1,                      /* 1 */
...
asn_TYPE_member_t asn_MBR_RelativeGeodeticLocation_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct RelativeGeodeticLocation, milli_Arc_SecondUnits),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct RelativeGeodeticLocation, heightUnits),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct RelativeGeodeticLocation, deltaLatitude),
     (ASN_TAG_CLASS_CONTEXT | (2 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {0, &asn_PER_memb_deltaLatitude_constr_12,
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct RelativeGeodeticLocation, deltaLongitude),
     (ASN_TAG_CLASS_CONTEXT | (3 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {0, &asn_PER_memb_deltaLongitude_constr_13,
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct RelativeGeodeticLocation, deltaHeight),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct RelativeGeodeticLocation, locationUncertainty),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct RelativeGeodeticLocation, iE_extensions),
     (ASN_TAG_CLASS_CONTEXT | (6 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_ProtocolExtensionContainer_2816P46,
     0,
     {0, 0, 0},
     0,
     0, /* No default value */
