...
asn_TYPE_descriptor_t asn_DEF_milli_Arc_SecondUnits_2 = {
	...
	{ &asn_OER_type_milli_Arc_SecondUnits_constr_2, &asn_PER_type_milli_Arc_SecondUnits_constr_2, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_heightUnits_7 = {
	...
	{ &asn_OER_type_heightUnits_constr_7, &asn_PER_type_heightUnits_constr_7, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_member_t asn_MBR_RelativeGeodeticLocation_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RelativeGeodeticLocation, deltaLatitude),
		...
		0,
		{ &asn_OER_memb_deltaLatitude_constr_12, &asn_PER_memb_deltaLatitude_constr_12,  memb_deltaLatitude_constraint_1 },
		0, 0, /* No default value */
		"deltaLatitude"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct RelativeGeodeticLocation, deltaLongitude),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_deltaLongitude_constr_13, &asn_PER_memb_deltaLongitude_constr_13,  memb_deltaLongitude_constraint_1 },
		0, 0, /* No default value */
		"deltaLongitude"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct RelativeGeodeticLocation, deltaHeight),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_deltaHeight_constr_14, &asn_PER_memb_deltaHeight_constr_14,  memb_deltaHeight_constraint_1 },
		0, 0, /* No default value */
		"deltaHeight"
		},
