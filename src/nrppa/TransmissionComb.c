...
static asn_TYPE_member_t asn_MBR_n2_2[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct TransmissionComb__n2, combOffset_n2),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct TransmissionComb__n2, cyclicShift_n2),
...
static asn_TYPE_member_t asn_MBR_n4_5[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct TransmissionComb__n4, combOffset_n4),
     (ASN_TAG_CLASS_CONTEXT | (0 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct TransmissionComb__n4, cyclicShift_n4),
     (ASN_TAG_CLASS_CONTEXT | (1 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
...
asn_TYPE_member_t asn_MBR_TransmissionComb_1[] = {
    {ATF_POINTER,
     0,
     offsetof(struct TransmissionComb, choice.n2),
     (ASN_TAG_CLASS_CONTEXT | (0 << 2)),
     0,
     &asn_DEF_n2_2,
     0,
    ...
    {ATF_POINTER,
     0,
     offsetof(struct TransmissionComb, choice.n4),
     (ASN_TAG_CLASS_CONTEXT | (1 << 2)),
     0,
     &asn_DEF_n4_5,
     0,
    ...
    {ATF_POINTER,
     0,
     offsetof(struct TransmissionComb, choice.choice_extension),
     (ASN_TAG_CLASS_CONTEXT | (2 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_ProtocolIE_Single_Container_2792P24,
     0,
     {0, 0, 0},
     0,
     0, /* No default value */
