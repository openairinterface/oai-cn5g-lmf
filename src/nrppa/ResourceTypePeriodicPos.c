...
asn_TYPE_member_t asn_MBR_ResourceTypePeriodicPos_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct ResourceTypePeriodicPos, periodicity),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct ResourceTypePeriodicPos, offset),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct ResourceTypePeriodicPos, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (2 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_ProtocolExtensionContainer_2816P55,
     0,
     {0, 0, 0},
     0,
     0, /* No default value */
