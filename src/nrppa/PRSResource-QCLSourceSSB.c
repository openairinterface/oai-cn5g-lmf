...
asn_TYPE_member_t asn_MBR_PRSResource_QCLSourceSSB_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct PRSResource_QCLSourceSSB, pCI_NR),
    ...
    {ATF_POINTER,
     2,
     offsetof(struct PRSResource_QCLSourceSSB, sSB_Index),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct PRSResource_QCLSourceSSB, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (2 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_ProtocolExtensionContainer_2920P47,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
