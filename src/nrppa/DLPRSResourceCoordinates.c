...
static int memb_listofDL_PRSResourceSetARP_constraint_1(
...
static asn_per_constraints_t asn_PER_type_listofDL_PRSResourceSetARP_constr_2
    CC_NOTUSED = {
...
static asn_per_constraints_t asn_PER_memb_listofDL_PRSResourceSetARP_constr_2
    CC_NOTUSED = {
        {APC_UNCONSTRAINED, -1, -1, 0, 0},
        {APC_CONSTRAINED, 1, 1, 1, 2} /* (SIZE(1..2)) */,
        0,
...
static asn_SET_OF_specifics_t asn_SPC_listofDL_PRSResourceSetARP_specs_2 = {
    ...
    offsetof(
        struct DLPRSResourceCoordinates__listofDL_PRSResourceSetARP, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_DLPRSResourceCoordinates_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct DLPRSResourceCoordinates, listofDL_PRSResourceSetARP),
     (ASN_TAG_CLASS_CONTEXT | (0 << 2)),
     0,
     &asn_DEF_listofDL_PRSResourceSetARP_2,
     0,
     {0, &asn_PER_memb_listofDL_PRSResourceSetARP_constr_2,
    ...
    {ATF_POINTER,
     1,
     offsetof(struct DLPRSResourceCoordinates, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (1 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_ProtocolExtensionContainer_2816P13,
     0,
     {0, 0, 0},
     0,
     0, /* No default value */
