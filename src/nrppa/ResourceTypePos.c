...
asn_TYPE_member_t asn_MBR_ResourceTypePos_1[] = {
    {ATF_POINTER,
     0,
     offsetof(struct ResourceTypePos, choice.periodic),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct ResourceTypePos, choice.semi_persistent),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct ResourceTypePos, choice.aperiodic),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct ResourceTypePos, choice.choice_extension),
     (ASN_TAG_CLASS_CONTEXT | (3 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_ProtocolIE_Single_Container_2907P24,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
