...
static asn_oer_constraints_t asn_OER_memb_aRFCN_constr_4 CC_NOTUSED = {
	{ 4, 1 }	/* (0..3279165) */,
	-1};
...
asn_TYPE_member_t asn_MBR_TRPInformationTypeResponseItem_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct TRPInformationTypeResponseItem, choice.pCI_NR),
		...
		0,
		{ &asn_OER_memb_pCI_NR_constr_2, &asn_PER_memb_pCI_NR_constr_2,  memb_pCI_NR_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct TRPInformationTypeResponseItem, choice.aRFCN),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_aRFCN_constr_4, &asn_PER_memb_aRFCN_constr_4,  memb_aRFCN_constraint_1 },
		0, 0, /* No default value */
		"aRFCN"
		},
...
asn_TYPE_descriptor_t asn_DEF_TRPInformationTypeResponseItem = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_TRPInformationTypeResponseItem_constr_1, &asn_PER_type_TRPInformationTypeResponseItem_constr_1, CHOICE_constraint },
