...
static asn_per_constraints_t asn_PER_memb_aRFCN_constr_4 CC_NOTUSED = {
    ...
    0 /* No PER value map */
          ...
          !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
asn_per_constraints_t asn_PER_type_TRPInformationTypeResponseItem_constr_1
    CC_NOTUSED = {
...
asn_TYPE_member_t asn_MBR_TRPInformationTypeResponseItem_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct TRPInformationTypeResponseItem, choice.pCI_NR),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct TRPInformationTypeResponseItem, choice.cGI_NR),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct TRPInformationTypeResponseItem, choice.aRFCN),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct TRPInformationTypeResponseItem, choice.pRSConfiguration),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct TRPInformationTypeResponseItem, choice.sSBinformation),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(
         struct TRPInformationTypeResponseItem, choice.sFNInitialisationTime),
    ...
    {ATF_POINTER,
     ...
     offsetof(
         ...
         choice.spatialDirectionInformation),
    ...
    {ATF_POINTER,
     0,
     offsetof(
         struct TRPInformationTypeResponseItem, choice.geographicalCoordinates),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct TRPInformationTypeResponseItem, choice.choice_extension),
     (ASN_TAG_CLASS_CONTEXT | (8 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_ProtocolIE_Single_Container_2907P32,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
