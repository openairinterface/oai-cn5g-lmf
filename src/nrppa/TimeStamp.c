...
asn_TYPE_member_t asn_MBR_TimeStamp_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct TimeStamp, systemFrameNumber),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct TimeStamp, slotIndex),
    ...
    {ATF_POINTER,
     2,
     offsetof(struct TimeStamp, measurementTime),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct TimeStamp, iE_Extension),
     (ASN_TAG_CLASS_CONTEXT | (3 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_ProtocolExtensionContainer_2920P96,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
