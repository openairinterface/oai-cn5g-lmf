...
static asn_oer_constraints_t asn_OER_memb_sRSResourceTrigger_constr_2 CC_NOTUSED = {
	{ 1, 1 }	/* (1..3) */,
	-1};
...
asn_TYPE_member_t asn_MBR_ResourceSetTypeAperiodic_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct ResourceSetTypeAperiodic, sRSResourceTrigger),
		...
		0,
		{ &asn_OER_memb_sRSResourceTrigger_constr_2, &asn_PER_memb_sRSResourceTrigger_constr_2,  memb_sRSResourceTrigger_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ResourceSetTypeAperiodic, slotoffset),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_slotoffset_constr_3, &asn_PER_memb_slotoffset_constr_3,  memb_slotoffset_constraint_1 },
		0, 0, /* No default value */
		"slotoffset"
		},
