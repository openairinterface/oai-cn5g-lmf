...
static int memb_sRSResourceTrigger_constraint_1(
...
static asn_per_constraints_t asn_PER_memb_sRSResourceTrigger_constr_2
    CC_NOTUSED = {
...
asn_TYPE_member_t asn_MBR_ResourceSetTypeAperiodic_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct ResourceSetTypeAperiodic, sRSResourceTrigger),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct ResourceSetTypeAperiodic, slotoffset),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct ResourceSetTypeAperiodic, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (2 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_ProtocolExtensionContainer_2920P56,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
