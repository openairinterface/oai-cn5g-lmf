...
asn_per_constraints_t asn_PER_type_CriticalityDiagnostics_IE_List_constr_1
    CC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_Member_2[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct CriticalityDiagnostics_IE_List__Member, iECriticality),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct CriticalityDiagnostics_IE_List__Member, iE_ID),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct CriticalityDiagnostics_IE_List__Member, typeOfError),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct CriticalityDiagnostics_IE_List__Member, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (3 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_ProtocolExtensionContainer_2920P11,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
