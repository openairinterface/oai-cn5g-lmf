...
asn_TYPE_member_t asn_MBR_PRSResource_Item_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PRSResource_Item, sequenceID),
		...
		0,
		{ &asn_OER_memb_sequenceID_constr_3, &asn_PER_memb_sequenceID_constr_3,  memb_sequenceID_constraint_1 },
		0, 0, /* No default value */
		"sequenceID"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct PRSResource_Item, rEOffset),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_rEOffset_constr_4, &asn_PER_memb_rEOffset_constr_4,  memb_rEOffset_constraint_1 },
		0, 0, /* No default value */
		"rEOffset"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct PRSResource_Item, resourceSlotOffset),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_resourceSlotOffset_constr_5, &asn_PER_memb_resourceSlotOffset_constr_5,  memb_resourceSlotOffset_constraint_1 },
		0, 0, /* No default value */
		"resourceSlotOffset"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct PRSResource_Item, resourceSymbolOffset),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_resourceSymbolOffset_constr_6, &asn_PER_memb_resourceSymbolOffset_constr_6,  memb_resourceSymbolOffset_constraint_1 },
		0, 0, /* No default value */
