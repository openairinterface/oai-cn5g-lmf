...
static int memb_pRSResourceID_constraint_1(
...
static int memb_rEOffset_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  long value;
...
static int memb_resourceSlotOffset_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  long value;
...
static int memb_resourceSymbolOffset_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  long value;
...
static asn_per_constraints_t asn_PER_memb_pRSResourceID_constr_2 CC_NOTUSED = {
...
static asn_per_constraints_t asn_PER_memb_resourceSlotOffset_constr_5
    CC_NOTUSED = {
...
static asn_per_constraints_t asn_PER_memb_resourceSymbolOffset_constr_6
    CC_NOTUSED = {
...
asn_TYPE_member_t asn_MBR_PRSResource_Item_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct PRSResource_Item, pRSResourceID),
     (ASN_TAG_CLASS_CONTEXT | (0 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {0, &asn_PER_memb_pRSResourceID_constr_2, memb_pRSResourceID_constraint_1},
     0,
     0, /* No default value */
     "pRSResourceID"},
    {ATF_NOFLAGS,
     0,
     offsetof(struct PRSResource_Item, sequenceID),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct PRSResource_Item, rEOffset),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct PRSResource_Item, resourceSlotOffset),
     (ASN_TAG_CLASS_CONTEXT | (3 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {0, &asn_PER_memb_resourceSlotOffset_constr_5,
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct PRSResource_Item, resourceSymbolOffset),
     (ASN_TAG_CLASS_CONTEXT | (4 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {0, &asn_PER_memb_resourceSymbolOffset_constr_6,
    ...
    {ATF_POINTER,
     2,
     offsetof(struct PRSResource_Item, qCLInfo),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct PRSResource_Item, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (6 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_ProtocolExtensionContainer_2816P42,
     0,
     {0, 0, 0},
     0,
     0, /* No default value */
