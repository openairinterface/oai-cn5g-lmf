...
static asn_type_selector_result_t select_SuccessfulOutcome_criticality_type(
...
static asn_type_selector_result_t select_SuccessfulOutcome_value_type(
    const asn_TYPE_descriptor_t* parent_type, const void* parent_sptr) {
  asn_type_selector_result_t result = {0, 0};
  const asn_ioc_set_t* itable       = asn_IOS_NRPPA_ELEMENTARY_PROCEDURES_1;
  size_t constraining_column        = 3; /* &procedureCode */
...
static asn_TYPE_member_t asn_MBR_value_5[] = {
    {ATF_NOFLAGS,
     ...
     offsetof(
         ...
         choice.E_CIDMeasurementInitiationResponse),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct SuccessfulOutcome__value, choice.OTDOAInformationResponse),
     (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
     0,
    ...
    {ATF_NOFLAGS,
     ...
     offsetof(
         struct SuccessfulOutcome__value,
         choice.PositioningInformationResponse),
     (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
     0,
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct SuccessfulOutcome__value, choice.MeasurementResponse),
     (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
     0,
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct SuccessfulOutcome__value, choice.TRPInformationResponse),
     (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
     0,
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(
         struct SuccessfulOutcome__value, choice.PositioningActivationResponse),
     (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
     0,
...
asn_TYPE_member_t asn_MBR_SuccessfulOutcome_1[] = {
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct SuccessfulOutcome, criticality),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct SuccessfulOutcome, nrppatransactionID),
    ...
    {ATF_OPEN_TYPE | ATF_NOFLAGS,
     0,
     offsetof(struct SuccessfulOutcome, value),
