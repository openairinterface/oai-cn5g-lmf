...
static asn_TYPE_member_t asn_MBR_value_5[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SuccessfulOutcome__value, choice.OTDOAInformationResponse),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SuccessfulOutcome__value, choice.MeasurementResponse),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
