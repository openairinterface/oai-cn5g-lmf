...
static asn_TYPE_member_t asn_MBR_encoding_5[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct EXTERNAL__encoding, choice.single_ASN1_type),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct EXTERNAL__encoding, choice.octet_aligned),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct EXTERNAL__encoding, choice.arbitrary),
...
static asn_TYPE_member_t asn_MBR_EXTERNAL_1[] = {
    {ATF_POINTER,
     3,
     offsetof(struct EXTERNAL, direct_reference),
    ...
    {ATF_POINTER,
     2,
     offsetof(struct EXTERNAL, indirect_reference),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct EXTERNAL, data_value_descriptor),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct EXTERNAL, encoding),
...
asn_TYPE_descriptor_t asn_DEF_EXTERNAL = {
    ...
    sizeof(asn_DEF_EXTERNAL_tags_1) / sizeof(asn_DEF_EXTERNAL_tags_1[0]) -
        1,                   /* 1 */
