...
asn_TYPE_member_t asn_MBR_ResourceTypeSemi_persistent_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct ResourceTypeSemi_persistent, periodicity),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct ResourceTypeSemi_persistent, offset),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct ResourceTypeSemi_persistent, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (2 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_ProtocolExtensionContainer_2920P58,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
