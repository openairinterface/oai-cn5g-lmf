...
static int memb_six_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  const BIT_STRING_t* st = (const BIT_STRING_t*) sptr;
  size_t size;
...
asn_TYPE_member_t asn_MBR_DL_PRSMutingPattern_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct DL_PRSMutingPattern, choice.two),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct DL_PRSMutingPattern, choice.four),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct DL_PRSMutingPattern, choice.six),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct DL_PRSMutingPattern, choice.eight),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct DL_PRSMutingPattern, choice.sixteen),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct DL_PRSMutingPattern, choice.thirty_two),
    ...
    {ATF_POINTER,
     0,
     offsetof(struct DL_PRSMutingPattern, choice.choice_extension),
     (ASN_TAG_CLASS_CONTEXT | (6 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_ProtocolIE_Single_Container_2907P5,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
