...
asn_TYPE_descriptor_t asn_DEF_nrofSymbols_9 = {
	...
	{ &asn_OER_type_nrofSymbols_constr_9, &asn_PER_type_nrofSymbols_constr_9, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_repetitionFactor_13 = {
	...
	{ &asn_OER_type_repetitionFactor_constr_13, &asn_PER_type_repetitionFactor_constr_13, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_groupOrSequenceHopping_22 = {
	...
	{ &asn_OER_type_groupOrSequenceHopping_constr_22, &asn_PER_type_groupOrSequenceHopping_constr_22, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_member_t asn_MBR_SRSResource_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SRSResource, startPosition),
		...
		0,
		{ &asn_OER_memb_startPosition_constr_8, &asn_PER_memb_startPosition_constr_8,  memb_startPosition_constraint_1 },
		0, 0, /* No default value */
		"startPosition"
		},
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SRSResource, freqDomainPosition),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_freqDomainPosition_constr_17, &asn_PER_memb_freqDomainPosition_constr_17,  memb_freqDomainPosition_constraint_1 },
		0, 0, /* No default value */
		"freqDomainPosition"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct SRSResource, freqDomainShift),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_freqDomainShift_constr_18, &asn_PER_memb_freqDomainShift_constr_18,  memb_freqDomainShift_constraint_1 },
		0, 0, /* No default value */
		"freqDomainShift"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct SRSResource, c_SRS),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_c_SRS_constr_19, &asn_PER_memb_c_SRS_constr_19,  memb_c_SRS_constraint_1 },
		0, 0, /* No default value */
		"c-SRS"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct SRSResource, b_SRS),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_b_SRS_constr_20, &asn_PER_memb_b_SRS_constr_20,  memb_b_SRS_constraint_1 },
		0, 0, /* No default value */
		"b-SRS"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct SRSResource, b_hop),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_b_hop_constr_21, &asn_PER_memb_b_hop_constr_21,  memb_b_hop_constraint_1 },
		0, 0, /* No default value */
		"b-hop"
		},
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SRSResource, sequenceId),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_sequenceId_constr_27, &asn_PER_memb_sequenceId_constr_27,  memb_sequenceId_constraint_1 },
		0, 0, /* No default value */
		"sequenceId"
		},
