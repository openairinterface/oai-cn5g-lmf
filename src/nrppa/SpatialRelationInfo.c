...
asn_TYPE_member_t asn_MBR_SpatialRelationInfo_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct SpatialRelationInfo, spatialRelationforResourceID),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct SpatialRelationInfo, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (1 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_ProtocolExtensionContainer_2920P80,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
