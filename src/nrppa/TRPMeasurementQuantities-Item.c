 ...
 */
static asn_oer_constraints_t asn_OER_type_TRPMeasurementQuantities_Item_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
asn_per_constraints_t asn_PER_type_TRPMeasurementQuantities_Item_constr_1 CC_NOTUSED = {
	{ APC_CONSTRAINED | APC_EXTENSIBLE,  2,  2,  0,  3 }	/* (0..3,...) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static const asn_INTEGER_enum_map_t asn_MAP_TRPMeasurementQuantities_Item_value2enum_1[] = {
...
const asn_INTEGER_specifics_t asn_SPC_TRPMeasurementQuantities_Item_specs_1 = {
	asn_MAP_TRPMeasurementQuantities_Item_value2enum_1,	/* "tag" => N; sorted by tag */
	asn_MAP_TRPMeasurementQuantities_Item_enum2value_1,	/* N => "tag"; sorted by N */
...
asn_TYPE_descriptor_t asn_DEF_TRPMeasurementQuantities_Item = {
	...
	sizeof(asn_DEF_TRPMeasurementQuantities_Item_tags_1)
		/sizeof(asn_DEF_TRPMeasurementQuantities_Item_tags_1[0]), /* 1 */
	{ &asn_OER_type_TRPMeasurementQuantities_Item_constr_1, &asn_PER_type_TRPMeasurementQuantities_Item_constr_1, NativeEnumerated_constraint },
