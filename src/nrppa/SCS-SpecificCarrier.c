 ...
 */
static int memb_offsetToCarrier_constraint_1(
...
static int memb_carrierBandwidth_constraint_1(
    const asn_TYPE_descriptor_t* td, const void* sptr,
    asn_app_constraint_failed_f* ctfailcb, void* app_key) {
  long value;
...
static asn_per_constraints_t asn_PER_memb_offsetToCarrier_constr_2
    CC_NOTUSED = {
...
static asn_per_constraints_t asn_PER_memb_carrierBandwidth_constr_9
    CC_NOTUSED = {
...
asn_TYPE_member_t asn_MBR_SCS_SpecificCarrier_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct SCS_SpecificCarrier, offsetToCarrier),
     (ASN_TAG_CLASS_CONTEXT | (0 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {0, &asn_PER_memb_offsetToCarrier_constr_2,
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct SCS_SpecificCarrier, subcarrierSpacing),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct SCS_SpecificCarrier, carrierBandwidth),
     (ASN_TAG_CLASS_CONTEXT | (2 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_NativeInteger,
     0,
     {0, &asn_PER_memb_carrierBandwidth_constr_9,
    ...
    {ATF_POINTER,
     1,
     offsetof(struct SCS_SpecificCarrier, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (3 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_ProtocolExtensionContainer_2816P72,
     0,
     {0, 0, 0},
     0,
     0, /* No default value */
