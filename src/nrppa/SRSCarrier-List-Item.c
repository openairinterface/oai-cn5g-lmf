...
static asn_oer_constraints_t asn_OER_memb_pCI_NR_constr_5 CC_NOTUSED = {
	{ 2, 1 }	/* (0..1007) */,
	-1};
...
asn_TYPE_member_t asn_MBR_SRSCarrier_List_Item_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct SRSCarrier_List_Item, pointA),
		...
		0,
		{ &asn_OER_memb_pointA_constr_2, &asn_PER_memb_pointA_constr_2,  memb_pointA_constraint_1 },
	...
	{ ATF_POINTER, 2, offsetof(struct SRSCarrier_List_Item, pCI_NR),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_pCI_NR_constr_5, &asn_PER_memb_pCI_NR_constr_5,  memb_pCI_NR_constraint_1 },
		0, 0, /* No default value */
		"pCI-NR"
		},
