...
asn_TYPE_member_t asn_MBR_TRPPositionReferenced_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct TRPPositionReferenced, referencePoint),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct TRPPositionReferenced, referencePointType),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct TRPPositionReferenced, iE_extensions),
     (ASN_TAG_CLASS_CONTEXT | (2 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_ProtocolExtensionContainer_2920P107,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
