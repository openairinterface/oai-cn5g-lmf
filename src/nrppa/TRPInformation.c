...
asn_TYPE_member_t asn_MBR_TRPInformation_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(struct TRPInformation, tRP_ID),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct TRPInformation, tRPInformationTypeResponseList),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct TRPInformation, iE_Extensions),
     (ASN_TAG_CLASS_CONTEXT | (2 << 2)),
     -1, /* IMPLICIT tag at current level */
     &asn_DEF_ProtocolExtensionContainer_2920P104,
     0,
     {
#if !defined(ASN_DISABLE_OER_SUPPORT)
         0,
...
static const asn_TYPE_tag2member_t asn_MAP_TRPInformation_tag2el_1[] = {
    ...
    {(ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0,
     0}, /* tRPInformationTypeResponseList */
